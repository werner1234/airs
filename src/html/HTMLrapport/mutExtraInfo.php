...
$query = "SELECT * FROM `_htmlRapport_MUT` WHERE id = ".$_GET["id"];
...
//    debug($rec);
    if ($rec["fondssoort"] == "OBL" OR $rec["fondssoort"] == "OVERIGE")
    {
      ...
      {
        $rente = $fmt->format("@N{.3}%",$renteRec["Rentepercentage"])." (" . vt('Vanaf') . " ".$fmt->format("@D {d}-{m}-{Y}",$renteRec["Datum"]).")";
      }
      else
      {
        $rente = vt("geen rente gevonden");
      }
      $extraData = "
      <tr>
    ...
    <table class="extraInfoTable" >
      <tr>
        <td>
          ...
          <?= vt('Laatste koers'); ?>: <?=$fmt->format("@N{.2}",$koersRec["Koers"])." ".$rec["Valuta"]." " . vt('d.d.') . ":".$fmt->format("@D{d}-{m}-{Y}",$koersRec["Datum"])?><br/>
          <br/>
<?
...
?>
        ...
        {
          $("#infoTab4").load("mutExtraInfo.php?tab=4&id=<?=$_GET["id"]?>");
        });
        $("#btn2Y").click(function ()
        {
          $("#infoTab4").load("mutExtraInfo.php?tab=4_2y&id=<?=$_GET["id"]?>");
        });
        $("#btn5Y").click(function ()
        {
          $("#infoTab4").load("mutExtraInfo.php?tab=4_5y&id=<?=$_GET["id"]?>");
        });
      })
...
//                ));
  ...
  <script>
    $(document).ready(function()
    {
      ...
      {
        $("#infoTab1").load("mutExtraInfo.php?tab=1R&id=<?=$_GET["id"]?>&stop=<?=$_GET['stop'];?>");
      });
      $("#btnTR1Y").click(function ()
      {
        $("#infoTab1").load("mutExtraInfo.php?tab=1R_1&id=<?=$_GET["id"]?>&stop=<?=$_GET['stop'];?>");
      });
      $("#btnTRhis").click(function ()
      {
        $("#infoTab1").load("mutExtraInfo.php?tab=1R_H&id=<?=$_GET["id"]?>&stop=<?=$_GET['stop'];?>");
      });
    });
  </script>
    <?
    ...
    <script>
      $(document).ready(function()
      {
        $("#GBgrootboek").change(function ()
        {
          ...
          $("#infoTab2").load("mutExtraInfo.php?tab=<?=$_GET["tab"]?>&id=<?=$_GET["id"]?>&stop=<?=$_GET['stop'];?>&GBgrootboek="+$(this).val());
...
<?
      ...
      switch($_GET["tab"])
      {
        ...
        ?>
          ...
          {
            $("#infoTab2").load("mutExtraInfo.php?tab=2R&id=<?=$_GET["id"]?>&stop=<?=$_GET['stop'];?>&GBgrootboek="+$("#GBgrootboek").val());
          });
          $("#btnGB1Y").click(function ()
          {
            $("#infoTab2").load("mutExtraInfo.php?tab=2R_1&id=<?=$_GET["id"]?>&stop=<?=$_GET['stop'];?>&GBgrootboek="+$("#GBgrootboek").val());
          });
          $("#btnGBhis").click(function ()
          {
            $("#infoTab2").load("mutExtraInfo.php?tab=2R_H&id=<?=$_GET["id"]?>&stop=<?=$_GET['stop'];?>&GBgrootboek="+$("#GBgrootboek").val());
          });
      });
    </script>
<?
