...
$(".iBtn").click(function (e)
{
  ...
  $("#infoTab1").load("mutExtraInfo.php?tab=1&id=" + btnId + "&stop=" + stop);
  $("#infoTab2").load("mutExtraInfo.php?tab=2&id=" + btnId + "&stop=" + stop);
  $("#infoTab3").load("mutExtraInfo.php?tab=3&id=" + btnId + "&stop=" + stop);
  $("#infoTab4").load("mutExtraInfo.php?tab=4&id=" + btnId + "&stop=" + stop);
  $("#infoTab5").load("mutExtraInfo.php?tab=5&id=" + btnId + "&stop=" + stop);
