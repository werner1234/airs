...
{
  $('#fondsTable').fixedHeader();

  $('#fondsTable').dragtable({
...
$('#fondsTable').dragtable({
  ...
  $(document).on('click', '.sortColumn', function (e)
  {
    ...
    var numbodies = $('#fondsTable').find('tbody').length;
    $('#fondsTable').find('tbody').each(function (i, el)
    {
      var table = $(this);
...
$.fn.fixedHeader = function() {
  return this.each(function() {
    ...
    function init() {
      ...
      fixedHeader.attr('id', 'fondsTableFloat');
