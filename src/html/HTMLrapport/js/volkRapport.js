...
$("#titleTab4").click(function (e)
{
  e.preventDefault();
  console.log("tab 4 clicked");

  $("#infoTab4").addClass("loading");
  $("#infoTab4").html('<div style="margin: 50px; text-align: center"><img src="../images/loading.gif" ><br/><br/><br/>Laden, moment a.u.b.</div>');
  $("#infoTab4").load("volkExtraInfo.php?tab=4&id=" + btnId + "&stop=" + stop);
});
...
$(".iBtn").click(function (e)
{
  ...
  stop = $(document).find('#stop').val();
  infoDialog.dialog('open');
  $("#infoTab1").load("volkExtraInfo.php?tab=1&id=" + btnId + "&stop=" + stop);
  $("#infoTab2").load("volkExtraInfo.php?tab=2&id=" + btnId + "&stop=" + stop);
  $("#infoTab3").load("volkExtraInfo.php?tab=3&id=" + btnId + "&stop=" + stop);
  $("#infoTab5").load("volkExtraInfo.php?tab=5&id=" + btnId + "&stop=" + stop);
  $("#titleTab1").click();
});
...
$(document).on('click', '.sortColumn', function (e)
{
  ...
  $('#volkTable').find('tbody').each(function (i, el)
  {
    ...
    {
      if ( $('#volkTable').find('tbody').length === 1 ) {
        table.append(row);
      } else {
