...
ajaxSubmit('submit-form', 'edit-form');
...
$('#recalculate').on('click', function () {
  if ( $('#Fonds').val().length > 0 && $('#Fondskoers').is(':enabled') ) {
    fondsChanged('Fonds');
  }
...
$('#Grootboekrekening').on('change', function () {
  ...
  //bij VERM waarde legen
  if( $('#Grootboekrekening').val() == 'VERM' ) {
    $('#Transactietype').val(0);
    $('#Debet').val(0);
    $('#Credit').val(0);
    $('input[name=Bedrag]').val(0);
  }
...
function setFondsenStatus() {
  ...
  if( $('#Grootboekrekening').val() == 'FONDS' ) {
    $("#Transactietype").attr('readonly', false);
    $("#Fonds").attr('readonly', false);
    $("#Fondskoers").attr('readonly', false);
    $("#Aantal").attr('readonly', false);
    $("#Bewaarder").attr('readonly', false);
	} else {
    $('#fonds-koers-info').removeClass();
    $('#fonds-koers-info').html('');

    $("#Transactietype").attr('readonly', true);
    $("#Fonds").attr('readonly', true);
    $("#Fondskoers").attr('readonly', true);
    $("#Fondskoers").val(0);
    $("#Aantal").attr('readonly', true);
    $("#Aantal").val(0);
    $("#Bewaarder").attr('readonly', true);
...
$('#Debet, #Credit').keydown(function(e) {
  if ( e.keyCode == 120 ) {
    ...
    if ( tempValue != 0 && tempValue != '' ) {
      ...
      $(this).val(0);
      //9010 herberekenen bij lege waarde
      setDebetCredet();
    }
    mutationsum();
  }
