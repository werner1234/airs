...
/*
    ...
    Author  						: $Author: cvs $
 		...
 		$Log: bew_ubp_reconFuncties.php,v $
...
//    debug($data);
    ...
    $record["portefeuille"] = checkForAirsPortefeuille(ontnullen(trim($data[2])));
...
function checkForAirsPortefeuille($portefeuille)
{
  // zoekt portefeuille en geeft als gevonden altijd de AIRS portefeuille retour
  $db = new DB();
  $query = "
    SELECT
      *
    ...
    WHERE
      ...
      `PortefeuilleDepotbank` = '{$portefeuille}'
  ";
