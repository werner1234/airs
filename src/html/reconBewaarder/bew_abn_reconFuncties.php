...
/*
    ...
    Author  						: $Author: cvs $
 		Laatste aanpassing	: $Date: 2019/02/27 15:05:50 $
 		File Versie					: $Revision: 1.2 $

 		$Log: bew_abn_reconFuncties.php,v $
 		Revision 1.2  2019/02/27 15:05:50  cvs
 		call 5995
...
{
  $DB = new DB();
  $query = "SELECT Rekening FROM Rekeningen WHERE Portefeuille = '$port' AND Memoriaal = 0 AND consolidatie = 0 AND Valuta='$valuta'";
  $DB->SQL($query);
