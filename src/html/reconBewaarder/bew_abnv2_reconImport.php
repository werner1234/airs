...
/*
    ...
    Author  						: $Author: cvs $
 		...
 		$Log: bew_abnv2_reconImport.php,v $
...
include_once("bew_abnv2_reconFuncties.php");
...
$recon = new reconcilatieBewClass("AAB",$_GET["manualBoekdatum"]);
$batch = "AABv2_".date("ymd_His");
$recon->batch = $batch;
