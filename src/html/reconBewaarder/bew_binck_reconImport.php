...
/*
    ...
    Author  						: $Author: cvs $
 		...
 		$Log: bew_binck_reconImport.php,v $
...
include_once("bew_binck_reconFuncties.php");
...
?>
<div id="running">
  <h2> Bewaarders Reconciliatie, moment a.u.b. </h2>
...
$recon = new reconcilatieBewClass("BIN",$_GET["manualBoekdatum"]);
