...
/*
    ...
    $Log: standaarddeviatieperrisicoklasseEdit.php,v $
...
$__funcvar["listurl"]  = "standaarddeviatieperrisicoklasseList.php";
$__funcvar["location"] = "standaarddeviatieperrisicoklasseEdit.php";

$object = new StandaarddeviatiePerRisicoklasse();
