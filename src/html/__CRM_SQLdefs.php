...
/*
    ...
    Author  						: $Author: cvs $
 		Laatste aanpassing	: $Date: 2020/01/05 14:46:34 $
 		File Versie					: $Revision: 1.11 $

 		$Log: __CRM_SQLdefs.php,v $
 		Revision 1.11  2020/01/05 14:46:34  cvs
 		call 7937 encoder probleem?
 		
 		Revision 1.10  2006/07/26 07:28:56  cvs
 		*** empty log message ***
...
"INSERT INTO `ae_modulecfg` VALUES (null, 'CRM', '240834-45652-1357500', '2010-12-31', '".$__appvar['bedrijf']."', null, null);",
"INSERT INTO `ae_modulecfg` VALUES (null, 'ORDER', '240834-46258-1357500', '2010-12-31', '".$__appvar['bedrijf']."', null, null);"
);
