...
/*
    ...
    Author  						: $Author: rvv $
 	...
 	$Log: rapportExportPDF.php,v $
 	Revision 1.48  2019/01/19 13:52:12  rvv
 	*** empty log message ***
 	
 	Revision 1.47  2019/01/16 16:35:40  rvv
 	*** empty log message ***
 	
 	Revision 1.46  2018/08/18 12:40:14  rvv
 	php 5.6 & consolidatie
 	
 	Revision 1.45  2014/03/22 15:48:26  rvv
 	*** empty log message ***
 	
 	Revision 1.44  2013/10/12 15:49:59  rvv
 	*** empty log message ***
 	
 	Revision 1.43  2011/09/14 09:26:56  rvv
 	*** empty log message ***
 	
 	Revision 1.42  2010/11/14 10:49:33  rvv
 	*** empty log message ***
...
while($pdata = $DB->nextRecord())
{
  ...
  else
  {
	...
	if($eMail ==true)
	  ...
	  $exportPath = $pdata['Export_'.$rapportType.'_pad'];
