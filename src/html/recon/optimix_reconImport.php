...
/*
    ...
    Author  						: $Author: cvs $
 		Laatste aanpassing	: $Date: 2018/05/14 08:56:36 $
 		File Versie					: $Revision: 1.1 $

 		$Log: optimix_reconImport.php,v $
...
include_once("optimix_reconFuncties.php");
...
$recon = new reconcilatieClass("OPT",$_GET["manualBoekdatum"]);
