...
/*
    ...
    Author  						: $Author: cvs $
 		Laatste aanpassing	: $Date: 2019/08/23 12:36:29 $
 		File Versie					: $Revision: 1.1 $

 		$Log: jblux_reconImport.php,v $
...
include_once("jblux_reconFuncties.php");
...
$recon = new reconcilatieClass("JBLUX",$_GET["manualBoekdatum"]);
$batch = "JULBAERLUX_".date("ymd_His");
$recon->batch = $batch;
