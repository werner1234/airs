...
/*
    ...
    Author  						: $Author: cvs $
 		Laatste aanpassing	: $Date: 2018/05/02 12:59:48 $
 		File Versie					: $Revision: 1.1 $

 		$Log: ingv2_reconImport.php,v $
...
include_once("ingv2_reconFuncties.php");
...
$recon = new reconcilatieClass("ING",$_GET["manualBoekdatum"]);
