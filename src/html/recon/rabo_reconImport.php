...
/*
    ...
    Author  						: $Author: cvs $
 		Laatste aanpassing	: $Date: 2019/09/25 09:11:47 $
 		File Versie					: $Revision: 1.1 $

 		$Log: rabo_reconImport.php,v $
 		Revision 1.1  2019/09/25 09:11:47  cvs
 		call 7650
...
include_once("rabo_reconFuncties.php");
...
$recon = new reconcilatieClass("RABO",$_GET["manualBoekdatum"]);
