...
/*
    ...
    Author  						: $Author: cvs $
 		Laatste aanpassing	: $Date: 2017/09/20 06:20:06 $
 		File Versie					: $Revision: 1.1 $

 		$Log: lynx_reconImport.php,v $
...
include_once("lynx_reconFuncties.php");
...
$recon = new reconcilatieClass("LYNX",$_GET["manualBoekdatum"]);
