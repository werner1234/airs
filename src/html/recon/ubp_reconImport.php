...
/*
    ...
    Author  						: $Author: cvs $
 		Laatste aanpassing	: $Date: 2017/04/03 13:39:46 $
 		File Versie					: $Revision: 1.1 $

 		$Log: ubp_reconImport.php,v $
...
include_once("ubp_reconFuncties.php");
...
$meldArray = array();
$recon = new reconcilatieClass("UBP",$_GET["manualBoekdatum"]);
