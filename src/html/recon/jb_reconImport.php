...
/*
    ...
    Author  						: $Author: cvs $
 		Laatste aanpassing	: $Date: 2018/04/30 13:53:53 $
 		File Versie					: $Revision: 1.2 $

 		$Log: jb_reconImport.php,v $
...
include_once("jb_reconFuncties.php");
...
$recon = new reconcilatieClass("JUL BAER",$_GET["manualBoekdatum"]);
$batch = "JULBAER_".date("ymd_His");
$recon->batch = $batch;
