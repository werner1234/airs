...
include_once("knox_reconFuncties.php");

// settings voor import
$set = array(
  "headerRow"       => "PortfolioNumber;ISINCode;AccountNumber;ProductOrAccountCCY;InternalProductId;NumberOfSharesCashBalance;Price;PriceDate"
);
...
//  exit;
//}
$recon = new reconcilatieClass("KNOX",$_GET["manualBoekdatum"]);
$batch = "KNOX".date("ymd_His");
$recon->batch = $batch;
...
$sRecords = recon_readBank($_GET["file"]);
