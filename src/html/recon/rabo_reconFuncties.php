...
/*
    ...
    Author  						: $Author: cvs $
 		Laatste aanpassing	: $Date: 2019/09/25 09:11:33 $
 		File Versie					: $Revision: 1.1 $

 		$Log: rabo_reconFuncties.php,v $
 		Revision 1.1  2019/09/25 09:11:33  cvs
 		call 7650
...
//    $prb->moveNext();
    ...
    else
    {
      $rek = explode("-", $data[1]);
      $record["type"]      = "cash";
      $record["rekening"]  = $rek[1];
      $record["datum1"]    = "";
      $record["valuta"]    = $data[4];
      $record["bedragRaw"] = $data[3];
      $record["DC"]        = ($data[3] >= 0)?"D":"C";
      $record["datum2"]    = "";
      $record["iban"]      = "";
