...
/*
    ...
    Author  						: $Author: cvs $
 		Laatste aanpassing	: $Date: 2019/07/18 07:54:18 $
 		File Versie					: $Revision: 1.1 $

 		$Log: bnpbgl_reconImport.php,v $
...
include_once("bnpbgl_reconFuncties.php");
...
$recon = new reconcilatieClass("BGL",$_GET["manualBoekdatum"]);
$batch = "BGL_".date("ymd_His");
$recon->batch = $batch;
...
echo " <li> bankbestand bevatte ".$sRecords." dataregels</li>";
ob_flush();flush();
