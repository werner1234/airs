...
/*
    ...
    Filename            : saxo_reconV3Import.php


*/

include_once("wwwvars.php");
include_once("saxo_reconV3Functies.php");
...
<style>
  ...
  <ul>
    ...
    if (!saxo_validateFile($_GET["file"]))
    {
      listError($error);
      exit;
    }

    $recon = new AE_cls_reconV3("SAXO", $_SESSION["vbArray"],$_GET["manualBoekdatum"]);
    $batch = "SAXO_" . date("ymd_His");
    $recon->batch = $batch;
    ...
    ob_flush();
    flush();
    $bankRecords = saxo_recon_readBank($_GET["file"]);
