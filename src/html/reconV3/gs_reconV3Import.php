...
/*
    ...
    Filename            : gs_reconV3Import.php


*/

include_once("wwwvars.php");
include_once("gs_reconV3Functies.php");
...
<style>
  ...
  <ul>
    ...
    if (!gs_validateFile($_GET["file"]))
    {
      listError($error);
      exit;
    }

    $recon = new AE_cls_reconV3("GMS", $_SESSION["vbArray"],$_GET["manualBoekdatum"]);
    $batch = "GMS_" . date("ymd_His");
    $recon->batch = $batch;
    ...
    ob_flush();
    flush();
    $bankRecords = gs_recon_readBank($_GET["file"]);
