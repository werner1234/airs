...
include_once("degirov2_reconV3Functies.php");
...
<style>
  ...
  <ul>
    ...
    if (!degirov2_validateFile($_GET["file"]))
    {
      listError($error);
      exit;
    }

    $recon = new AE_cls_reconV3("GIRO", $_SESSION["vbArray"],$_GET["manualBoekdatum"]);
    ...
    ob_flush();
    flush();
    $bankRecords = degirov2_recon_readBank($_GET["file"]);
