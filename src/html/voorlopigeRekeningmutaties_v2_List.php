...
<td class="list_button"><div class="icon"><a href="rekeningmutaties_v2_Edit.php?action=edit&id={id_value}&afschrift_id='.$afschrift_id.'&type=temp" target="content" ><img src="images//16/muteer.gif" width="16" height="16" border="0" alt="" align="absmiddle">&nbsp;</a></div></td>
