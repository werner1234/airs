...
$set = array(
  "banknaam"        => "CAW bank",              //  volledige banknaam
  "depot"           => "CAW",                   //  depotbankcode v/d bank
  "filePrefix"      => "_template",             //  fileprefix
  ...
  "bankCode"        => "CAWcode"                //  veldnaam bankcode in de Fondsentabel
);
