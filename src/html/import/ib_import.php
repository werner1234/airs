...
/*
    ...
    Filename            : ib_import.php


*/
// settings voor import
$set = array(
  "banknaam"        => "IB bank",              //  volledige banknaam
  "depot"           => "IB",                   //  depotbankcode v/d bank
  "filePrefix"      => "ib",             //  fileprefix
  ...
  "transactieCodes" => "ibTransactieCodes",    //  tabelnaam van de transactiecodes
  "bankCode"        => "IBcode"                //  veldnaam bankcode in de Fondsentabel
);
...
while ($data = fgetcsv($handle, 4096, $set["fileDelimit"]))
{
  ...
  if (($data["isin"] != "" OR $data["bankCode"] != "") AND $data[9] != "CASH")
  {
    getFonds();
  }
