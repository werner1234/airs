...
include_once("vlch_functies.php");
include_once "../../classes/AIRS_import_afwijkingen.php";
$afw = new AIRS_import_afwijkingen("VLCH");
...
while ($data = fgetcsv($handle, 4096, ","))
{
  ...
  $prb->hide();
	...
	// datamapping verplaatst naar functie om deze ook in de validatie te kunnen gebruiken
...
Records in VLCH CSV bestand :<?=$row?><br>
