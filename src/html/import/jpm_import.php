...
$set = array(
  "banknaam"        => "JP Morgan",         //  volledige banknaam
  "depot"           => "JPM",                   //  depotbankcode v/d bank
  "filePrefix"      => "jpm",                    //  fileprefix
  ...
  "transactieCodes" => "jpmTransactieCodes",     //  tabelnaam van de transactiecodes
  "bankCode"        => "JPMcode"              //  veldnaam bankcode in de Fondsentabel
);
...
<?
	...
	{
    // sla het regel nummer op in een reeks
    $parts       = trim(explode(":", $foutregel));
    $foutreeks[] = $parts[0];
?>
  	<tr>
...
?>
    ...
    <div id="kopje"></div>
  	...
  	<input type="hidden" name="foutregels" value="<?=implode(",", $foutreeks)?>">
