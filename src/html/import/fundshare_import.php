...
$set = array(
  "banknaam"        => "Fundshare",             //  volledige banknaam
  "depot"           => "FSE",                   //  depotbankcode v/d bank
  "filePrefix"      => "fundshare",             //  fileprefix
  ...
  "transactieCodes" => "NVT",                   //  tabelnaam van de transactiecodes
...
while ($data = fgetcsv($handle, 4096, $set["fileDelimit"]))
{
  ...
  $do_func    = "do_$val";
//  debug($do_func, $data["transactieCode"]);
