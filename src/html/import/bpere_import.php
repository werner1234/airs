...
/*
 		...
 		$Log: bpere_import.php,v $
 		Revision 1.9  2014/07/10 06:53:14  cvs
 		*** empty log message ***
 		
 		Revision 1.8  2013/12/16 08:21:00  cvs
 		*** empty log message ***
 		
 		Revision 1.7  2012/07/05 07:55:43  cvs
 		*** empty log message ***
 		
 		Revision 1.6  2011/10/24 12:25:00  cvs
 		*** empty log message ***
 		
 		Revision 1.5  2010/11/12 10:10:22  cvs
 		*** empty log message ***
 		
 		Revision 1.4  2010/11/03 11:04:28  cvs
 		*** empty log message ***
...
//include_once("import_functies.php");
include_once("bpere_functies.php");


$skipFoutregels = array();


$transactieCodes = array("ACT" => "A",
                         "ASE" => "ST",
                         "ASS" => "OP",
                         "CDE" => "ST",
                         "CPS" => "R",
...
$csvRegels = 1;
include("bpere_validate.php");


$volgnr = 1;
$prb->setLabelValue('txt1','Validatie van Rotschild CSV bestand');
...
// EINDE insert leeg veld in $data[0] om veldnummering gelijk te maken aan de documentatie
   ...
   {  
     ...
     $val = trim($transactieCodes[$data[4]]);
   }
