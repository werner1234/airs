...
/*
 		Author  						: $Author: cvs $
 		Laatste aanpassing	: $Date: 2020/03/30 09:02:15 $
 		File Versie					: $Revision: 1.2 $

 		$Log: btc_import.php,v $
 		Revision 1.2  2020/03/30 09:02:15  cvs
 		call 6712
...
$csvRegels = 1;
include("btc_validate.php");


$volgnr = 1;
$prb->setLabelValue('txt1','Validatie van BTCtrans CSV bestand');
...
//   exit();
  ...
  $data[1] = str_replace("AAA", "",$data[1]);
  $data[4] = str_replace("CP", "R",$data[4]);
  if ($data[10] != 1)
  {
    $data[23] = $data[10];
  }
...
Records in BTC trans CSV bestand :<?=$row?><br>
