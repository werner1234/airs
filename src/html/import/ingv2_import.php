...
/*
 		...
 		$Log: ingv2_import.php,v $
 		Revision 1.4  2020/06/24 09:43:29  cvs
 		call 8713
 		
 		Revision 1.3  2020/06/08 13:11:01  cvs
 		call 8669
 		
 		Revision 1.2  2019/09/18 10:07:39  cvs
 		call 8097
...
include_once("ingv2_functies.php");
include_once "../../classes/AIRS_import_afwijkingen.php";
$afw = new AIRS_import_afwijkingen("ING");
 ...
 * 15.tradePrice,
 * 16.tradePriceFactor,
 * 17.tradeAccruedInterest,
 * 18.settlementCurrency,
 * 19.tradeFXSecurityCurrToSettlementCurr,
 * 20.tradeCommission,
 * 21.tradeExternalCosts,
 * 22.tradeWithholdingTax,
 * 23.tradeStampDuty,
 * 24.tradeExchangeTax,
 * 25.tradeVAT,
 * 26.tradeNetAmount,
 * 27.tradeDebitCredit,
 * 28.settlementDate,
 * 29.settlementAccountID,
 * 30.tradeFXSettlementCurrToPortfolioCurr,
 * 31.tradeRemarks
 */
...
//   exit();
   ...
   if (strstr($data[32], "|"))
   {
     $extra = explode("|", $data[32]);
     $data["sp_rekval"]      = $extra[0];
     $data["sp_tegenval"]    = $extra[1];
     $data["sp_bedrag"]      = $extra[2];
     $data["sp_wisselkoers"] = 1/$extra[3];
   }

   getFonds();

   $num = count($data);
   $val = $transactieMapping[trim($data[11])];
   $transcode = trim($data[11]);  // tbv  errormelding
   $do_func = "do_$val";
