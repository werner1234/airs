...
/*
 		...
 		$Log: kasbank_import.php,v $
 		Revision 1.5  2019/07/08 10:43:40  cvs
 		call 7867
...
include_once("kasbank_functies.php");
...
//  debug($data);
 ...
 // $data = cleanRow($data);
  ...
  if ( function_exists($do_func) )
    ...
    $skipped .= "- $row: transactie ".$portefeuille." / ".$data[24]."(".$tcRec["omschrijving"].") overgeslagen<br>";
