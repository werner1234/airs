...
/*
 		...
 		$Log: atn_import.php,v $
 		Revision 1.4  2014/07/10 06:53:14  cvs
 		*** empty log message ***
...
include_once("atn_functies.php");


$transactieCodes = array("0"=>"ST",
                         "1"=>"OP",
                         "2"=>"ST",
                         "3"=>"OP",
                         "5"=>"ST",
...
$csvRegels = 1;
include("atn_validate.php");


$volgnr = 1;
$prb->setLabelValue('txt1','Validatie van ATN CSV bestand');
...
//   exit();
   ...
   $num = count($data);
   $val = trim($transactieCodes[$data[1]]);
