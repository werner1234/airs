...
/*
 		Author  						: $Author: cvs $
 		Laatste aanpassing	: $Date: 2018/10/03 15:21:33 $
 		File Versie					: $Revision: 1.3 $

 		$Log: mabeltrans_import.php,v $
 		Revision 1.3  2018/10/03 15:21:33  cvs
 		no message
...
include_once("mabeltrans_functies.php");
...
$csvRegels = 1;
include("mabeltrans_validate.php");


$volgnr = 1;
$prb->setLabelValue('txt1','Validatie van Mabeltrans CSV bestand');
