...
/* 	
    ...
    $Log: pdftemplateafbeeldingEdit.php,v $
*/
...
$__funcvar['listurl']  = "pdftemplateafbeeldingList.php";
$__funcvar['location'] = "pdftemplateafbeeldingEdit.php";

$object = new PdfTemplateAfbeelding();
