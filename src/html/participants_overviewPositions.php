...
$editObject->formTemplate = "participants_overviewPositionTemplate.html";
$editObject->usetemplate = true;

//debug($fondsObject->data['table']);
$fondsObject->data['fields']['Fonds']['key_field'] = false;

$fondsObject->data['fields']['date'] = array(
...
$fondsObject->set('date', date('Y-m-d'));
...
//  'datum'                 => array('title' => 'Datum', 'state' => 'checked'),
...
$editObject->formVars['generateXls'] = '<button  type="submit" class="btn btn-gray" name="viewType" value="xls" id="generateCsv">'.maakKnop('csv.png').' ' . vt('Genereer xls') . '</button>';
