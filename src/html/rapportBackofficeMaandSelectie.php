...
/*
    ...
    Author  						: $Author: rvv $
 		Laatste aanpassing	: $Date: 2010/03/10 19:55:29 $
 		File Versie					: $Revision: 1.19 $

 		$Log: rapportBackofficeMaandSelectie.php,v $
 		Revision 1.19  2010/03/10 19:55:29  rvv
 		*** empty log message ***
 		
 		Revision 1.18  2009/04/15 14:29:08  rvv
 		*** empty log message ***

 		Revision 1.17  2008/12/17 13:41:59  rvv
 		*** empty log message ***

 		Revision 1.16  2008/06/30 06:53:04  rvv
 		*** empty log message ***

 		Revision 1.15  2008/05/29 07:22:51  rvv
 		*** empty log message ***

 		Revision 1.14  2007/11/05 15:41:52  rvv
 		*** empty log message ***

 		Revision 1.13  2007/07/05 12:23:59  rvv
 		*** empty log message ***

 		Revision 1.12  2007/02/21 10:57:56  rvv
 		Client / consolidatie toevoeging

 		Revision 1.11  2007/01/16 14:56:41  rvv
 		*** empty log message ***

 		Revision 1.10  2007/01/12 12:51:09  rvv
 		*** empty log message ***

 		Revision 1.9  2006/05/03 07:16:37  jwellner
 		*** empty log message ***

 		Revision 1.8  2006/01/18 11:58:28  jwellner
 		no message
...
function print()
{
	...
	document.selectForm.exportRap.value="";
...
function exportData()
{
	...
	document.selectForm.type.value="maand";
...
<div class="tabbuttonRow">
	...
	<input type="button" class="tabbuttonActive"  id="tabbutton1" value="Maandrapportage">
...
<input type="hidden" name="maandrapportage" value="1" />
...
<td valign="top">
	...
	<input type="button" onclick="javascript:exportData();" value=" Maand Export " style="width:120px"><br><br>
