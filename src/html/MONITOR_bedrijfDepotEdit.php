...
/*
    ...
    $Log: MONITOR_bedrijfDepotEdit.php,v $
...
$__funcvar["listurl"]  = "MONITOR_bedrijfDepotList.php";
$__funcvar["location"] = "MONITOR_bedrijfDepotEdit.php";

$object = new MONITOR_bedrijfDepot();
