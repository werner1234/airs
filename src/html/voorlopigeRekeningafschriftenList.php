...
/*
    ...
    Filename            : voorlopigeRekeningafschriftenList.php
...
$editScript = "voorlopigeRekeningafschriftenEdit.php";
...
$list->setWhere("Portefeuilles.Portefeuille = Rekeningen.Portefeuille $verwerkt AND VoorlopigeRekeningafschriften.Rekening = Rekeningen.Rekening AND Rekeningen.Memoriaal = '".$memSelect."' AND Rekeningen.Consolidatie=0");
...
?>
<br>
<form action="voorlopigeRekeningafschriftenList.php" method="GET"  name="controleForm">
...
<a href="voorlopigeRekeningmutatiesEdit.php?action=new&afschrift_id='.$data['id']['value'].'"><img src="images//16/muteer.gif" width="16" height="16" border="0" alt="" align="absmiddle">&nbsp;</a>
'.$checkbox.'
</td>
