...
Revision 1.4  2016/09/19 11:28:56  rvv
*** empty log message ***

Revision 1.3  2016/09/18 08:47:00  rvv
*** empty log message ***
...
class RapportFISCAAL
{
	function RapportFISCAAL($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
