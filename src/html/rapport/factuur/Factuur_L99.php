...
$this->pdf->ln(20);
$this->pdf->row(array('','Team Junior'));
...
$this->pdf->SetAligns(array('L', 'L'));
$this->pdf->SetWidths(array(10, 20+ 60, 15, 50));
...
$this->pdf->SetFont($this->pdf->rapport_font, '', 8);
  $this->pdf->row(array('','Junior is een handelsnaam van Mercurius Vermogensbeheer B.V.','','Nassaulaan 19, 2514 JT ’s-Gravenhage'));
...
$this->pdf->ln(-4);
$this->pdf->SetFont($this->pdf->rapport_font, '', 8);
$this->pdf->row(array('','','+31(0)85 105 01 02 ','','info@juniorbeleggen.nl','','NL89ABNA0501484108'));
$this->pdf->SetFont($this->pdf->rapport_font, 'B', 8);
$this->pdf->row(array('','KvK','','Internet','','BTW',''));
$this->pdf->ln(-4);
$this->pdf->SetFont($this->pdf->rapport_font, '', 8);
$this->pdf->row(array('','','Handelsregister ’s-Gravenhage nr. 27302787','','www.juniorbeleggen.nl ','','NL 818181709B01'));
