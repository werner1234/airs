<?php
 ...
 if(is_file($this->pdf->rapport_logo))
  {
    $logoWidth=50;
      $this->pdf->Image($this->pdf->rapport_logo, $this->pdf->w-($logoWidth+$extraMarge+5), 5, $logoWidth);
  }
...
$this->pdf->SetWidths(array($extraMarge+110,55));
...
$this->pdf->Row(array('', 'Email: finance@yieldinc.com'));
$this->pdf->Row(array('', 'Telefoon: 088-10 37 700'));

$this->pdf->ln();

$this->pdf->Row(array('', 'KvK-nummer: 80166229'));
$this->pdf->Row(array('', 'BTW-nummer: NL861574151.B.01'));
...
$this->pdf->SetFont($this->pdf->rapport_font,'B',$fontsize);
$this->pdf->Row(array('','NL82ABNA0491231431',$factuurnummer,'€ '.$this->formatGetal($this->waarden['beheerfeeBetalenIncl'],2)));
$this->pdf->SetFont($this->pdf->rapport_font,'',$fontsize);
for($i=0;$i<3;$i++)
...
{
$this->pdf->row(array('', vertaalTekst('Het bovenstaande bedrag wordt binnenkort automatisch van uw rekening bij onze bewaarinstelling afgeschreven.', $this->pdf->rapport_taal)));
}
$this->pdf->ln();
