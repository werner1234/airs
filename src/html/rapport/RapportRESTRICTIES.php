...
/*
Author  						: $Author: rvv $
Laatste aanpassing	: $Date: 2018/09/05 15:50:43 $
File Versie					: $Revision: 1.4 $

$Log: RapportRESTRICTIES.php,v $
Revision 1.4  2018/09/05 15:50:43  rvv
*** empty log message ***
...
class RapportRESTRICTIES
{
	function RapportRESTRICTIES($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum, $valuta = 'EUR')
	{
		$this->pdf = &$pdf;
		$this->pdf->rapport_type = "RESTRICTIES";
    ...
    $maxDagenOud=$dagen['VerouderdeKoersDagen'];
	  ...
	  $this->pdf->widthB = array(10,55,20,20,30,30,5,20,30,30,30);
		...
		$this->pdf->AddPage();
    $this->pdf->templateVars['RESTRICTIESPaginas']=$this->pdf->page;
...
AND (einddatum='0000-00-00' OR einddatum > '".$this->rapportageDatum."')";
		$DB->SQL($query);
		$DB->Query();
