...
class RapportVHO_L61
{
	function RapportVHO_L61($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
...
*/
		$this->pdf->widthB = array(5,68,15,18,15,20,2,16,21,20,22,22,22,15);
		$this->pdf->alignB = array('R','L','R','R','R','R','R','R','R','R','R','R','R','R','R','R');

		// voor kopjes
		$this->pdf->widthA = array(   73,15,18,15,20,2,16,21,20,22,22,22,15);
		$this->pdf->alignA = array('L','R','R','R','R','R','R','R','R','R','R','R','R','R','R');
