...
class RapportVHO_L10
{
	function RapportVHO_L10($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
...
//rvv
    ...
    " TijdelijkeRapportage.beleggingscategorie =  '".$categorien['beleggingscategorie']."' AND ".
      ...
      $n=0;
        ...
        $this->pdf->setX($this->pdf->marge);
        $this->pdf->Cell($this->pdf->widthB[0],4,"");
        $this->pdf->Cell($this->pdf->widthB[1],4,$omschrijving,null,null,null,null,null);
        $this->pdf->setXY($this->pdf->marge,$this->pdf->getY()+$this->pdf->rowHeight);
        $n++;
			}
