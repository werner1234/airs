...
$Log: RapportKERNV_L58.php,v $
Revision 1.4  2018/08/18 12:40:14  rvv
php 5.6 & consolidatie

Revision 1.3  2015/04/22 10:32:05  rvv
*** empty log message ***

Revision 1.2  2015/04/20 06:22:49  rvv
*** empty log message ***

Revision 1.1  2015/04/19 08:35:38  rvv
*** empty log message ***
...
class RapportKERNV_L58
{
	function RapportKERNV_L58($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
  ...
  function formatGetalKoers($waarde, $dec , $start = false)
    ...
    $this->waarden['Historie']=$att->bereken($rapportageStartJaar,  $this->rapportageDatum,'EUR','categorie','maandenYTD');
...
//listarray($this->maandEffectenCumulatief['AAND']);exit;
     ...
     // $this->maandTotalenCumulatief=array('attributieEffect'=>array(),'allocatieEffect'=>array(),'selectieEffect'=>array(),'interactieEffect'=>array());
      foreach($this->maandTotalen as $maand=>$maandWaarden)
        ...
        $this->LineDiagram(20,50+50,120,120-50,$this->maandEffectenCumulatief['AAND'],'Aandelen');
      $this->LineDiagram(160,50+50,120,120-50,$this->maandEffectenCumulatief['OBL'],'Obligaties');
