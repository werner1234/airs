...
/*
    ...
    Author  						: $Author: rvv $
 		Laatste aanpassing	: $Date: 2017/09/30 16:31:15 $
 		File Versie					: $Revision: 1.3 $

 		$Log: ATTberekening_L46.php,v $
 		Revision 1.3  2017/09/30 16:31:15  rvv
 		*** empty log message ***
 		
 		Revision 1.2  2017/05/26 16:45:07  rvv
 		*** empty log message ***
 		
 		Revision 1.1  2016/05/16 07:35:34  rvv
 		*** empty log message ***
 		

*/

class ATTberekening_L46
{

	function ATTberekening_L46($rapportData,$periode='maanden')
	{
...
//echo "<br>\n".$categorie."<br>\n";
  ...
  $perfData['totaal']['ongerealiseerdFondsResultaat']=$ongerealiseerdFondsResultaat+$ongerealiseerdValutaResultaat;
  $perfData['totaal']['ongerealiseerdValutaResultaat']=0;
  ...
  function genereerMutatieLijst($rapportageDatumVanaf,$rapportageDatum,$fonds='')
    ...
    elseif($fonds!='')
      ...
      $fondsenWhere='1';
		...
		"Rekeningmutaties.Boekdatum, Rekeningmutaties.id,".
     ...
     Rekeningmutaties.omschrijving as rekeningOmschrijving,
      ...
      $mutaties['Rapportagekoers']=1;
        ...
        elseif ($this->rapport->pdf->rapportageValuta != 'EUR')
            ...
            $verkoop_koers=1;
            //echo "rvv:".$mutaties['Fonds']. " $resultaatvoorgaande | $resultaatlopende =  (( ".$t_aankoop_waarde." * -1) * ".$mutaties['Rapportagekoers'].") - $beginditjaar;". "<br>\n";
					}
				}
      ...
      if($verkoop_koers <> '')
      {
        ...
        //echo $mutaties['Fonds']." $fondsResultaat $valutaResultaat =".($fondsResultaat+$valutaResultaat)." <br>\n";
      }
