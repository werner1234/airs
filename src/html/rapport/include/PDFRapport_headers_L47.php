...
/* 	
    ...
    Author  						: $Author: rvv $
 		...
 		$Log: PDFRapport_headers_L47.php,v $
 		Revision 1.2  2016/12/30 08:17:59  rvv
 		*** empty log message ***
...
*/
function Header_basis_L47($object)
{
 $pdfObject = &$object;
    ...
    $pdfObject->SetX(0);
	  ...
	  function HeaderPERF_L47($object)
	  {
	    $pdfObject = &$object;
