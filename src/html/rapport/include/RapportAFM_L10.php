...
/*
Author  						: $Author: rvv $
Laatste aanpassing	: $Date: 2018/10/07 08:29:03 $
File Versie					: $Revision: 1.1 $

$Log: RapportAFM_L10.php,v $
...
class RapportAFM_L10
{
	function RapportAFM_L10($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
	  global $__appvar;
		$this->pdf = &$pdf;
