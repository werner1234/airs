...
class rapportHulp_L4
{
  function rapportHulp_L4()
  {
    $this->test='';
  }
}
...
class ATTberekening_L4
{

	function ATTberekening_L4($rapportData)
	{
  ...
  function getPerf_noguit($portefeuille, $datumBegin, $datumEind)
  {
    $this->rapport = new rapportHulp_L4();
    $db=new DB();
