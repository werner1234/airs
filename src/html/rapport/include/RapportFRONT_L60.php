...
/*
Author  						: $Author: rvv $
Laatste aanpassing	: $Date: 2017/09/06 16:30:15 $
File Versie					: $Revision: 1.2 $

$Log: RapportFRONT_L60.php,v $
Revision 1.2  2017/09/06 16:30:15  rvv
*** empty log message ***
...
class RapportFront_L60
{
	function RapportFront_L60($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
