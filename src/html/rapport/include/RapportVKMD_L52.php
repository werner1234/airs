...
$Log: RapportVKMD_L52.php,v $
Revision 1.3  2019/04/10 15:50:36  rvv
*** empty log message ***
...
include_once($__appvar["basedir"]."/html/rapport/include/RapportVKMS_L52.php");

class RapportVKMD_L52
{

	function RapportVKMD_L52($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->vkm=new RapportVKMS_L52($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum);
	}
