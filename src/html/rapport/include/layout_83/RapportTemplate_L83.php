...
/*
Author  						: $Author: rvv $
Laatste aanpassing	: $Date: 2019/07/13 17:50:20 $
File Versie					: $Revision: 1.4 $

$Log: RapportTemplate_L83.php,v $
Revision 1.4  2019/07/13 17:50:20  rvv
*** empty log message ***

Revision 1.3  2019/06/26 10:01:18  rvv
*** empty log message ***
...
class RapportTemplate_L83
{
	function RapportTemplate_L83($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
	  global $__appvar;
		$this->pdf = &$pdf;
    ...
    $valutaOmschrijving=vertaalTekst("in",$this->pdf->rapport_taal).' '. vertaalTekst($this->pdf->valutaOmschrijvingen[$this->pdf->portefeuilledata['RapportageValuta']],$this->pdf->rapport_taal);
       ...
       //$this->pdf->SetFont($pdfObject->rapport_font,'',$this->pdf->rapport_fontsize+8);
	     ...
	     $this->pdf->SetWidths(array(20,160,7));
       $this->pdf->ln(10);
       ...
       foreach ($this->pdf->templateVars as $key=>$value)
       {
         ...
         $dots=round((160-$stringWidth)/($this->pdf->CurrentFont['cw']['.']*$this->pdf->FontSize/1000));
