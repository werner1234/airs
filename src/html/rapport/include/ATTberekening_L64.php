...
/*
    ...
    Author  						: $Author: rvv $
 		...
 		*** empty log message ***
 		...
 		Revision 1.6  2016/02/06 16:42:56  rvv
 		*** empty log message ***
 		
 		Revision 1.5  2015/12/23 17:25:45  rvv
 		*** empty log message ***
 		
 		Revision 1.4  2015/12/23 16:55:01  rvv
 		*** empty log message ***
...
class ATTberekening_L64
{

  function ATTberekening_L64($rapportData, $periode = 'maanden')
  {
  ...
  function bereken($van, $tot, $verdeling = 'Beleggingscategorie')
  {
    global $__appvar;
    $DB = new DB();
...
class indexHerberekening_L64
{
	function indexHerberekening_L64( $selectData )
	{
...
ORDER BY Beleggingscategorien.Afdrukvolgorde desc";
    ...
    //listarray($fondswaarden['eindmaand']);
   	if($valuta <> 'EUR')
