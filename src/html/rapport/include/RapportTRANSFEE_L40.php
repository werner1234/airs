...
$Log: RapportTRANSFEE_L40.php,v $
Revision 1.3  2020/01/22 16:07:06  rvv
*** empty log message ***

Revision 1.2  2019/01/16 08:41:44  rvv
*** empty log message ***

Revision 1.1  2018/01/06 18:10:41  rvv
*** empty log message ***

Revision 1.1  2017/12/13 17:03:53  rvv
*** empty log message ***
...
class RapportTRANSFEE_L40
{
	function RapportTRANSFEE_L40($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		if(is_object($pdf))
		{
			$this->pdf = &$pdf;
