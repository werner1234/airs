...
include_once($__appvar["basedir"]."/html/rapport/include/RapportOIB_L35.php");

//include_once("rapport/ATTberekening2.php");

class RapportOIH_L88
{
	function RapportOIH_L88($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
