...
/*
    ...
    Author  						: $Author: rvv $
 		Laatste aanpassing	: $Date: 2018/10/27 16:49:57 $
 		File Versie					: $Revision: 1.2 $

 		$Log: PreProcessor_L75.php,v $
...
class PreProcessor_L75
{


  function PreProcessor_L75($portefeuille, $datum = '', $pdf)
  {
    global $__appvar;
    $this->portefeuille = $portefeuille;
    $this->rapporten = array();
    $this->portefeuilles = array();
    $this->nodigVoor = array('RISK');
    $berekenen = false;
    $dagen = array();
    ...
    if(count($this->pdf->portefeuilles) < 2)
      return '';
