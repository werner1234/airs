...
/*
    ...
    Author  						: $Author: rvv $
 		...
 		$Log: RapportGRAFIEK_L61.php,v $
 		Revision 1.1  2018/11/17 17:34:53  rvv
 		*** empty log message ***
...
class RapportGRAFIEK_L61
{
	function RapportGRAFIEK_L61($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
