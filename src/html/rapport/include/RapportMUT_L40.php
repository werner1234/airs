...
Revision 1.4  2015/12/19 14:27:30  rvv
*** empty log message ***
...
Revision 1.1  2012/10/02 16:17:32  rvv
*** empty log message ***
...
class RapportMUT_L40
{
	function RapportMUT_L40($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
	...
	function writeRapport()
	{
	  ...
	  if ($this->pdf->rapportageValuta != "EUR" || $this->pdf->rapportageValuta != '')
	   $koersQuery =	" / (SELECT Koers FROM Valutakoersen WHERE Valuta='".$this->pdf->rapportageValuta."' AND Datum <= Rekeningmutaties.Boekdatum ORDER BY Datum DESC LIMIT 1 ) ";
		...
		$DB = new DB();
		// voor data
		$this->pdf->widthA = array(5,0,110,25,35,40,25,25,15);
		$this->pdf->alignA = array('R','R','L','R','R','R','R','R');

		// voor kopjes 40
		$this->pdf->widthB = array(5,0,110,25,35,40,25,25,15);
      ...
      if($_POST['anoniem']==1)
        $mutaties['Rekening']='000000'.$mutaties['Valuta'];
