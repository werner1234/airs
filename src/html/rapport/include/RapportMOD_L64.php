...
class RapportMOD_L64
{
	function RapportMOD_L64($pdf, $portefeuille, $rapportageDatum)
	{
		$this->pdf = &$pdf;
	...
	function writeRapport()
	{
		...
		// voor data
		$this->pdf->widthB = array(10,58,25,17,25,25,25,5);
		$this->pdf->alignB = array('L','L','L','R','R','R','R','R');

		// voor kopjes
		$this->pdf->widthA = array(68,25,17,25,25,25,5);
