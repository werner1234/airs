...
/*
    ...
    Author  						: $Author: rvv $
 		Laatste aanpassing	: $Date: 2017/11/08 10:10:28 $
 		File Versie					: $Revision: 1.2 $

 		$Log: RapportPERFD_L50.php,v $
 		Revision 1.2  2017/11/08 10:10:28  rvv
 		*** empty log message ***
 		
 		Revision 1.1  2017/11/04 17:40:21  rvv
 		*** empty log message ***
...
class RapportPERFD_L50
{

  function RapportPERFD_L50($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
  {
    $this->pdf = &$pdf;
...
//echo "Norm ".$this->rapportageDatumVanaf.",$eind,".$this->pdf->rapportageValuta.",hoofdcategorie <br>\n";
      $hcatData = $att->bereken($this->rapportageDatumVanaf, $eind, $this->pdf->rapportageValuta, 'categorie');
