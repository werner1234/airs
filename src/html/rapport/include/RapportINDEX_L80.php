...
/*
Author  						: $Author: rvv $
Laatste aanpassing	: $Date: 2019/01/30 16:47:26 $
File Versie					: $Revision: 1.3 $

$Log: RapportINDEX_L80.php,v $
...
class RapportIndex_L80
{
	function RapportIndex_L80($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
...
ORDER BY Valutas.Afdrukvolgorde";
	...
	//	$this->pdf->SetY(40);
  	$this->pdf->SetWidths(array(10,80,33,33,33,33,33));
