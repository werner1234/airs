...
/*
Author  						: $Author: rvv $
Laatste aanpassing	: $Date: 2017/09/16 18:07:12 $
File Versie					: $Revision: 1.5 $

$Log: RapportOIB_L72.php,v $
Revision 1.5  2017/09/16 18:07:12  rvv
*** empty log message ***
...
class RapportOIB_L72
{
	function RapportOIB_L72($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
...
IF (TijdelijkeRapportage.type = 'rekening','Liquiditeiten',  TijdelijkeRapportage.Bewaarder) as beleggingscategorie,
TijdelijkeRapportage.beleggingscategorieVolgorde ,
TijdelijkeRapportage.type,
IF (TijdelijkeRapportage.type = 'rekening','Liquiditeiten',Depotbanken.Omschrijving) AS categorieOmschrijving,
...
IF (TijdelijkeRapportage.type = 'rekening',concat('ZZ_Liquiditeiten',Depotbanken.Omschrijving),Depotbanken.Omschrijving) AS BewaarderGroup,
IF (TijdelijkeRapportage.type = 'rekening',TijdelijkeRapportage.id,'') AS rekeningUniek,
...
TijdelijkeRapportage.rapportageDatum='".$this->rapportageDatum."' AND TijdelijkeRapportage.portefeuille='".$this->portefeuille."' ".$__appvar['TijdelijkeRapportageMaakUniek']."
GROUP BY
BewaarderGroup,	TijdelijkeRapportage.fondsOmschrijving,	TijdelijkeRapportage.ValutaVolgorde,rekeningUniek
HAVING tonen <> 0
ORDER BY BewaarderGroup ,TijdelijkeRapportage.fondspaar,TijdelijkeRapportage.fondsOmschrijving,TijdelijkeRapportage.ValutaVolgorde
			...
			if($data['type']=='rekening')
			{
				...
				foreach($ibanParts as $index=>$waarde)
				{
					...
					if(strlen($waarde)==1)
					{
						...
						$align='R';
					$this->pdf->setX($x);
					$this->pdf->cell($ibanCellen[$index],4,$waarde,0,0,$align);
				}
