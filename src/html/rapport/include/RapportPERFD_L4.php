...
/*
Author  						: $Author: rvv $
Laatste aanpassing	: $Date: 2018/01/06 18:10:41 $
File Versie					: $Revision: 1.6 $

$Log: RapportPERFD_L4.php,v $
...
class RapportPERFD_L4
{
	function RapportPERFD_L4($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
