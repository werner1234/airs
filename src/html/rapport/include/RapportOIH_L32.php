...
class RapportOIH_L32
{
	function RapportOIH_L32($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
  ...
  function getDividend($fonds)
  {
	...
	function writeRapport()
	{
		...
		$this->pdf->widthB = array(5,73,2,3,1,20,5,13,1,21,27,31,31,31,17);
		$this->pdf->alignB = array('R','L','R','R','R','R','R','R','R','R','R','R','R','R','R','R');
//echo 297-array_sum($this->pdf->widthB)-$this->pdf->marge*2;exit;
		// voor kopjes
		$this->pdf->widthA = array(   75,22,23,1,20,5,13,1,21,17,21,21,21,17);
...
//echo $subquery."<br><br>";exit;
      ...
      $grandtotaaldividendCorrected  += $subtotaal['totaalDividendCorrected'];
		...
		$this->printTotaal(vertaalTekst("Totale actuele waarde",$this->pdf->rapport_taal), "", $actueleWaardePortefeuille,100,$grandtotaalfonds,$grandtotaalvaluta,"",true,$grandtotaaldividend);
