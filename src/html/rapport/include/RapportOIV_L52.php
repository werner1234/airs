...
$Log: RapportOIV_L52.php,v $
Revision 1.3  2019/05/01 15:53:25  rvv
*** empty log message ***

Revision 1.2  2019/04/10 15:50:36  rvv
*** empty log message ***
...
class RapportOIV_L52
{
	function RapportOIV_L52($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
  ...
  function formatGetalKoers($waarde, $dec , $start = false)
	...
	function writeRapport()
	{
		...
		" TijdelijkeRapportage.valuta, TijdelijkeRapportage.beleggingscategorie, TijdelijkeRapportage.actueleValuta, TijdelijkeRapportage.type, ".
		" SUM(TijdelijkeRapportage.actuelePortefeuilleWaardeInValuta) AS subtotaalactueelvaluta, ".
		" SUM(TijdelijkeRapportage.actuelePortefeuilleWaardeEuro) AS subtotaalactueel ".
		" FROM TijdelijkeRapportage ".
		" WHERE TijdelijkeRapportage.portefeuille = '".$this->portefeuille."' AND ".
		" TijdelijkeRapportage.rapportageDatum = '".$this->rapportageDatum."' AND TijdelijkeRapportage.beleggingscategorie <> 'Liquiditeiten' "
		 .$__appvar['TijdelijkeRapportageMaakUniek'].
