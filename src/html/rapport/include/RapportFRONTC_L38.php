...
$Log: RapportFRONTC_L38.php,v $
Revision 1.1  2019/11/02 15:20:30  rvv
*** empty log message ***
...
include_once($__appvar["basedir"]."/html/rapport/include/RapportFRONT_L38.php");

class RapportFRONTC_L38
{
	function RapportFRONTC_L38($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
    $this->rapport = new RapportFRONT_L38($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum);
  }
