...
/*
Author  						: $Author: rvv $
Laatste aanpassing	: $Date: 2014/09/17 15:16:31 $
File Versie					: $Revision: 1.1 $

$Log: RapportVOLKD_L5.php,v $
...
class RapportVOLKD_L5
{
	function RapportVOLKD_L5($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum, $valuta = 'EUR')
	{
		$this->pdf = &$pdf;
