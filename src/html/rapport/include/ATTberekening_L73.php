...
/*
    ...
    Author  						: $Author: rvv $
 		Laatste aanpassing	: $Date: 2017/10/07 17:21:21 $
 		File Versie					: $Revision: 1.2 $

 		$Log: ATTberekening_L73.php,v $
 		Revision 1.2  2017/10/07 17:21:21  rvv
 		*** empty log message ***
...
class ATTberekening_L73
{

	function ATTberekening_L73($rapportData,$periode='maanden')
	{
