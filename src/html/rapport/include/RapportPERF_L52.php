...
$Log: RapportPERF_L52.php,v $
Revision 1.7  2019/05/04 18:22:49  rvv
*** empty log message ***

Revision 1.6  2019/05/01 15:53:25  rvv
*** empty log message ***

Revision 1.5  2019/04/24 08:00:20  rvv
*** empty log message ***

Revision 1.4  2019/04/10 15:50:36  rvv
*** empty log message ***

Revision 1.3  2019/04/07 11:07:21  rvv
*** empty log message ***
...
class RapportPERF_L52
{

	function RapportPERF_L52($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
    ...
    $this->att=new ATTberekening_L52($this);
	}
