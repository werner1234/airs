...
include_once("rapport/include/layout_129/ATTberekening_L129.php");

class RapportPERF_L129
{

	function RapportPERF_L129($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
    ...
    $this->att=new ATTberekening_L129($this);
	}
...
function addResultaat()
{
  ...
  $vetralingGrootboek=$this->getGrootboeken();
    ...
    $att=new ATTberekening_L129($this);
