...
$Log: RapportPERFD_L43.php,v $
Revision 1.5  2018/08/18 12:40:14  rvv
php 5.6 & consolidatie

Revision 1.4  2017/07/30 10:19:36  rvv
*** empty log message ***
...
include_once("rapport/include/ATTberekening_L43.php");

class RapportPERFD_L43
{

	function RapportPERFD_L43($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
    ...
    $this->att=new ATTberekening_L43($this);
	}
...
function addResultaat()
{
  ...
  $vetralingGrootboek=$this->getGrootboeken();
    ...
    $att=new ATTberekening_L43($this);
