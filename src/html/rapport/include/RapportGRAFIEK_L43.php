...
/*
    ...
    Author  						: $Author: rvv $
 		Laatste aanpassing	: $Date: 2016/10/09 14:45:08 $
 		File Versie					: $Revision: 1.1 $

 		$Log: RapportGRAFIEK_L43.php,v $
...
class RapportGRAFIEK_L43
{
	function RapportGRAFIEK_L43($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
