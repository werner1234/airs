...
$Log: RapportTemplate_L64.php,v $
Revision 1.2  2016/01/27 17:08:53  rvv
*** empty log message ***
...
class RapportTemplate_L64
{
	function RapportTemplate_L64($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
	  global $__appvar;
		$this->pdf = &$pdf;
