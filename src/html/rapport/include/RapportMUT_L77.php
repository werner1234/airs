...
$Log: RapportMUT_L77.php,v $
Revision 1.4  2020/03/18 17:44:11  rvv
*** empty log message ***

Revision 1.3  2018/10/07 13:39:46  rvv
*** empty log message ***

Revision 1.2  2018/10/07 10:19:56  rvv
*** empty log message ***

Revision 1.1  2018/10/06 17:20:57  rvv
*** empty log message ***
...
class RapportMUT_L77
{
	function RapportMUT_L77($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
		$this->pdf->rapport_type = "MUT";
		$this->pdf->rapport_datum = db2jul($rapportageDatum);
		$this->pdf->rapport_datumvanaf = db2jul($rapportageDatumVanaf);
		$this->pdf->rapport_titel = "Overige mutaties";
