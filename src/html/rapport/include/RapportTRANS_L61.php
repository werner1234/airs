...
$Log: RapportTRANS_L61.php,v $
Revision 1.5  2019/06/21 14:52:45  rm
7880
...
class RapportTRANS_L61
{
	function RapportTRANS_L61($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
	  ...
	  if ($this->pdf->rapportageValuta != "EUR" || $this->pdf->rapportageValuta != '')
	   $koersQuery =	" / (SELECT Koers FROM Valutakoersen WHERE Valuta='".$this->pdf->rapportageValuta."' AND Datum <= Rekeningmutaties.Boekdatum ORDER BY Datum DESC LIMIT 1 ) ";
		...
		$db2 = new DB();
			...
			// voor data
		$this->pdf->widthB = array(15,16,17,70,18,26,18,26,20,20,20,13);
...
//	echo "lopende -> ".$resultaatlopende." <-  voorgaande ".$resultaatvoorgaande. " -  <br>" ;
	  ...
	  $this->pdf->CellBorders=array('','','','','',array('UU','T'),'',array('UU','T'),'','',array('UU','T'));
		$this->pdf->row(array("",
								"",
								"",
								"",
