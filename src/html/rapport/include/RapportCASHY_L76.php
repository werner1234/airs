...
/*
    ...
    Author  						: $Author: rvv $
 		...
 		$Log: RapportCASHY_L76.php,v $
 		Revision 1.3  2018/04/28 18:36:15  rvv
 		*** empty log message ***
 		
 		Revision 1.2  2018/04/22 09:30:28  rvv
 		*** empty log message ***
 		
 		Revision 1.1  2018/04/18 16:18:39  rvv
 		*** empty log message ***
 		
 		Revision 1.1  2013/10/12 15:54:06  rvv
 		*** empty log message ***
...
class RapportCASHY_L76
{
	function RapportCASHY_L76($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
	 //
		$this->pdf = &$pdf;
...
$this->pdf->CellBorders = array();
	...
	function VBarDiagram($w, $h, $data,$titel)
  {
    ...
    //  $colors=array('rente'=>array(20,150,20),
    //  'lossing'=>array(20,20,150));

      $colors=array('rente'=>array($this->pdf->rapport_oranje[0],$this->pdf->rapport_oranje[1],$this->pdf->rapport_oranje[2]),
      'lossing'=>array($this->pdf->rapport_blauw[0],$this->pdf->rapport_blauw[1],$this->pdf->rapport_blauw[2]));
