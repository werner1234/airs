...
/*
    ...
    Author  						: $Author: rvv $
 		...
 		*** empty log message ***
 		...
 		Revision 1.2  2015/08/30 11:44:35  rvv
 		*** empty log message ***
 		
 		Revision 1.1  2014/11/30 13:19:33  rvv
 		*** empty log message ***
...
class RapportKERNZ_L30
{
	function RapportKERNZ_L30($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
	 //
		$this->pdf = &$pdf;
