...
include_once("rapport/include/ATTberekening_L53.php");

class RapportPERFD_L53
{

	function RapportPERFD_L53($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
    ...
    $this->att=new ATTberekening_L53($this);
	}
