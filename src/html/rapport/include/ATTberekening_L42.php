...
/*
    ...
    Author  						: $Author: rvv $
 		Laatste aanpassing	: $Date: 2019/02/04 07:11:10 $
 		File Versie					: $Revision: 1.31 $

 		$Log: ATTberekening_L42.php,v $
 		Revision 1.31  2019/02/04 07:11:10  rvv
 		*** empty log message ***
 		
 		Revision 1.30  2019/02/03 17:52:57  rvv
 		*** empty log message ***
...
class ATTberekening_L42
{

	function ATTberekening_L42($rapportData,$periode='maanden')
	{
