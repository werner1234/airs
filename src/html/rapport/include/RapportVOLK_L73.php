...
$Log: RapportVOLK_L73.php,v $
Revision 1.11  2018/12/01 19:51:30  rvv
*** empty log message ***
...
class RapportVOLK_L73
{
	function RapportVOLK_L73($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
