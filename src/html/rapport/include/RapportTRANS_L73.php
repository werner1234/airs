...
$Log: RapportTRANS_L73.php,v $
Revision 1.8  2019/08/07 15:30:49  rvv
*** empty log message ***

Revision 1.7  2019/02/06 16:07:12  rvv
*** empty log message ***

Revision 1.6  2018/12/30 07:39:13  rvv
*** empty log message ***

Revision 1.5  2018/12/29 13:57:23  rvv
*** empty log message ***

Revision 1.4  2017/10/18 06:26:55  rvv
*** empty log message ***
...
class RapportTRANS_L73
{
	function RapportTRANS_L73($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
...
//18
    ...
    JOIN Beleggingscategorien ON BeleggingscategoriePerFonds.Beleggingscategorie = Beleggingscategorien.Beleggingscategorie ".
			...
			"ORDER BY Rekeningmutaties.Transactietype,Rekeningmutaties.Boekdatum,Rekeningmutaties.Fonds,Rekeningmutaties.Valuta,  Rekeningmutaties.id";
    ...
    {
      $txt = 'De onderstaande transacties zijn gebaseerd op de uitgangspunten voor uw beleggingen, waaronder uw financiële situatie, beleggingsdoel, beleggingshorizon, risicoprofiel en kennis & ervaring. Deze uitgangspunten worden periodiek (in beginsel jaarlijks) met u besproken. De transacties zijn passend bevonden voor het met u overeengekomen risicoprofiel.';
