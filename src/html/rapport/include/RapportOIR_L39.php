...
Revision 1.1  2016/09/14 15:45:54  rvv
*** empty log message ***

Revision 1.16  2014/01/18 17:27:23  rvv
*** empty log message ***

Revision 1.15  2014/01/04 17:06:27  rvv
*** empty log message ***

Revision 1.14  2013/12/23 16:43:01  rvv
*** empty log message ***

Revision 1.13  2013/11/30 14:24:56  rvv
*** empty log message ***

Revision 1.12  2013/11/27 16:29:11  rvv
*** empty log message ***

Revision 1.11  2013/11/24 16:04:03  rvv
*** empty log message ***

Revision 1.10  2013/11/24 15:06:07  rvv
*** empty log message ***

Revision 1.9  2013/11/23 17:23:24  rvv
*** empty log message ***

Revision 1.8  2013/04/17 11:37:12  rvv
*** empty log message ***
...
class RapportOIR_L39
{
	function RapportOIR_L39($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
...
Left Join Fondsen ON Fondsen.Fonds = TijdelijkeRapportage.Fonds      
      ...
      TijdelijkeRapportage.regioVolgorde asc,
 ...
 //$this->pdf->SetFillColor($this->pdf->rapport_kop_bgcolor['r']*1.2,$this->pdf->rapport_kop_bgcolor['g']*1.2,$this->pdf->rapport_kop_bgcolor['b']*1.2);
		...
		while($fonds = $DB->NextRecord())
		{
		  ...
		  if($fonds['regioOmschrijving']=='')
		    $fonds['regioOmschrijving']='Geen sector';
...
*/
			...
			if($lastSector <> $fonds['regioOmschrijving'] && $fonds['regioOmschrijving'] <> '')
			{
					$this->printKop('       '.vertaalTekst($fonds['regioOmschrijving'],$this->pdf->rapport_taal), "b");
			}
  ...
  $beginWaardeEur=  $this->formatGetal($fonds[beginPortefeuilleWaardeEuro],$this->pdf->rapport_VOLK_decimaal,true);
      ...
      if($fonds['type']=='rente')
        $totaalactueelRente+=$fonds['actuelePortefeuilleWaardeEuro'];
			...
			$lastSector = $fonds['regioOmschrijving'];
