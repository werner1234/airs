...
/*
Author  						: $Author: rvv $
Laatste aanpassing	: $Date: 2019/01/16 08:41:44 $
File Versie					: $Revision: 1.2 $

$Log: RapportTRANSFEE_L55.php,v $
...
class RapportTRANSFEE_L55
{
	function RapportTRANSFEE_L55($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		if(is_object($pdf))
		{
			$this->pdf = &$pdf;
