...
$Log: RapportHSE_L32.php,v $
Revision 1.3  2017/05/25 14:35:58  rvv
*** empty log message ***

Revision 1.2  2015/12/05 14:38:50  rvv
*** empty log message ***
...
class RapportHSE_L32
{
	function RapportHSE_L32($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum, $valuta = 'EUR')
	{
		$this->pdf = &$pdf;
	...
	function writeRapport()
	{
		...
		{
		// voor data
	  $this->pdf->widthB = array(10,55,20,30,30,30,5,30,30,30,5);
		$this->pdf->alignB = array('L','L','R','R','R','R','R','R','R','R','R');

		// voor kopjes
		$this->pdf->widthA = array(65,20,30,30,30,5,30,30,30,5);
...
//		{
    ...
    SUM(TijdelijkeRapportage.beginPortefeuilleWaardeEuro) / ".$this->pdf->ValutaKoersBegin. ") as subtotaalbegin, ".
		...
		// print grandtotaal
		$this->printTotaal(vertaalTekst("Totale actuele waarde vermogen",$this->pdf->rapport_taal), "", $actueleWaardePortefeuille,100,true);
