...
/*
Author  						: $Author: rvv $
Laatste aanpassing	: $Date: 2018/10/03 15:42:01 $
File Versie					: $Revision: 1.1 $

$Log: RapportTemplate_L80.php,v $
...
class RapportTemplate_L80
{
	function RapportTemplate_L80($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
	  global $__appvar;
		$this->pdf = &$pdf;
