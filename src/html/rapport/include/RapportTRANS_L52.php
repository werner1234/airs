...
$Log: RapportTRANS_L52.php,v $
Revision 1.2  2019/08/07 15:30:49  rvv
*** empty log message ***
...
class RapportTRANS_L52
{
	function RapportTRANS_L52($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
