...
/*
Author  						: $Author: rvv $
Laatste aanpassing	: $Date: 2016/12/03 19:22:25 $
File Versie					: $Revision: 1.2 $

$Log: RapportVOLK_L4.php,v $
Revision 1.2  2016/12/03 19:22:25  rvv
*** empty log message ***

Revision 1.1  2012/11/07 17:08:18  rvv
*** empty log message ***
...
class RapportVOLK_L4
{
	function RapportVOLK_L4($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
	...
	function writeRapport()
	{
		...
		{ //15 -> 19
			$this->pdf->widthB = array(10,50+$omschrijvingExtra,18,19,21,21,1,19,21,21,15,21,1,19,15);
			$this->pdf->alignB = array('R','L','R','R','R','R','R','R','R','R','R','R','R','R','R');

		// voor kopjes
			$this->pdf->widthA = array(60+$omschrijvingExtra,18,19,21,21,1,19,21,21,15,21,1,19,15);
			$this->pdf->alignA = array('L','R','R','R','R','R','R','R','R','R','R','R','R','R');
		}
