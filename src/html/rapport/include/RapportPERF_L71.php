...
include_once("rapport/include/ATTberekening_L71.php");

class RapportPERF_L71
{

	function RapportPERF_L71($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
    ...
    $this->att=new ATTberekening_L71($this);
	}
