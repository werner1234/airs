...
$Log: RapportTRANS_L57.php,v $
Revision 1.4  2020/03/04 16:40:47  rvv
*** empty log message ***

Revision 1.3  2020/02/29 16:24:09  rvv
*** empty log message ***

Revision 1.2  2020/01/15 14:29:50  rvv
*** empty log message ***
...
class RapportTRANS_L57
{
	function RapportTRANS_L57($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
    ...
    $this->pdf->rapport_TRANS_decimaal=0;
	...
	function writeRapport()
	{
	  ...
	  if ($this->pdf->rapportageValuta != "EUR" || $this->pdf->rapportageValuta != '')
	   $koersQuery =	" / (SELECT Koers FROM Valutakoersen WHERE Valuta='".$this->pdf->rapportageValuta."' AND Datum <= Rekeningmutaties.Boekdatum ORDER BY Datum DESC LIMIT 1 ) ";
		...
		{
		// voor data
		$this->pdf->widthB = array(15,10,20,58,16,18,18,16,18,18,18,22,22,12);
		$this->pdf->alignB = array('L','L','R','L','R','R','R','R','R','R','R','R','R','R');
		// voor kopjes
		$this->pdf->widthA = array(15,10,20,58,16,18,18,16,18,18,18,22,22,12);
        ...
        else
        {
          $koersValuta = '';
			  ...
			  if (round($koers,2 >0))
			    ...
			    {
			       $provisieTxt = $this->formatGetal($mutaties['kosten'],0);
			    ...
			    {
			       $totaalTransactieTxt = $this->formatGetal($totaalTransactie-$mutaties['kosten'],0);
			    }
			    else
			    $totaalTransactieTxt = '';
...
//echo ($this->pdf->getY()-$startY);exit;
