...
class RapportEND_L110
{
  function RapportEND_L110($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
  {
    $this->pdf = &$pdf;
    $this->pdf->rapport_type = "END";
    $this->pdf->rapport_datum = db2jul($rapportageDatum);
    
    $this->pdf->rapport_titel = 'Verklarende woordenlijst';
...
ORDER BY begrippenCategorie.afdrukVolgorde,begrippenCategorie.categorie, begrippenRapport.afdrukVolgorde,begrippenRapport.begrip ";
    ...
    $this->pdf->CellFontStyle=array(array($this->pdf->rapport_font,'B',$this->pdf->rapport_fontsize+$fontSizeCorrectie),
      array($this->pdf->rapport_font,'B',$this->pdf->rapport_fontsize+$fontSizeCorrectie),
      array($this->pdf->rapport_font,'',$this->pdf->rapport_fontsize+$fontSizeCorrectie));
    ...
    foreach($begrippen as $categorie=>$begripData)
    {
      ...
      $this->pdf->SetFont($this->pdf->rapport_font,'',$this->pdf->rapport_fontsize+$fontSizeCorrectie);
      $this->pdf->SetWidths(array($extraMarge,40,220));
