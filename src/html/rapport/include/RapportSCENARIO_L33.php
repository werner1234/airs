...
$Log: RapportSCENARIO_L33.php,v $
Revision 1.1  2018/01/31 17:21:26  rvv
*** empty log message ***
...
class RapportSCENARIO_L33
{
	function RapportSCENARIO_L33($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
