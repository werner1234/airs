...
/*
Author  						: $Author: rvv $
Laatste aanpassing	: $Date: 2014/10/29 16:47:19 $
File Versie					: $Revision: 1.6 $

$Log: RapportOIB_L27.php,v $
...
class RapportOIB_L27
{
	function RapportOIB_L27($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
		$this->pdf->rapport_type = "OIB_l27";
