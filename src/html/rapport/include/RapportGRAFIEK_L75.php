...
$Log: RapportGRAFIEK_L75.php,v $
Revision 1.3  2020/07/15 16:38:19  rvv
*** empty log message ***

Revision 1.2  2020/06/03 15:41:22  rvv
*** empty log message ***

Revision 1.1  2020/03/11 15:18:12  rvv
*** empty log message ***
...
class RapportGRAFIEK_L75
{
	function RapportGRAFIEK_L75($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = $pdf;
...
//listarray($colorArray);listarray($data);
    foreach($kleurdata as $key=>$val)
    {
      ...
      $this->pdf->Cell($legendWidth , $hval,vertaalTekst($key ,$this->pdf->rapport_taal).' ('.$this->formatGetal($val['percentage'],1).'%)',0,0,'R');
      $i++;
    }
