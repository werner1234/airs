...
class RapportPERFG_L12
{

  function RapportPERFG_L12($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
	  global $__appvar;
		$this->pdf = &$pdf;
  ...
  function writeRapport()
    ...
    $this->attKleuren['totaal']=$this->attKleuren['Totaal'];
...
$datumStop  = db2jul($eind);
    ...
    */
    ...
    $this->waarden=array();
    $this->tmp['rapportagePeriode']=$this->berekening->bereken($start,$this->rapportageDatum);
    $categorien=$this->berekening->categorien;
    
   // listarray( $this->tmp['rapportagePeriode']);
foreach ($this->tmp['rapportagePeriode']['totaal']['perfWaarden'] as $datum=>$data)
{
  ...
  { //listarray($this->tmp['rapportagePeriode'][$categorie]['perfWaarden']);
    $this->waarden[$categorie][$datum]['waarde']=$this->tmp['rapportagePeriode'][$categorie]['perfWaarden'][$datum]['eindwaarde'];
    $this->waarden[$categorie][$datum]['perf']=$this->tmp['rapportagePeriode'][$categorie]['perfWaarden'][$datum]['procent']*100;
    $this->waarden[$categorie][$datum]['stortingen']=$this->tmp['rapportagePeriode'][$categorie]['perfWaarden'][$datum]['stort'];
    $this->waarden[$categorie][$datum]['resultaat']=($this->tmp['rapportagePeriode'][$categorie]['perfWaarden'][$datum]['eindwaarde']-$this->tmp['rapportagePeriode'][$categorie]['perfWaarden'][$datum]['beginwaarde'])-
      $this->tmp['rapportagePeriode'][$categorie]['perfWaarden'][$datum]['stort'];
  }
}
...
*/
$header=array('',"Jaar\n ");
$headerCat=array_values($categorien);
unset($headerCat[0]);
