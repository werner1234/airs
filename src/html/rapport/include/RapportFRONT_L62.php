...
/*
Author  						: $Author: rvv $
Laatste aanpassing	: $Date: 2016/03/30 10:35:05 $
File Versie					: $Revision: 1.4 $

$Log: RapportFRONT_L62.php,v $
Revision 1.4  2016/03/30 10:35:05  rvv
*** empty log message ***

Revision 1.3  2015/12/16 17:07:25  rvv
*** empty log message ***
...
class RapportFront_L62
{
	function RapportFront_L62($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
...
$this->pdf->Cell(297,5,$portefeuilledata['vermogensbeheerderAdres'].', '.$portefeuilledata['vermogensbeheerderWoonplaats'].' - www.ambassadorinvestments.nl - info@ambassadorinvestments.nl - 035-2031035',0,1,'C');
