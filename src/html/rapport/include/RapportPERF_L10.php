...
/*
Author  						: $Author: rvv $
Laatste aanpassing	: $Date: 2019/01/16 16:28:10 $
File Versie					: $Revision: 1.4 $

$Log: RapportPERF_L10.php,v $
...
include_once("rapport/include/ATTberekening_L10.php");

class RapportPERF_L10
{

	function RapportPERF_L10($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
    ...
    $this->att=new ATTberekening_L10($this);
	}
...
function addResultaat()
{
  ...
  $vetralingGrootboek=$this->getGrootboeken();
    ...
    $att=new ATTberekening_L10($this);
...
foreach($categorien as $categorie)
{
  ...
  foreach($categorien as $categorie)
  {
    ...
    if($categorie=='Liquiditeiten' || $categorie=='LIQ')
    {
      $rendement[]='';
      $rendement[]='';
      $rendementKwartaal[]='';
