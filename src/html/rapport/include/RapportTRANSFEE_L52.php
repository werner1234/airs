...
/*
    ...
    Author  						: $Author: rvv $
 		...
 		$Log: RapportTRANSFEE_L52.php,v $
 		Revision 1.20  2018/01/13 19:10:29  rvv
 		*** empty log message ***
...
class RapportTRANSFEE_L52
{
	function RapportTRANSFEE_L52($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
	 //
		$this->pdf = &$pdf;
