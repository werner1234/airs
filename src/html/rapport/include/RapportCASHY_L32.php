...
class RapportCASHY_L32
{
	function RapportCASHY_L32($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
        	$this->pdf = &$pdf;
...
$this->pdf->CellBorders = array();
	...
	function VBarDiagram($w, $h, $data,$titel)
  {
      ...
      $colors=array('rente'=>array($this->pdf->rapport_voet_bgcolor[0],$this->pdf->rapport_voet_bgcolor[1],$this->pdf->rapport_voet_bgcolor[2]),
