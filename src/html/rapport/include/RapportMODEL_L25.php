...
$Log: RapportMODEL_L25.php,v $
Revision 1.9  2020/05/02 15:57:50  rvv
*** empty log message ***

Revision 1.8  2020/03/11 16:21:41  rvv
*** empty log message ***

Revision 1.7  2018/11/03 18:45:31  rvv
*** empty log message ***
...
Revision 1.4  2015/10/07 19:38:52  rvv
*** empty log message ***
...
Revision 1.1  2013/11/17 13:17:44  rvv
*** empty log message ***
...
class RapportModel_L25
{
	...
	*/
	...
	function RapportModel_L25($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
	  $this->pdf = &$pdf;
		$this->selectData =
	...
	function writeRapport()
	{
      ...
      {
        echo "Geen model aan portefeuille ".$this->portefeuille." gekoppeld.";
        exit;
      }
        ...
        array_push($totaalRekeningen,array("Liquiditeiten","Model waarde","Herziene waarde"));
			...
			while($fdata = $DB2->nextRecord())
			{
				...
				if ($fdata['portefeuilleWaarde'] != 0)
				{
				   ...
				   $this->pdf->excelData[] = array("Effectenrekening ".$fdata['fondsOmschrijving'],
