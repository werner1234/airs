...
class RapportTemplate_L122
{
	function RapportTemplate_L122($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
	  global $__appvar;
		$this->pdf = &$pdf;
    ...
    $totPagina = ($lastpage-$startpagina+$paginaCorrectie);//-1
       ...
       $inhoudsItems=array('PERFPaginas'=>'Performance over de beleggingscategorieën',
        ...
        {
          if($this->pdf->templateVarsOmschrijving[$key] || $inhoudsItems[$key]) //
          {
