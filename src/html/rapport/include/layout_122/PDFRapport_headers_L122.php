...
function Header_basis_L122($object)
{
 $pdfObject = &$object;
    ...
    if(strlen($pdfObject->rapport_logo_beeld)>0)
    {
      ...
      $pdfObject->memImage($pdfObject->rapport_logo_beeld,$pdfObject->w/2-$w/2,$pdfObject->h-10,$w);
 		...
 		else if(!empty($pdfObject->rapport_logo_tekst))
		{
			...
			$pdfObject->MultiCell($pdfObject->w-$pdfObject->marge*2	,4,$pdfObject->rapport_logo_tekst,0, "C");
			$pdfObject->SetTextColor($pdfObject->rapport_kop2_fontcolor['r'],$pdfObject->rapport_kop2_fontcolor['g'],$pdfObject->rapport_kop2_fontcolor['b']);
			$pdfObject->SetFont($pdfObject->rapport_font,'',$pdfObject->rapport_fontsize);
		}
...
function HeaderHSE_L122($object)
{
  $pdfObject = &$object;
  $pdfObject->ln();
  ...
  $pdfObject->Rect($pdfObject->marge, $pdfObject->getY(), array_sum($pdfObject->widthA), 12 , 'F');
  ...
  $pdfObject->ln();
    $pdfObject->row(array("Categorie\n"."     ".vertaalTekst("Fondsomschrijving",$pdfObject->rapport_taal),
                 ...
                 vertaalTekst("Datum NAV",$pdfObject->rapport_taal),
  ...
  $pdfObject->SetFont($pdfObject->rapport_font,'',$pdfObject->rapport_fontsize);
	...
	function HeaderVKM_L122($object)
	{
		$pdfObject = &$object;
		$pdfObject->HeaderVKM();
	}
	
	  function HeaderFRONT_L122($object)
	  {
	    $pdfObject = &$object;
	    //$pdfObject->headerSCENARIO();

	  }
	  function HeaderSCENARIO_L122($object)
	  {
	    $pdfObject = &$object;
	    //$pdfObject->headerSCENARIO();
    ...
    function HeaderRISK_L122($object)
    {
	    $pdfObject = &$object;
			$pdfObject->Ln();
			$pdfObject->SetFillColor($pdfObject->rapport_kop_bgcolor['r'],$pdfObject->rapport_kop_bgcolor['g'],$pdfObject->rapport_kop_bgcolor['b']);
    ...
    function HeaderGRAFIEK_L122($object)
    {
	    $pdfObject = &$object;
    }

    function HeaderEND_L122($object)
    {
     	$pdfObject = &$object;
			$pdfObject->Ln();
			$pdfObject->SetFillColor($pdfObject->rapport_kop_bgcolor['r'],$pdfObject->rapport_kop_bgcolor['g'],$pdfObject->rapport_kop_bgcolor['b']);
    ...
    function HeaderPERFD_L122($object)
    {
      $pdfObject = &$object;
      HeaderPERF_L122($object);
      $pdfObject->SetTextColor($pdfObject->rapport_fontcolor['r'],$pdfObject->rapport_fontcolor['g'],$pdfObject->rapport_fontcolor['b']);
    }


    function HeaderTRANSFEE_L122($object)
    {
      $pdfObject = &$object;
      $pdfObject->SetFont($pdfObject->rapport_font,$pdfObject->rapport_kop_fontstyle,$pdfObject->rapport_fontsize);
      $pdfObject->SetX(100);
      $start=db2jul($pdfObject->portefeuilledata['Startdatum']);
      $pdfObject->MultiCell(100,4,vertaalTekst("Verslagperiode",$pdfObject->rapport_taal)." ".date("j",$start)." ".vertaalTekst($pdfObject->__appvar["Maanden"][date("n",$start)],$pdfObject->rapport_taal)." ".date("Y",$start)." ".vertaalTekst("tot en met",$pdfObject->rapport_taal)." ".date("j",$pdfObject->rapport_datum)." ".vertaalTekst($pdfObject->__appvar["Maanden"][date("n",$pdfObject->rapport_datum)],$pdfObject->rapport_taal)." ".date("Y",$pdfObject->rapport_datum),0,'C');
      $pdfObject->ln();
      ...
      $pdfObject->row(array("\n".vertaalTekst("Datum",$pdfObject->rapport_taal),
                        vertaalTekst("Aankoop/VerKoop NAV",$pdfObject->rapport_taal),
                        "\n".vertaalTekst("Aantal",$pdfObject->rapport_taal),
                        "\n".vertaalTekst("Investeringbedrag",$pdfObject->rapport_taal),
                        "\n".vertaalTekst("Huidige waarde",$pdfObject->rapport_taal),
                        "".vertaalTekst("Gerealiseerde meerwaarde",$pdfObject->rapport_taal),
                        "".vertaalTekst("Ongerealiseerde meerwaarde",$pdfObject->rapport_taal),
                        "\n".vertaalTekst("Rendement",$pdfObject->rapport_taal),
                        "".vertaalTekst("Geannualiseerd rendement",$pdfObject->rapport_taal)));
      $pdfObject->ln(1);
    }

    function HeaderTRANS_L122($object)
	  {
	    $pdfObject = &$object;
    	$pdfObject->SetFont($pdfObject->rapport_font,$pdfObject->rapport_kop_fontstyle,$pdfObject->rapport_fontsize);
  		$pdfObject->SetX(100);
		...
		$pdfObject->SetAligns($pdfObject->alignA);
			...
			$pdfObject->row(array("\n".vertaalTekst("Datum",$pdfObject->rapport_taal),
										 ...
										 "\n".vertaalTekst("Investeringbedrag",$pdfObject->rapport_taal),
										 "\n".vertaalTekst("Huidige waarde",$pdfObject->rapport_taal),
										 "\n".vertaalTekst("Meerwaarde",$pdfObject->rapport_taal),
										 "\n".vertaalTekst("Rendement",$pdfObject->rapport_taal),
										 "".vertaalTekst("Geannualiseerd rendement",$pdfObject->rapport_taal),
    ...
    function HeaderMUT_L122($object)
	  {
	    $pdfObject = &$object;
   		$pdfObject->SetFont($pdfObject->rapport_font,$pdfObject->rapport_kop_fontstyle,$pdfObject->rapport_fontsize);
  	  $pdfObject->SetX(100);
	  ...
	  function HeaderAFM_L122($object)
	  {
	    $pdfObject = &$object;
...
$pdfObject->ln(2);
	  ...
	  function HeaderINHOUD_L122($object)
	  {
	    $pdfObject = &$object;
	    //$pdfObject->headerSCENARIO();

	  }	  
 	  function HeaderPERF_L122($object)
	  {
	    $pdfObject = &$object;
      $pdfObject->ln();
      $pdfObject->SetFillColor($pdfObject->rapport_kop_bgcolor['r'],$pdfObject->rapport_kop_bgcolor['g'],$pdfObject->rapport_kop_bgcolor['b']);
...
$pdfObject->ln();
    ...
    function HeaderINDEX_L122($object)
	  {
	    $pdfObject = &$object;
	  }
    function HeaderOIB_L122($object)
	  {
	    $pdfObject = &$object;
      $pdfObject->Ln();
      		$pdfObject->SetFillColor($pdfObject->rapport_kop_bgcolor['r'],$pdfObject->rapport_kop_bgcolor['g'],$pdfObject->rapport_kop_bgcolor['b']);
  ...
  function HeaderATT_L122($object)
	{
    $pdfObject = &$object;
...
*/
   ...
   function HeaderPERFG_L122($object)
	{
    $pdfObject = &$object;
...
*/
  ...
  function HeaderVOLK_L122($object)
	{
    $pdfObject = &$object;
   	$pdfObject->ln();
		$pdfObject->SetFont($pdfObject->rapport_font,$pdfObject->rapport_kop_fontstyle,$pdfObject->rapport_fontsize);
...
function HeaderVHO_L122($object)
	{
    $pdfObject = &$object;
   	$pdfObject->ln();
		$pdfObject->SetFont($pdfObject->rapport_font,$pdfObject->rapport_kop_fontstyle,$pdfObject->rapport_fontsize);
...
function printRendement_L122($object,$portefeuille, $rapportageDatum, $rapportageDatumVanaf, $kort=false)
{
  $pdfObject = &$object;
  global $__appvar;
