...
/*
Author  						: $Author: rvv $
Laatste aanpassing	: $Date: 2019/02/09 18:40:17 $
File Versie					: $Revision: 1.3 $

$Log: RapportATT_L46.php,v $
...
class RapportATT_L46
{
	function RapportATT_L46($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
      ...
      //  $factor=1.2;
       // $this->pdf->SetFillColor($this->pdf->rapport_kop_bgcolor['r']*$factor,$this->pdf->rapport_kop_bgcolor['g']*$factor,$this->pdf->rapport_kop_bgcolor['b']*$factor);
        ...
        $this->pdf->SetFont($this->pdf->rapport_font,'',$this->pdf->rapport_fontsize);
		  ...
		  if (count($barGraph) > 0)
		  {
		    $this->pdf->SetXY($this->pdf->marge,125)		;//112
        $this->pdf->SetFont($this->pdf->rapport_font,'B',$this->pdf->rapport_fontsize);
		      ...
		      $this->pdf->SetXY(15,188)		;//112
		      $this->VBarDiagram(220, 55, $barGraph['Index']);
		  }
