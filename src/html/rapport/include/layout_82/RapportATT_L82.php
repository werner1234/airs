...
$Log: RapportATT_L82.php,v $
Revision 1.2  2020/04/29 09:44:54  rvv
*** empty log message ***
...
class RapportATT_L82
{
	function RapportATT_L82($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
...
*/
   ...
   // $color=array(200,0,0);
    ...
    {
      $this->pdf->TextWithRotation($XDiag+($i)*$unit-10+$unit,$YDiag+$hDiag+1,date("d-M-Y",db2jul($legendDatum[$i])),0);
