...
$Log: RapportOIB_L82.php,v $
Revision 1.2  2020/04/29 09:44:54  rvv
*** empty log message ***

Revision 1.1  2020/03/14 19:11:26  rvv
*** empty log message ***
...
class RapportOIB_L82
{
	function RapportOIB_L82($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
...
foreach ($regelData as $regelNr=>$regel)
{
  ...
  $regelData[$regelNr]=$regel;
    ...
    $this->pdf->SetWidths(array(20+25, 40,20,15, 15+25, 40,20,15, 15, 40,20,15));
