...
Revision 1.3  2013/05/01 15:53:08  rvv
*** empty log message ***

Revision 1.2  2013/04/27 16:29:28  rvv
*** empty log message ***

Revision 1.1  2013/04/20 16:34:57  rvv
*** empty log message ***
...
class RapportMUT_L45
{
	function RapportMUT_L45($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
	...
	function writeRapport()
	{
	  ...
	  if ($this->pdf->rapportageValuta != "EUR" || $this->pdf->rapportageValuta != '')
	   $koersQuery =	" / (SELECT Koers FROM Valutakoersen WHERE Valuta='".$this->pdf->rapportageValuta."' AND Datum <= Rekeningmutaties.Boekdatum ORDER BY Datum DESC LIMIT 1 ) ";
		...
		$DB = new DB();
		// voor data
		$this->pdf->widthA = array(20,25,90,25,30,20,25,25,21);
		$this->pdf->alignA = array('R','R','L','R','R','R','R','R');

		// voor kopjes
		$this->pdf->widthB = array(20,25,90,25,30,20,25,25,21);
