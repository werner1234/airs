...
include_once("rapport/include/ATTberekening_L62.php");

class RapportPERF_L62
{

	function RapportPERF_L62($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
    ...
    $this->att=new ATTberekening_L62($this);
	}
