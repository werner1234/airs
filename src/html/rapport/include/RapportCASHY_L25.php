...
/*
    ...
    Author  						: $Author: rvv $
 		Laatste aanpassing	: $Date: 2017/05/03 14:35:54 $
 		File Versie					: $Revision: 1.1 $

 		$Log: RapportCASHY_L25.php,v $
 		Revision 1.1  2017/05/03 14:35:54  rvv
 		*** empty log message ***
...
class RapportCASHY_L25
{
	function RapportCASHY_L25($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
	 //
		$this->pdf = &$pdf;
...
$this->pdf->CellBorders = array();
	...
	function VBarDiagram($w, $h, $data,$titel)
  {
    ...
    //listarray($this->pdf->rapport_titel_fontcolor);
      $colors=array('rente'=>$this->pdf->rapport_titel_fontcolor,
      'lossing'=>$this->pdf->rapport_kopvoet_bg );
