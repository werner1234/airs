...
$Log: RapportFRONT_L53.php,v $
Revision 1.6  2016/01/06 16:20:40  rvv
*** empty log message ***

Revision 1.5  2014/06/20 09:26:34  rvv
*** empty log message ***
...
class RapportFront_L53
{
	function RapportFront_L53($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
    ...
    $this->pdf->SetY(80);
    $this->pdf->row(array('','Vermogensrapportage '.$this->pdf->portefeuilledata['Client']));
    $this->pdf->ln(10);
    ...
    $this->pdf->ln(10);
    $this->pdf->row(array('','Portefeuille(s): '.$this->pdf->portefeuilledata['Portefeuille']));
    $this->pdf->ln(10);
