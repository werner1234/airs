...
class RapportVAR_L13
{
  
  function RapportVAR_L13($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
  {
    $this->pdf = &$pdf;
    $this->pdf->setDefaults();
 ...
 */
  ...
  function addResultaat()
  {
    ...
    {
      if($categorie<>'totaal' && ( !empty ($this->waarden['Periode'][$categorie]['beginwaarde']) || !empty ($this->waarden['Periode'][$categorie]['eindwaarde'])))
...
//      $samenstelling[]='';
    ...
    $rendement=array("",vertaalTekst("Waardeontwikkeling over verslagperiode",$this->pdf->rapport_taal));
    ...
    $cellWidth=27;
    $cellWidthP=2;
    $this->pdf->widthB = array(0,75,$cellWidth,$cellWidthP,$cellWidth,$cellWidthP,$cellWidth,$cellWidthP,$cellWidth,$cellWidthP,$cellWidth,$cellWidthP,$cellWidth,$cellWidthP,$cellWidth,$cellWidthP,$cellWidth,$cellWidthP,$cellWidth,$cellWidthP);
...
//    $this->pdf->fillCell=array();
    ...
    $this->pdf->SetFont($this->pdf->rapport_font,'b',$this->pdf->rapport_fontsize);
    $tmpwidthB = $this->pdf->widthB;
    $tmpwidthB[1] = $tmpwidthB[1]+10;
    $tmpwidthB[2] = $tmpwidthB[2]-10;
    $this->pdf->SetWidths($tmpwidthB);
