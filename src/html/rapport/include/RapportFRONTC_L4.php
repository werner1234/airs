...
include_once($__appvar["basedir"]."/html/rapport/include/RapportFRONT_L4.php");

class RapportFRONTC_L4
{
	function RapportFRONTC_L4($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
    $this->rapport = new RapportFRONT_L4($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum);
  }
