...
include_once("rapport/include/ATTberekening_L46.php");

class RapportPERFD_L46
{

	function RapportPERFD_L46($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
    ...
    $this->att=new ATTberekening_L46($this);
	}
...
function addResultaat()
{
  ...
  $vetralingGrootboek=$this->getGrootboeken();
    ...
    $att=new ATTberekening_L46($this);
