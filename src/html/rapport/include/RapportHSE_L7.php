...
/*
Author  						: $Author: rvv $
Laatste aanpassing	: $Date: 2016/03/27 17:35:07 $
File Versie					: $Revision: 1.2 $

$Log: RapportHSE_L7.php,v $
Revision 1.2  2016/03/27 17:35:07  rvv
*** empty log message ***

Revision 1.1  2016/03/17 07:15:39  rvv
*** empty log message ***
...
class RapportHSE_L7
{
	function RapportHSE_L7($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum, $valuta = 'EUR')
	{
		$this->pdf = &$pdf;
    ...
    $maxDagenOud=$dagen['VerouderdeKoersDagen'];
	  ...
	  $this->pdf->widthB = array(10,55,20,25,30,30,5,25,30,30,15);
		$this->pdf->alignB = array('L','L','R','R','R','R','R','R','R','R','R');

		// voor kopjes
		$this->pdf->widthA = array(65,20,25,30,30,5,25,30,30,15);
...
//		{
    ...
    SUM(TijdelijkeRapportage.beginPortefeuilleWaardeEuro) / ".$this->pdf->ValutaKoersBegin. ") as subtotaalbegin, ".
		...
		" WHERE TijdelijkeRapportage.portefeuille = '".$this->portefeuille."' AND TijdelijkeRapportage.type IN('fondsen','rente') AND TijdelijkeRapportage.rapportageDatum = '".$this->rapportageDatum."'".
		$__appvar['TijdelijkeRapportageMaakUniek'].
        ...
        TijdelijkeRapportage.type,".
			...
			$__appvar['TijdelijkeRapportageMaakUniek'].
			" ORDER BY TijdelijkeRapportage.type asc, TijdelijkeRapportage.Lossingsdatum, TijdelijkeRapportage.fondsOmschrijving asc";
