...
/*
    ...
    Author  						: $Author: rvv $
 		Laatste aanpassing	: $Date: 2018/12/27 15:10:29 $
 		File Versie					: $Revision: 1.2 $

 		$Log: ATTberekening_L10.php,v $
 		Revision 1.2  2018/12/27 15:10:29  rvv
 		*** empty log message ***
...
class ATTberekening_L10
{

	function ATTberekening_L10($rapportData,$periode='maanden')
	{
  ...
  function genereerMutatieLijst($rapportageDatumVanaf,$rapportageDatum,$fonds='')
    ...
    elseif($fonds!='')
     ...
     Rekeningmutaties.omschrijving as rekeningOmschrijving,
      ...
      $fondsResultaat=0;
      $valutaResultaat=0;
      if($verkoop_koers <> '' || $mutaties['Transactietype'] == 'A/S' || $mutaties['Transactietype'] == 'V/S' )
      { //listarray($historie);
        //$historischekostprijsValuta = $rekenAantal*$historie['historischeWaarde']* $mutaties['Fondseenheid'];//$historischekostprijs = $mutaties[Aantal]        * $historie[historischeWaarde]       * $historie[historischeValutakoers]        * $mutaties[Fondseenheid];
        $historischekostprijsValuta = $rekenAantal*$historie['beginwaardeLopendeJaar']* $mutaties['Fondseenheid'];
