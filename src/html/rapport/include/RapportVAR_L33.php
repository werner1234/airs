...
class RapportVAR_L33
{
	function RapportVAR_L33($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
...
//echo "<tr><td>". $data['fonds'] . "</td><td> $p </td><td> ".($r*100)." </td><td> $b </td><td>$y  </td><td>  $ytm </td>  <td> ".$data['Lossingsdatum']."</td> </tr>\n";
   ...
   //       echo $data['fonds']." ".round($modifiedDuration,4)." = $duration/(1+$ytm/100) <br>\n";
