...
$Log: RapportKERNZ_L99.php,v $

*/
include_once("rapportRekenClass.php");
include_once($__appvar["basedir"]."/html/rapport/rapportVertaal.php");

class RapportKERNZ_L99
{
	function RapportKERNZ_L99($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
    ...
    $this->pdf->templateVars[$this->pdf->rapport_type.'Paginas']=$this->pdf->page;
		...
		risicoMeter_L99($this->pdf, 50, 65, 50, $this->pdf->portefeuilledata['Risicoklasse']);
