...
/*
Author  						: $Author: rvv $
Laatste aanpassing	: $Date: 2019/04/07 11:07:21 $
File Versie					: $Revision: 1.1 $

$Log: RapportAFM_L99.php,v $
...
class RapportAFM_L99
{
	function RapportAFM_L99($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
	  global $__appvar;
		$this->pdf = &$pdf;
