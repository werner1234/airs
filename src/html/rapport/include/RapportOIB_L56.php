...
/*
Author  						: $Author: rvv $
Laatste aanpassing	: $Date: 2020/07/05 16:18:52 $
File Versie					: $Revision: 1.10 $

$Log: RapportOIB_L56.php,v $
Revision 1.10  2020/07/05 16:18:52  rvv
*** empty log message ***

Revision 1.9  2020/07/04 15:59:25  rvv
*** empty log message ***

Revision 1.8  2019/05/11 16:48:39  rvv
*** empty log message ***
...
class RapportOIB_L56
{
	function RapportOIB_L56($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
...
//$this->pdf->setXY(65,40);
    ...
    $this->toonTabel($data['beleggingscategorieEind'],10+0,'Categorie');
...
//$this->pdf->setXY(175,40);
    ...
    $this->toonTabel($data['valutaVerdeling'],10+90,'Valuta');
$this->pdf->wLegend=0;
