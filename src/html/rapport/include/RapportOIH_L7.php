...
class RapportOIH_L7
{
	function RapportOIH_L7($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
    ...
    $this->pdf->templateVars['OIHPaginas']=$this->pdf->page;
	 ...
	 $query="SELECT Omschrijving, SectorenPerHoofdsector.Hoofdsector FROM Beleggingssectoren
      ...
      SectorenPerHoofdsector.Hoofdsector
			...
			WHERE TijdelijkeRapportage.portefeuille = '".$this->portefeuille."' AND TijdelijkeRapportage.type IN('fondsen','rente')  AND TijdelijkeRapportage.rapportageDatum = '".$this->rapportageDatum."'"
			.$__appvar['TijdelijkeRapportageMaakUniek'].
			" GROUP BY Hoofdcategorie,TijdelijkeRapportage.Beleggingssector   ".
			" ORDER BY hoofdVolgorde, Beleggingssectoren.Afdrukvolgorde asc";
...
WHERE ".
				...
				.$__appvar['TijdelijkeRapportageMaakUniek'].
				" ORDER BY TijdelijkeRapportage.type, TijdelijkeRapportage.Lossingsdatum,   omschrijvingVolgorde,  OptieBovenliggendFonds";
