...
/*
Author  						: $Author: rvv $
Laatste aanpassing	: $Date: 2016/07/31 10:40:44 $
File Versie					: $Revision: 1.5 $

$Log: RapportRISK_L48.php,v $
Revision 1.5  2016/07/31 10:40:44  rvv
*** empty log message ***

Revision 1.4  2016/01/09 18:58:30  rvv
*** empty log message ***

Revision 1.3  2015/12/13 09:03:13  rvv
*** empty log message ***

Revision 1.2  2015/11/18 17:08:02  rvv
*** empty log message ***
...
class RapportRISK_L48
{
	function RapportRISK_L48($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
	  global $__appvar;
		$this->pdf = &$pdf;
    ...
    include($__appvar["basedir"]."/html/rapport/include/RapportImages_L48.php");
