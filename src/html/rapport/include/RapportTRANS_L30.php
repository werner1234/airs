...
$Log: RapportTRANS_L30.php,v $
Revision 1.7  2019/06/21 14:52:45  rm
7880

Revision 1.6  2017/01/21 17:48:04  rvv
*** empty log message ***

Revision 1.5  2017/01/04 16:22:50  rvv
*** empty log message ***

Revision 1.4  2016/12/29 07:49:25  rvv
*** empty log message ***

Revision 1.3  2016/12/28 19:38:27  rvv
*** empty log message ***

Revision 1.2  2015/12/19 08:29:17  rvv
*** empty log message ***

Revision 1.1  2012/04/18 16:03:03  rvv
*** empty log message ***

Revision 1.1  2012/04/16 17:56:27  rvv
*** empty log message ***
...
class RapportTRANS_L30
{
	function RapportTRANS_L30($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
	...
	function printSub($subtotalen)
	{
		...
		$this->pdf->row(array("","","","",vertaalTekst("",$this->pdf->rapport_taal),"",
											                $this->formatGetal($subtotalen['totaal_aankoop_waarde'],$this->pdf->rapport_TRANS_decimaal),"","",
											                $this->formatGetal($subtotalen['totaal_verkoop_waarde'],$this->pdf->rapport_TRANS_decimaal),"","",
											                 $this->formatGetal($subtotalen['koersresultaat'],$this->pdf->rapport_TRANS_decimaal)));
	...
	function writeRapport()
	{
	  ...
	  if ($this->pdf->rapportageValuta != "EUR" || $this->pdf->rapportageValuta != '')
	   $koersQuery =	" / (SELECT Koers FROM Valutakoersen WHERE Valuta='".$this->pdf->rapportageValuta."' AND Datum <= Rekeningmutaties.Boekdatum ORDER BY Datum DESC LIMIT 1 ) ";
		...
		{
		// voor data
		$this->pdf->widthB = array(15,11,20,41,16,22,22,16,22,22,22,26,26,4);
		$this->pdf->alignB = array('L','L','R','L','R','R','R','R','R','R','R','R','R','R');
		// voor kopjes
		$this->pdf->widthA = array(15,11,20,41,16,22,22,16,22,22,22,26,26,4);
		...
		$query = "SELECT if(SUBSTR(Transactietype,1,1) IN ('A','V'),1,0) as koop, Fondsen.Omschrijving, ".
	     ...
	     //$totaal_resultaat_waarde
			...
			switch($mutaties['Transactietype'])
			{
					case "A" :
						...
						$subtotalen['totaal_aankoop_waarde'] += $t_aankoop_waarde;
					...
					case "L" :
						...
						$subtotalen['totaal_verkoop_waarde'] += $t_verkoop_waarde;
...
//	echo "lopende -> ".$resultaatlopende." <-  voorgaande ".$resultaatvoorgaande. " -  <br>" ;
				...
				$subtotalen['koersresultaat']+=$resultaatlopende;
