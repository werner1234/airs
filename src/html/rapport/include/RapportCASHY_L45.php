...
class RapportCASHY_L45
{
	function RapportCASHY_L45($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
	 //
		$this->pdf = &$pdf;
...
$this->pdf->CellBorders = array();
	...
	function VBarDiagram($w, $h, $data,$titel)
  {
    ...
    //  'lossing'=>array(20,20,150));
      ...
      $colors=array('rente'=>array(125,41,145),
      'lossing'=>array(25,50,95));
