...
/*
    ...
    Author  						: $Author: rvv $
 		Laatste aanpassing	: $Date: 2011/01/23 08:53:55 $
 		File Versie					: $Revision: 1.2 $

 		$Log: PDFRapport_footers_L27.php,v $
 		Revision 1.2  2011/01/23 08:53:55  rvv
 		*** empty log message ***
 		
 		Revision 1.1  2010/12/22 18:45:30  rvv
 		*** empty log message ***
...
function Footer_basis_L27($object)
{
    $pdfObject=&$object;
...
function FooterFRONT_L27($object)
{
   $pdfObject=&$object;
