...
function Header_basis_L111($object)
{
 $pdfObject = &$object;
    ...
    {  
  	...
  	if($pdfObject->lastPortefeuille != $pdfObject->portefeuilledata['Portefeuille'] && !empty($pdfObject->lastPortefeuille))
		...
		$pdfObject->rapport_koptext = str_replace("{DepotbankOmschrijving}", vertaalTekst($pdfObject->rapport_depotbankOmschrijving, $pdfObject->rapport_taal), $pdfObject->rapport_koptext);
	  ...
	  $pdfObject->SetXY($pdfObject->marge,$y+3);
	...
	function HeaderVKM_L111($object)
	{
		$pdfObject = &$object;
		$pdfObject->HeaderVKM();
	}
	
	  function HeaderFRONT_L111($object)
	  {
	    $pdfObject = &$object;
	    //$pdfObject->headerSCENARIO();

	  }
	  function HeaderSCENARIO_L111($object)
	  {
	    $pdfObject = &$object;
	    //$pdfObject->headerSCENARIO();
    ...
    function HeaderRISK_L111($object)
    {
	    $pdfObject = &$object;
			$pdfObject->Ln();
    ...
    function HeaderGRAFIEK_L111($object)
    {
	    $pdfObject = &$object;
    }

function HeaderSMV_L111($object)
{
  $pdfObject = &$object;
}

function HeaderKERNZ_L111($object)
{
  $pdfObject = &$object;
}

function HeaderKERNV_L111($object)
{
  $pdfObject = &$object;
}
    function HeaderEND_L111($object)
    {
     	$pdfObject = &$object;
			$pdfObject->Ln();
			$pdfObject->SetFillColor($pdfObject->rapport_kop_bgcolor['r'],$pdfObject->rapport_kop_bgcolor['g'],$pdfObject->rapport_kop_bgcolor['b']);
    ...
    function HeaderPERFD_L111($object)
    {
      $pdfObject = &$object;
...
function HeaderTRANSFEE_L111($object)
{
  $pdfObject = &$object;
...
//  $pdfObject->SetTextColor($pdfObject->rapport_kop_fontcolor[r],$pdfObject->rapport_kop_fontcolor[g],$pdfObject->rapport_kop_fontcolor[b]);
  ...
  $pdfObject->row(array(vertaalTekst("Datum",$pdfObject->rapport_taal),
    ...
    vertaalTekst("Kosten-BPS",$pdfObject->rapport_taal),
    vertaalTekst("",$pdfObject->rapport_taal),
    vertaalTekst("",$pdfObject->rapport_taal),
    vertaalTekst("",$pdfObject->rapport_taal),
    vertaalTekst("",$pdfObject->rapport_taal)
...
//  $pdfObject->ln(15);
    ...
    function HeaderTRANS_L111($object)
	  {
	    $pdfObject = &$object;
    ...
    $pdfObject->SetDrawColor(0,0,0);
      ...
      $pdfObject->SetXY($pdfObject->marge,$y);
			$pdfObject->row(array("\n".vertaalTekst("Datum",$pdfObject->rapport_taal),
										 ...
										 "\n".vertaalTekst("Waarde",$pdfObject->rapport_taal),
										 "\n".vertaalTekst("Waarde in ".$pdfObject->rapportageValuta,$pdfObject->rapport_taal),
                        "\n".vertaalTekst("Kostprijs in ".$pdfObject->rapportageValuta,$pdfObject->rapport_taal),
                        "\n".vertaalTekst("Voor verslagperiode",$pdfObject->rapport_taal),
                        "\n".vertaalTekst("Verslagperiode",$pdfObject->rapport_taal),
                        "\n".'%'));
      $pdfObject->ln(1);
	  }
    
    function HeaderMUT_L111($object)
	  {
	    $pdfObject = &$object;
   		$pdfObject->SetFont($pdfObject->rapport_font,$pdfObject->rapport_kop_fontstyle,$pdfObject->rapport_fontsize);
  	  $pdfObject->SetX(100);
...
function HeaderAFM_L111($object)
{
  $pdfObject = &$object;
...
//
//	  }
	  function HeaderINHOUD_L111($object)
	  {
	    $pdfObject = &$object;
	    //$pdfObject->headerSCENARIO();
...
function HeaderFISCAAL_L111($object)
{
  $pdfObject = &$object;
...
function HeaderPERF_L111($object)
	  {
	    $pdfObject = &$object;
      $pdfObject->ln();
      $pdfObject->SetFillColor($pdfObject->rapport_kop_bgcolor['r'],$pdfObject->rapport_kop_bgcolor['g'],$pdfObject->rapport_kop_bgcolor['b']);
...
function HeaderHSE_L111($object)
{
  HeaderVOLKD_L111($object);
}
function HeaderVOLKD_L111($object)
{
  $pdfObject = &$object;
  $pdfObject->ln();
  $pdfObject->SetFont($pdfObject->rapport_font,$pdfObject->rapport_kop_fontstyle,$pdfObject->rapport_fontsize);
...
//    else
  ...
  // $pdfObject->ln(20);
    ...
    function HeaderINDEX_L111($object)
	  {
	    $pdfObject = &$object;
	  }
    function HeaderOIB_L111($object)
	  {
	    $pdfObject = &$object;
      $pdfObject->Ln();
      		$pdfObject->SetFillColor($pdfObject->rapport_kop_bgcolor['r'],$pdfObject->rapport_kop_bgcolor['g'],$pdfObject->rapport_kop_bgcolor['b']);
    ...
    function HeaderOIV_L111($object)
    {
      $pdfObject = &$object;
      $pdfObject->Ln();
      $pdfObject->SetFillColor($pdfObject->rapport_kop_bgcolor['r'],$pdfObject->rapport_kop_bgcolor['g'],$pdfObject->rapport_kop_bgcolor['b']);
  ...
  function HeaderATT_L111($object)
	{
    $pdfObject = &$object;
...
*/
   ...
   function HeaderPERFG_L111($object)
	{
    $pdfObject = &$object;
    $pdfObject->widthA = array(26,25,30,30,23,23,23,24,28,24,26);
		$pdfObject->alignA = array('L','R','R','R','R','R','R','R','R','R','R','R');
...
*/
  ...
  function HeaderVOLK_L111($object)
	{
    $pdfObject = &$object;
   	$pdfObject->ln();
		$pdfObject->SetFont($pdfObject->rapport_font,$pdfObject->rapport_kop_fontstyle,$pdfObject->rapport_fontsize);
...
function HeaderVHO_L111($object)
	{
    $pdfObject = &$object;
  	// achtergrond kleur
		$pdfObject->SetFillColor($pdfObject->rapport_kop_bgcolor['r'],$pdfObject->rapport_kop_bgcolor['g'],$pdfObject->rapport_kop_bgcolor['b']);
