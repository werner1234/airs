...
class RapportPERF_L111
{

	function RapportPERF_L111($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
		...
		if($this->pdf->rapport_PERF_titel)
			...
			$this->pdf->rapport_titel = vertaalTekst("Resultaat- en rendementsberekening", $this->pdf->rapport_taal) . ' ' . date("j",$this->pdf->rapport_datumvanaf)." ".
    ...
    $this->att=new ATTberekening_L111($this);
	}
...
//listarray($this->waarden['Periode']['H-Liq']);
