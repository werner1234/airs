...
$Log: RapportDOORKIJK_L72.php,v $
Revision 1.4  2020/02/29 16:23:08  rvv
*** empty log message ***

Revision 1.3  2019/04/13 17:42:49  rvv
*** empty log message ***

Revision 1.2  2018/05/23 13:51:26  rvv
*** empty log message ***
...
class RapportDOORKIJK_L72
{
	function RapportDOORKIJK_L72($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = $pdf;
...
*/
	...
	function vulPagina($belCategorien='',$pagina=1)
	{
		$pieTeller = 0;

		if($pagina==2)
		{
			$doorkijkCategorieSoorten = array('Valutas');
			$doorkijkTitels = array('Valutas' => 'Valuta');//array();Beleggingscategorie
		}
		else
		{
...
KeuzePerVermogensbeheerder.categorie='Beleggingscategorien' ";
      ...
      $this->pdf->AddPage();
      $this->vulPagina($beleggingscategorien,2);
		}
	}
}