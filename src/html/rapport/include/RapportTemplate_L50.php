...
/*
Author  						: $Author: rvv $
Laatste aanpassing	: $Date: 2013/09/04 16:13:24 $
File Versie					: $Revision: 1.2 $

$Log: RapportTemplate_L50.php,v $
Revision 1.2  2013/09/04 16:13:24  rvv
*** empty log message ***
...
class RapportTemplate_L50
{
	function RapportTemplate_L50($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
    ...
    $totPagina = ($lastpage-$startpagina+$paginaCorrectie);//-1
       ...
       $this->pdf->ln(10);
	     ...
	     $inhoudsItems=array('PERFPaginas'=>'Kerngegevens rapportage',
	                         ...
	                         'OISPaginas'=>'Verdeling van de aandelen over de verschillende sectoren',
                           ...
                           'HUISPaginas'=>'Uitsplitsing van effecten naar categorie van duurzaamheid',
        ...
        foreach ($this->pdf->templateVars as $key=>$value)
        {
          if($inhoudsItems[$key])
          {
            ...
            $this->pdf->row(array($n,$text,$this->pdf->templateVars[$key]+$paginaCorrectieInhoud));
