...
$Log: RapportATT_L67.php,v $
Revision 1.5  2019/03/09 18:45:47  rvv
*** empty log message ***
...
class RapportATT_L67
{
	function RapportATT_L67($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
 ...
 return number_format($getal,$decimaal,',','');
  ...
  $julEind = db2jul($datumEind);
    ...
    $categorieVerdeling=$this->categorieVolgorde;
      ...
      if($regel['type']=='fondsen'|| $regel['beleggingscategorie']<>'')
      {
