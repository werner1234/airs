...
/*
Author  						: $Author: rvv $
Laatste aanpassing	: $Date: 2012/05/27 08:33:11 $
File Versie					: $Revision: 1.1 $

$Log: RapportVOLK_L38.php,v $
...
class RapportVOLK_L38
{
	function RapportVOLK_L38($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
