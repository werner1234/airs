...
include_once("rapport/include/layout_121/ATTberekening_L121.php");

class RapportPERF_L121
{

	function RapportPERF_L121($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
    ...
    $this->att=new ATTberekening_L121($this);
	}
...
WHERE Portefeuilles.Portefeuille = '$this->portefeuille'";
    ...
    $this->pdf->Rect($this->pdf->marge+128,120,122,count($benchmarks)*4+4);
...
function addResultaat()
{
  ...
  $vetralingGrootboek=$this->getGrootboeken();
    ...
    $att=new ATTberekening_L121($this);
