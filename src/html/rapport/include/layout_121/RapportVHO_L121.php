...
class RapportVHO_L121
{
	function RapportVHO_L121($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
...
//rvv
    ...
    {
      //$this->pdf->rapport_resultaatText = 'Resultaat over verslagperiode';
      $this->pdf->rapport_rendementText = 'Rendement verslagperiode';
    }
		$this->pdf->printValutaoverzicht($this->portefeuille, $this->rapportageDatum);
    $this->pdf->SetFont($this->pdf->rapport_font,'B',$this->pdf->rapport_fontsize);
		$this->pdf->printRendement($this->portefeuille, $this->rapportageDatum, $this->rapportageDatumVanaf);
    //unset($this->pdf->rapport_resultaatText);
    unset($this->pdf->rapport_rendementText);
