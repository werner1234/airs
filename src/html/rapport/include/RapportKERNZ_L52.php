...
$Log: RapportKERNZ_L52.php,v $
Revision 1.2  2019/04/10 15:50:36  rvv
*** empty log message ***

Revision 1.1  2018/03/12 06:32:52  rvv
*** empty log message ***
...
class RapportKERNZ_L52
{
	function RapportKERNZ_L52($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
    ...
    $this->pdf->templateVars[$this->pdf->rapport_type.'Paginas']=$this->pdf->page;
		...
		risicoMeter_L52($this->pdf, 50, 65, 50, $this->pdf->portefeuilledata['Risicoklasse']);
