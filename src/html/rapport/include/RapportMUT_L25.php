...
$Log: RapportMUT_L25.php,v $
Revision 1.8  2020/03/18 17:44:11  rvv
*** empty log message ***

Revision 1.7  2020/02/19 15:02:02  rvv
*** empty log message ***

Revision 1.6  2020/01/25 16:36:35  rvv
*** empty log message ***

Revision 1.5  2017/09/20 13:13:13  rvv
*** empty log message ***

Revision 1.4  2017/05/28 09:58:52  rvv
*** empty log message ***

Revision 1.3  2016/01/24 09:52:26  rvv
*** empty log message ***

Revision 1.2  2016/01/03 09:16:56  rvv
*** empty log message ***

Revision 1.1  2015/08/05 15:59:20  rvv
*** empty log message ***
...
class RapportMUT_L25
{
	function RapportMUT_L25($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
		$this->pdf->rapport_type = "MUT";
		$this->pdf->rapport_datum = db2jul($rapportageDatum);
		$this->pdf->rapport_datumvanaf = db2jul($rapportageDatumVanaf);
		$this->pdf->rapport_titel = "Overzicht mutaties";
...
//		$this->pdf->Line($totaal2+2,$this->pdf->GetY(),$totaal2 + $this->pdf->widthA[7],$this->pdf->GetY());
	...
	function printKop($title, $type="default")
	{
		...
		$this->pdf->SetTextColor($this->pdf->rapport_koptrans_color[0],$this->pdf->rapport_koptrans_color[1],$this->pdf->rapport_koptrans_color[2]);
	...
	function writeRapport()
	{
	  ...
	  if ($this->pdf->rapportageValuta != "EUR" || $this->pdf->rapportageValuta != '')
	   $koersQuery =	" / (SELECT Koers FROM Valutakoersen WHERE Valuta='".$this->pdf->rapportageValuta."' AND Datum <= Rekeningmutaties.Boekdatum ORDER BY Datum DESC LIMIT 1 ) ";
		...
		$DB = new DB();
		// voor data
		$this->pdf->widthA = array(20,25,90,25,50,10,25,25,0);
    $this->pdf->widthA[8]=297-(array_sum($this->pdf->widthA)+$this->pdf->marge*2);
    ...
    $this->pdf->SetFillColor($this->pdf->rapport_row_bg[0],$this->pdf->rapport_row_bg[1],$this->pdf->rapport_row_bg[2]);
      ...
      if($this->pdf->getY()<39 && $lastCategorie<>'' && $lastCategorie ==$mutaties['gbOmschrijving'])
      {
        $this->printKop(vertaalTekst($lastCategorie,$this->pdf->rapport_taal), $this->pdf->rapport_kop3_fontstyle);
        $this->pdf->SetFont($this->pdf->rapport_font,'',$this->pdf->rapport_fontsize);
      }
