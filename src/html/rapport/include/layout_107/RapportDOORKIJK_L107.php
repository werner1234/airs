...
$Log: RapportDOORKIJK_L107.php,v $
Revision 1.5  2020/02/29 16:23:08  rvv
*** empty log message ***

Revision 1.4  2019/11/16 17:12:28  rvv
*** empty log message ***

Revision 1.3  2019/10/23 13:34:01  rvv
*** empty log message ***
...
class RapportDOORKIJK_L107
{
	function RapportDOORKIJK_L107($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = $pdf;
...
*/
	...
	function vulPagina($belCategorien='')
	{
		...
		$doorkijkTitels=array('Beleggingscategorien'=>'Beleggingscategorie','Regios'=>'Regio\'s','Beleggingssectoren'=>'Sectoren');//array();Beleggingscategorie
		$extraX=20;
		foreach($doorkijkCategorieSoorten as $index=>$doorkijkCategorieSoort)
		{
			$xOffset =  $index * (98*3/2);
			...
			if($grafiekTonen==true)
			  $this->printPie( $grafiekdata,30+$xOffset+$extraX,125,$doorkijkTitels[$doorkijkCategorieSoort]); //+$yOffset);
			$pieTeller++;
		}
