...
class RapportATT_L107
{
	function RapportATT_L107($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
...
//listarray($this->categorieVolgorde);
  ...
  if(count($indexJaren > 0))
  {
    ...
    $rendemnten=$this->att->getPerfArray($this->portefeuille, $this->rapportageDatumVanaf,$this->rapportageDatum);//bereken(,'Hoofdcategorie');
        ...
        $totaalRendamentIndex=100;
		    foreach ($rendamentWaarden as $row)
		    {
		      ...
		      $this->pdf->row(array(date("Y",$datum).' '.vertaalTekst($__appvar["Maanden"][date("n",$datum)],$this->pdf->rapport_taal) ,
		                           ...
		                           $this->formatGetal($row['resultaatVerslagperiode'],0),
		                           $this->formatGetal($row['waardeHuidige'],0),
                               $this->formatGetal($rendemnten[$row['datum']]['index'],1),
                               ));
		                           ...
		                           $totaalRendament = $rendemnten[$row['datum']]['index'];
