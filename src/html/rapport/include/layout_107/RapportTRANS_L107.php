...
$Log: RapportTRANS_L107.php,v $
Revision 1.4  2019/08/07 15:30:49  rvv
*** empty log message ***

Revision 1.3  2018/03/04 10:14:13  rvv
*** empty log message ***
...
class RapportTRANS_L107
{
	function RapportTRANS_L107($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
	...
	function writeRapport()
	{
	  ...
	  if ($this->pdf->rapportageValuta != "EUR" || $this->pdf->rapportageValuta != '')
	   $koersQuery =	" / (SELECT Koers FROM Valutakoersen WHERE Valuta='".$this->pdf->rapportageValuta."' AND Datum <= Rekeningmutaties.Boekdatum ORDER BY Datum DESC LIMIT 1 ) ";
		...
		{
		// voor data
		$this->pdf->widthA = array(15,12,42,18,20,22,22,16,22,22,22,22,22,1);
		$this->pdf->alignA = array('L','L','L','R','R','R','R','R','R','R','R','R','R','R');

		// voor kopjes
		$this->pdf->widthB = array(15,12,42,18,20,22,22,16,22,22,22,22,22,1);
...
//	echo "lopende -> ".$resultaatlopende." <-  voorgaande ".$resultaatvoorgaande. " -  <br>" ;
			...
			$this->pdf->Cell($this->pdf->widthB[2],4,rclip($mutaties['Omschrijving'],27));
			}
