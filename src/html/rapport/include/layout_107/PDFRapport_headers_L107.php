...
function Header_basis_L107($object)
{
 $pdfObject = &$object;
	...
	function HeaderVKMS_L107($object)
	{
		$pdfObject = &$object;
		$pdfObject->ln();
...
function HeaderVKM_L107($object)
{
	$pdfObject = &$object;
	$pdfObject->HeaderVKM();
}

function HeaderVOLK_L107($object)
{
    $pdfObject = &$object;
...
function HeaderHUIS_L107($object)
{
    $pdfObject = &$object;
		
}

function HeaderDOORKIJK_L107($object)
{
	$pdfObject = &$object;

}

   function HeaderPERF_L107($object)
  {
	  	$pdfObject = &$object;
   ...
   function HeaderTRANS_L107($object)
  {
    $pdfObject=&$object;
    $pdfObject->ln();
		$pdfObject->SetFont($pdfObject->rapport_font,$pdfObject->rapport_kop_fontstyle,$pdfObject->rapport_fontsize);
  ...
  function HeaderMUT2_L107($object)
  {
    $pdfObject=&$object;
    $pdfObject->SetTextColor($pdfObject->rapport_kop_fontcolor['r'],$pdfObject->rapport_kop_fontcolor['g'],$pdfObject->rapport_kop_fontcolor['b']);
  ...
  function HeaderOIH_L107($object)
	{
  	  $pdfObject = &$object;
  	  $pdfObject->HeaderOIH();
	}

	function HeaderOIBS_L107($object)
	{
  	  $pdfObject = &$object;
  	  $pdfObject->HeaderOIBS();
	}

	function HeaderOIR_L107($object)
	{
  	  $pdfObject = &$object;
  	  $pdfObject->HeaderOIR();
	}

	function HeaderHSE_L107($object)
	{
			$pdfObject = &$object;
	...
	function HeaderOIB_L107($object)
	{
  	  $pdfObject = &$object;
	...
	function HeaderOIV_L107($object)
	{
  	  $pdfObject = &$object;
  	  $pdfObject->HeaderOIV();
	}

	function HeaderPERFG_L107($object)
	{
  	  $pdfObject = &$object;
  	  $pdfObject->HeaderPERFG();
	}
	function HeaderPERFD_L107($object)
	{
  	  $pdfObject = &$object;
  	  $pdfObject->HeaderPERFD();
	}
function HeaderVOLKD_L107($object)
{
  $pdfObject = &$object;
  $pdfObject->ln();
  ...
  // listarray($pdfObject->widths);echo "new page <br>\n";
	...
	function HeaderVHO_L107($object)
	{
  	  $pdfObject = &$object;
  	  $pdfObject->ln();
  	  $pdfObject->HeaderVHO();
	}
	function HeaderGRAFIEK_L107($object)
	{
  	  $pdfObject = &$object;
	...
	function HeaderCASH_L107($object)
	{
  	  $pdfObject = &$object;
  	  $pdfObject->HeaderCASH();
	}
	function HeaderCASHY_L107($object)
	{
  	  $pdfObject = &$object;
  	  $pdfObject->ln();
	...
	function HeaderMODEL_L107($object)
	{
  	  $pdfObject = &$object;
  	  $pdfObject->HeaderMODEL();
	}
	function HeaderSMV_L107($object)
	{
  	  $pdfObject = &$object;
  	  $pdfObject->HeaderSMV();
	}
	...
	function HeaderRISK_L107($object)
	{
  	  $pdfObject = &$object;
  	  $pdfObject->Line($pdfObject->marge,$pdfObject->GetY()+7,$pdfObject->marge + 283,$pdfObject->GetY()+7);
	}
  ...
  function HeaderATT_L107($object)
	{
    $pdfObject = &$object;
    $colW=280/11;
