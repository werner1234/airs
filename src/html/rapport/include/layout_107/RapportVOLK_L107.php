...
$Log: RapportVOLK_L107.php,v $
Revision 1.16  2019/02/27 13:50:51  rvv
*** empty log message ***

Revision 1.15  2018/03/04 10:14:13  rvv
*** empty log message ***

Revision 1.14  2016/08/17 16:01:13  rvv
*** empty log message ***

Revision 1.13  2016/03/20 14:32:23  rvv
*** empty log message ***

Revision 1.12  2015/08/05 15:58:52  rvv
*** empty log message ***

Revision 1.11  2014/10/25 14:39:09  rvv
*** empty log message ***

Revision 1.10  2013/11/30 14:24:56  rvv
*** empty log message ***

Revision 1.9  2013/10/23 15:45:31  rvv
*** empty log message ***

Revision 1.8  2013/08/28 16:02:50  rvv
*** empty log message ***

Revision 1.7  2013/08/04 10:49:02  rvv
*** empty log message ***

Revision 1.6  2013/04/27 16:29:28  rvv
*** empty log message ***

Revision 1.5  2013/04/17 16:00:15  rvv
*** empty log message ***
...
class RapportVOLK_L107
{
	function RapportVOLK_L107($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
 ...
 function getDividend($fonds)
  {
    ...
    $maxDagenOud=$dagen['VerouderdeKoersDagen'];
		...
		$actueleWaardePortefeuille = 0;
			...
			$query = "SELECT 
      TijdelijkeRapportage.afmCategorie as beleggingscategorie,
TijdelijkeRapportage.afmCategorieVolgorde,
TijdelijkeRapportage.afmCategorieOmschrijving as Omschrijving,
      ...
      LEFT JOIN Beleggingscategorien on (TijdelijkeRapportage.beleggingscategorie = Beleggingscategorien.Beleggingscategorie) 
       WHERE TijdelijkeRapportage.portefeuille = '".$this->portefeuille."' AND TijdelijkeRapportage.type = 'fondsen' AND TijdelijkeRapportage.rapportageDatum = '".$this->rapportageDatum."'"
			...
			" ORDER BY afmCategorieVolgorde asc, TijdelijkeRapportage.afmCategorie ";
       ...
       (TijdelijkeRapportage.beginPortefeuilleWaardeEuro) / ".$this->pdf->ValutaKoersBegin. " * ".$this->aandeel.") as beginPortefeuilleWaardeEuro,".
        ...
        round((UNIX_TIMESTAMP(TijdelijkeRapportage.rapportageDatum) - UNIX_TIMESTAMP(TijdelijkeRapportage.koersDatum))/86400) as koersLeeftijd,
           ...
           WHERE ".
				...
				" TijdelijkeRapportage.afmCategorie =  '".$categorien['beleggingscategorie']."' AND ".
