...
$Log: RapportOIV_L46.php,v $
Revision 1.1  2017/03/25 16:01:09  rvv
*** empty log message ***
...
class RapportOIV_L46
{
	function RapportOIV_L46($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
  ...
  function formatGetalKoers($waarde, $dec , $start = false)
	...
	//		$grafiekCategorien[$lastValuta]=$categorien[ValutaOmschrijving];
		...
		printPie_L46($this->pdf,$this->pdf->pieData,$kleurdata);
  //  listarray($kleurdata);
