...
$Log: RapportMUT_L74.php,v $
Revision 1.2  2020/03/18 17:44:11  rvv
*** empty log message ***
...
class RapportMUT_L74
{
	function RapportMUT_L74($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
...
//		$this->pdf->Line($totaal2+2,$this->pdf->GetY(),$totaal2 + $this->pdf->widthA[7],$this->pdf->GetY());
	...
	function writeRapport()
	{
      ...
      if($_POST['anoniem']==1)
      {
        if ($mutaties['Grootboekrekening'] == 'STORT')
        {
          $mutaties['Omschrijving'] = 'Storting';
        }
        elseif ($mutaties['Grootboekrekening'] == 'ONTTR')
        {
          $mutaties['Omschrijving'] = 'Onttrekking';
        }
      }
