...
class RapportOIS_L72
{

	function RapportOIS_L72($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
...
Rekeningmutaties.Fonds='".mysql_real_escape_string($fondsData['stop']['fonds'])."' AND Rekeningmutaties.transactieType IN('A','V','D','L')";
        $DB->SQL($query);
        $DB->Query();
