...
/* 	
    ...
    Author  						: $Author: rvv $
 		Laatste aanpassing	: $Date: 2020/06/14 06:42:29 $
 		File Versie					: $Revision: 1.8 $
 		
 		$Log: PDFRapport_headers_L86.php,v $
 		Revision 1.8  2020/06/14 06:42:29  rvv
 		*** empty log message ***
 		
 		Revision 1.7  2020/06/13 15:13:43  rvv
 		*** empty log message ***
 		
 		Revision 1.6  2020/06/06 15:49:31  rvv
 		*** empty log message ***
 		
 		Revision 1.5  2020/05/20 17:15:50  rvv
 		*** empty log message ***
 		
 		Revision 1.4  2020/01/25 16:37:33  rvv
 		*** empty log message ***
 		
 		Revision 1.3  2020/01/04 18:57:42  rvv
 		*** empty log message ***
...
function Header_basis_L86($object)
{
 $pdfObject = &$object;
  ...
  if ($pdfObject->rapport_type == "BRIEF")
    ...
    {  
      ...
      if($pdfObject->w > 250)
      {
		...
		//$pdfObject->MultiCell(120,4,"\n".$pdfObject->rapport_koptext,0,'L');
		$pdfObject->SetY($y);
    ...
    $pdfObject->SetX(0);
		...
		$pdfObject->SetY($y+32);
    $pdfObject->headerStart=$pdfObject->GetY()+35;
    $pdfObject->lastPortefeuille=$pdfObject->portefeuilledata['Portefeuille'];
}
}

	function HeaderVKM_L86($object)
	{
		$pdfObject = &$object;
		$pdfObject->HeaderVKM();
	}

function HeaderVKMS_L86($object)
{
  $pdfObject = &$object;
}
	
	  function HeaderFRONT_L86($object)
	  {
	    $pdfObject = &$object;
...
function HeaderDOORKIJKVR_L86($object)
{
  $pdfObject = &$object;
  //$pdfObject->headerSCENARIO();
...
function HeaderTRANSFEE_L86($object)
{
	$pdfObject = &$object;
	$pdfObject->ln();
  ...
  $dataWidth=array(28,50,28,28,28,28,28,28,28);
	...
	$pdfObject->SetLineWidth(0.1);
	  ...
	  function HeaderSCENARIO_L86($object)
	  {
	    $pdfObject = &$object;
	    //$pdfObject->headerSCENARIO();
    ...
    function HeaderRISK_L86($object)
    {
	    $pdfObject = &$object;
			$pdfObject->Ln();
    ...
    function HeaderGRAFIEK_L86($object)
    {
	    $pdfObject = &$object;
    }
function HeaderHUIS_L86($object)
{
  $pdfObject = &$object;
  
  $pdfObject->SetFont($pdfObject->rapport_font,'',$pdfObject->rapport_fontsize);
  $pdfObject->SetXY(8,8);
//  $pdfObject->MultiCell(100,4,vertaalTekst("Portefeuille",$pdfObject->rapport_taal).' '.$pdfObject->portefeuille,0,'L');
  $pdfObject->ln();
}

function HeaderKERNZ_L86($object)
{
  $pdfObject = &$object;
  ...
  $pdfObject->ln();
    ...
    function HeaderPERFD_L86($object)
    {
      $pdfObject = &$object;
      HeaderPERF_L86($object);
      $pdfObject->SetTextColor($pdfObject->rapport_fontcolor['r'],$pdfObject->rapport_fontcolor['g'],$pdfObject->rapport_fontcolor['b']);
    }



function HeaderTRANS_L86($object)
{
  $pdfObject = &$object;
...
$pdfObject->ln(2);
	  ...
	  function HeaderINHOUD_L86($object)
	  {
	    $pdfObject = &$object;
	    //$pdfObject->headerSCENARIO();
...
function HeaderPERF_L86($object)
{
  $pdfObject = &$object;
  $pdfObject->ln();
  $pdfObject->SetFillColor($pdfObject->rapport_kop_bgcolor['r'],$pdfObject->rapport_kop_bgcolor['g'],$pdfObject->rapport_kop_bgcolor['b']);
  ...
  $pdfObject->SetFont($pdfObject->rapport_font,'',$pdfObject->rapport_fontsize);
    ...
    function HeaderINDEX_L86($object)
	  {
	    $pdfObject = &$object;
	  }

function HeaderDOORKIJK_L86($object)
{
  $pdfObject = &$object;
}
    function HeaderOIB_L86($object)
	  {
	    $pdfObject = &$object;
      $pdfObject->Ln();
      		$pdfObject->SetFillColor($pdfObject->rapport_kop_bgcolor['r'],$pdfObject->rapport_kop_bgcolor['g'],$pdfObject->rapport_kop_bgcolor['b']);
...
*/
   ...
   function HeaderPERFG_L86($object)
	{
    $pdfObject = &$object;
...
*/
  ...
  function HeaderVOLK_L86($object)
	{
    $pdfObject = &$object;
   	$pdfObject->ln();
		$pdfObject->SetFont($pdfObject->rapport_font,$pdfObject->rapport_kop_fontstyle,$pdfObject->rapport_fontsize);
