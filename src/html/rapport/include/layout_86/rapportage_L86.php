<?php
// Client First Finance
$pdf->rapport_layout = 86;
$pdf->marge = 8;
...
{
  if (!isset($pdf->fonts['raleway']))
  {
    $pdf->AddFont('raleway', '', 'Raleway.php');
    $pdf->AddFont('raleway', 'B', 'RalewayB.php');
    $pdf->AddFont('raleway', 'I', 'RalewayI.php');
    $pdf->AddFont('raleway', 'BI', 'RalewayBI.php');
    
  }
  $pdf->rapport_font = 'raleway';
}
...
$pdf->rapport_voettext = '';//vertaalTekst("Aan deze opgave kunnen geen rechten worden ontleend. Ga naar de website voor meer informatie over de voorwaarden en de begrippenlijst.", $pdf->rapport_taal);
