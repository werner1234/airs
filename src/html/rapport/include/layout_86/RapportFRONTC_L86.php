...
$Log: RapportFRONTC_L86.php,v $
Revision 1.1  2020/05/16 16:24:10  rvv
*** empty log message ***
...
include_once($__appvar["basedir"]."/html/rapport/include/layout_86/RapportFRONT_L86.php");

class RapportFRONTC_L86
{
	function RapportFRONTC_L86($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
    $this->rapport = new RapportFRONT_L86($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum);
  }
