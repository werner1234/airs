...
class RapportVOLK_L86
{
	function RapportVOLK_L86($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
    ...
    $this->pdf->excelData[]=array('Categorie',"Fondsomschrijving","Aantal","Begin Koers","Begin Waarde","Begin Waarde EUR","Actuele Koers","Actuele Waarde","Actuele Waarde EUR","in %","Fondsresultaat","Valutanresultaat","Direct resultaat","in %");
	}
...
//echo $subquery."<br><br>";exit;
      ...
      $kopPrinted=false;
        ...
        $this->pdf->excelData[]=array($categorien['Omschrijving'],$subdata['fondsOmschrijving'],
          round($subdata['totaalAantal'],$this->pdf->rapport_VOLK_aantal_decimaal,$this->pdf->rapport_VOLK_aantalVierDecimaal),
