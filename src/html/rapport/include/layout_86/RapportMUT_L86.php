...
/*
Author  						: $Author: rvv $
Laatste aanpassing	: $Date: 2020/03/18 17:49:18 $
File Versie					: $Revision: 1.2 $

$Log: RapportMUT_L86.php,v $
Revision 1.2  2020/03/18 17:49:18  rvv
*** empty log message ***
...
class RapportMUT_L86
{
	function RapportMUT_L86($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
    ...
    $this->pdf->excelData[]=array('Transaction type','Omschrijving','Boekdatum','Amount');
	}
	...
	function writeRapport()
	{
	  ...
	  if ($this->pdf->rapportageValuta != "EUR" || $this->pdf->rapportageValuta != '')
	   ...
	   $extraquery .= "AND Rekeningmutaties.Grootboekrekening IN('$grootboekSelectie')  ";
		...
		{
      $this->pdf->excelData[]=array($mutaties['gbOmschrijving'],$mutaties['Omschrijving'],$mutaties['Boekdatum'],$mutaties['Credit']-$mutaties['Debet']);
