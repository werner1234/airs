...
/*
    ...
    Author  						: $Author: rvv $
 		Laatste aanpassing	: $Date: 2020/05/16 16:24:10 $
 		File Versie					: $Revision: 1.2 $

 		$Log: ATTberekening_L86.php,v $
 		Revision 1.2  2020/05/16 16:24:10  rvv
 		*** empty log message ***
...
class ATTberekening_L86
{

	function ATTberekening_L86($rapportData,$periode='maanden')
	{
...
//	     $AttributieStortingenOntrekkingen['totaal'] += $nietToegerekendeKosten['kostenTotaal'];
      ...
      // echo " $categorie $performance = ((($eindwaarde - $beginwaarde) - ".$AttributieStortingenOntrekkingen['totaal']." ) / $gemiddelde); <br>\n";
      /*
...
$stapelItems=array('procent','bijdrage','benchmark');
...
if(count($this->rapport->pdf->portefeuilles) > 1)
   $stapelenVerwijderen=true;
else
