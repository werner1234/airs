...
include_once("rapport/include/layout_116/ATTberekening_L116.php");

class RapportPERF_L116
{

  function RapportPERF_L116($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
  {
    $this->pdf = &$pdf;
    ...
    $this->att=new ATTberekening_L116($this);
  }
 ...
 */
  ...
  function addResultaat()
  {
    ...
    // $att=new ATTberekening_L116($this);
