...
class RapportAFM_L116
{
	function RapportAFM_L116($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
	  global $__appvar;
		$this->pdf = &$pdf;
    ...
    $this->pdf->rapport_type = "AFM";
  	...
  	$this->pdf->rapport_datum = db2jul($rapportageDatum);
		if($this->pdf->rapport_OIB_titel)
			...
			$this->pdf->rapport_titel = "AFM categorieën";
...
//			$grafiekCategorien[$categorien['afmCategorie']]+=$percentageVanTotaal; //toevoeging voor kleuren.
      ...
      $pieData[$categorie]['percentage'] = $subtotaalPercentage;
