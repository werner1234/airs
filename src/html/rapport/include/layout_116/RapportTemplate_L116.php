...
class RapportTemplate_L116
{
	function RapportTemplate_L116($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
	  global $__appvar;
		$this->pdf = &$pdf;
    ...
    $totPagina = ($lastpage-$startpagina+$paginaCorrectie);//-1
       ...
       $this->pdf->SetFont($this->pdf->rapport_font,'',$this->pdf->rapport_fontsize);
       $this->pdf->row(array('','In dit rapport vatten wij de met u besproken uitgangspunten en gemaakte afspraken samen, op basis van de bij ons bekende informatie. Als u hierin onjuistheden aantreft, wijzigingen nodig acht of als zich wijzigingen in relevante omstandigheden en/of in uw risicohouding voordoen, verzoeken wij u vriendelijk ons daarvan op de hoogte te stellen. Wij zullen hier rekening mee houden en komen in overleg met u mogelijk tot een aanpassing van uw profiel.

De voor u uitgevoerde transacties passen binnen het voor u vastgestelde risicoprofiel, waarbij rekening is gehouden met uw kennis en ervaring, beleggingsdoelstelling, persoonlijke omstandigheden, risicobereidheid en uw capaciteit om verlies te dragen en de spreiding in uw portefeuille.'));
