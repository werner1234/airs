...
/*
Author  						: $Author: rvv $
Laatste aanpassing	: $Date: 2019/03/31 12:20:45 $
File Versie					: $Revision: 1.8 $

$Log: RapportPERFD_L65.php,v $
Revision 1.8  2019/03/31 12:20:45  rvv
*** empty log message ***

Revision 1.7  2018/08/18 12:40:14  rvv
php 5.6 & consolidatie

Revision 1.6  2017/09/07 05:49:19  rvv
*** empty log message ***

Revision 1.5  2017/09/06 16:31:28  rvv
*** empty log message ***
...
class RapportPERFD_L65
{

	function RapportPERFD_L65($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
...
foreach($categorien as $categorie)
{
  ...
  foreach($categorien as $categorie)
  {
    ...
    else
    {
      if($categorie=='G-LIQ')
      {
        $effectenmutaties[] = $this->formatGetal($perfWaarden['stort']-$this->waarden['Periode']['totaal']['storting']+$this->waarden['Periode']['totaal']['onttrekking']-$perfWaarden['resultaat'], 0);
        $effectenmutaties[] = '';
