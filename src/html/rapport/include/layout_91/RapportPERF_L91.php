...
class RapportPERF_L91
{

	function RapportPERF_L91($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
...
//			$this->pdf->ln(2);
  ...
  function LineDiagram($w, $h, $data, $color=null, $maxVal=0, $minVal=0, $horDiv=4, $verDiv=4,$jaar=0)
  {
    ...
    $this->pdf->rect($startx,$YPage,$rectWidth,$h,'F','',array(251,204,233));
