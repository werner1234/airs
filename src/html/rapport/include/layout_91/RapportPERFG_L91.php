...
class RapportPERFG_L91
{

  function RapportPERFG_L91($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
...
if($this->pdf->lastPOST['perfPstart'] == 1)//8726 Altijd vanaf portefeuilleStart $this->pdf->lastPOST['perfPstart'] == 1 || $plotData=='VAR')
{
  if($datum['id'] > 0)
  {
    if($datum['month'] <10)
