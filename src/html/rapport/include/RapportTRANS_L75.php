...
$Log: RapportTRANS_L75.php,v $
Revision 1.8  2020/06/03 15:41:22  rvv
*** empty log message ***

Revision 1.7  2019/06/21 14:52:45  rm
7880

Revision 1.6  2019/06/02 10:03:42  rvv
*** empty log message ***

Revision 1.5  2019/05/25 16:22:07  rvv
*** empty log message ***

Revision 1.4  2018/08/18 12:40:15  rvv
php 5.6 & consolidatie

Revision 1.3  2018/07/14 14:05:14  rvv
*** empty log message ***
...
class RapportTRANS_L75
{
	function RapportTRANS_L75($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
	  ...
	  if ($this->pdf->rapportageValuta != "EUR" || $this->pdf->rapportageValuta != '')
	   $koersQuery =	" / (SELECT Koers FROM Valutakoersen WHERE Valuta='".$this->pdf->rapportageValuta."' AND Datum <= Rekeningmutaties.Boekdatum ORDER BY Datum DESC LIMIT 1 ) ";
		...
		$db2 = new DB();
			...
			// voor data
		$this->pdf->widthB = array(15,11,17,34,21,22,25,21,22,25,19.5,19.5,19,11);
