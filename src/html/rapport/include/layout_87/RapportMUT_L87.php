...
/*
Author  						: $Author: rvv $
Laatste aanpassing	: $Date: 2020/03/18 17:49:59 $
File Versie					: $Revision: 1.2 $

$Log: RapportMUT_L87.php,v $
Revision 1.2  2020/03/18 17:49:59  rvv
*** empty log message ***
...
class RapportMUT_L87
{
	function RapportMUT_L87($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
