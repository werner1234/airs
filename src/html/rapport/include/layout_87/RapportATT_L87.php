...
Revision 1.12  2016/11/05 17:51:08  rvv
*** empty log message ***

Revision 1.11  2015/12/30 19:01:23  rvv
*** empty log message ***

Revision 1.10  2015/12/19 14:27:30  rvv
*** empty log message ***

Revision 1.9  2015/11/07 16:45:15  rvv
*** empty log message ***

Revision 1.8  2015/05/13 15:45:13  rvv
*** empty log message ***

Revision 1.7  2015/04/26 12:26:58  rvv
*** empty log message ***

Revision 1.6  2015/04/15 18:25:11  rvv
*** empty log message ***
...
class RapportATT_L87
{
	function RapportATT_L87($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
...
//listarray($this->categorieVolgorde);
  ...
  $indexData = $index->getWaarden($this->rapportageDatumVanaf ,$this->rapportageDatum ,$this->portefeuille);//,$this->pdf->portefeuilledata['SpecifiekeIndex']);
...
*/
        ...
        $kleuren=array(array($this->pdf->rapport_kop_bgcolor['r'],$this->pdf->rapport_kop_bgcolor['g'],$this->pdf->rapport_kop_bgcolor['b']));// ,array($this->pdf->rapport_grafiek2[0],$this->pdf->rapport_grafiek2[1],$this->pdf->rapport_grafiek2[2]));
        $this->perfg->LineDiagram(270, 60, $grafiekData,$kleuren,0,0,6,5,1);//50
...
function formatGetalLength ($getal,$decimaal,$gewensteLengte)
{
 ...
 return number_format($getal,$decimaal,',','');
  ...
  function VBarDiagram($w, $h, $data)
  {
      ...
      $this->pdf->SetTextColor($this->pdf->rapport_grafiektxtcolor[0],$this->pdf->rapport_grafiektxtcolor[1],$this->pdf->rapport_grafiektxtcolor[2]);
