...
/* 	
    ...
    Author  						: $Author: rvv $
 		Laatste aanpassing	: $Date: 2020/03/29 08:53:32 $
 		File Versie					: $Revision: 1.6 $
 		
 		$Log: PDFRapport_headers_L87.php,v $
 		Revision 1.6  2020/03/29 08:53:32  rvv
 		*** empty log message ***
 		
 		Revision 1.5  2020/03/29 06:55:58  rvv
 		*** empty log message ***
 		
 		Revision 1.4  2020/03/29 06:51:22  rvv
 		*** empty log message ***
 		
 		Revision 1.3  2020/03/28 15:47:31  rvv
 		*** empty log message ***
 		...
 		*** empty log message ***
 		...
 		Revision 1.20  2016/10/23 11:32:33  rvv
 		*** empty log message ***
 		


*/
function Header_basis_L87($object)
{
 $pdfObject = &$object;
  ...
  if ($pdfObject->rapport_type == "MODEL")
  {
    $pdfObject->rapport_titel='';
  }
    ...
    $pdfObject->lastPortefeuille=$pdfObject->portefeuilledata['Portefeuille'];
	  ...
	  function HeaderFRONTBRIEF_L87($object)
    {
    
    }

	function HeaderVKM_L87($object)
	{
		$pdfObject = &$object;
		$pdfObject->HeaderVKM();
    $pdfObject->SetTextColor($pdfObject->rapport_default_fontcolor['r'],$pdfObject->rapport_default_fontcolor['g'],$pdfObject->rapport_default_fontcolor['b']);
	  ...
	  function HeaderFRONT_L87($object)
	  {
	    $pdfObject = &$object;
      $pdfObject->SetTextColor($pdfObject->rapport_default_fontcolor['r'],$pdfObject->rapport_default_fontcolor['g'],$pdfObject->rapport_default_fontcolor['b']);
	  ...
	  function HeaderSCENARIO_L87($object)
	  {
	    $pdfObject = &$object;
	    //$pdfObject->headerSCENARIO();
	  ...
	  function HeaderDOORKIJK_L87($object)
    {
      $pdfObject = &$object;
     //$pdfObject->headerSCENARIO();
    }

    function HeaderRISK_L87($object)
    {
	    $pdfObject = &$object;
			$pdfObject->Ln();
    ...
    function HeaderGRAFIEK_L87($object)
    {
	    $pdfObject = &$object;
      $pdfObject->Ln();
      $pdfObject->SetFillColor($pdfObject->rapport_kop_bgcolor['r'],$pdfObject->rapport_kop_bgcolor['g'],$pdfObject->rapport_kop_bgcolor['b']);
...
function HeaderMODEL_L87($object)
{
  $pdfObject = &$object;
 // $pdfObject->Ln();
//
...
// $pdfObject->Line($pdfObject->marge ,$pdfObject->GetY(),$pdfObject->marge + 280,$pdfObject->GetY());
 $pdfObject->SetFont("Times","",10);
    ...
    function HeaderPERFD_L87($object)
    {
      $pdfObject = &$object;
      HeaderPERF_L87($object);
      $pdfObject->SetTextColor($pdfObject->rapport_fontcolor['r'],$pdfObject->rapport_fontcolor['g'],$pdfObject->rapport_fontcolor['b']);
    }
  
    
    function HeaderTRANS_L87($object)
	  {
	    $pdfObject = &$object;
    	$pdfObject->SetFont($pdfObject->rapport_font,$pdfObject->rapport_kop_fontstyle,$pdfObject->rapport_fontsize);
		  ...
		  $inkoopEind = $inkoop  + $pdfObject->widthB[4] + $pdfObject->widthB[5] + $pdfObject->widthB[6]+ $pdfObject->widthB[7] ;

		  $verkoop			= $inkoopEind;
		  $verkoopEind = $verkoop + $pdfObject->widthB[8] + $pdfObject->widthB[9]+ $pdfObject->widthB[10]+ $pdfObject->widthB[11];
...
$pdfObject->ln(2);
	  ...
	  function HeaderINHOUD_L87($object)
	  {
	    $pdfObject = &$object;
	    //$pdfObject->headerSCENARIO();

	  }	  
 	  function HeaderPERF_L87($object)
	  {
	    $pdfObject = &$object;
      $pdfObject->ln();
      $pdfObject->SetFillColor($pdfObject->rapport_kop_bgcolor['r'],$pdfObject->rapport_kop_bgcolor['g'],$pdfObject->rapport_kop_bgcolor['b']);
...
$pdfObject->ln();
    ...
    function HeaderINDEX_L87($object)
	  {
	    $pdfObject = &$object;
	  }

function HeaderOIH_L87($object)
{
  $pdfObject = &$object;
  $pdfObject->Ln();
}

function HeaderKERNZ_L87($object)
{
  $pdfObject = &$object;
  $pdfObject->Ln();
}

function HeaderKERNV_L87($object)
{
  $pdfObject = &$object;
  $pdfObject->Ln();
}

function HeaderOIR_L87($object)
{
  $pdfObject = &$object;
  HeaderOIS_L87($pdfObject);
}

function HeaderTRANSFEE_L87($object)
{
  $pdfObject = &$object;
  HeaderOIS_L87($pdfObject);
}
    function HeaderOIB_L87($object)
	  {
	    $pdfObject = &$object;
      $pdfObject->Ln();
      		$pdfObject->SetFillColor($pdfObject->rapport_kop_bgcolor['r'],$pdfObject->rapport_kop_bgcolor['g'],$pdfObject->rapport_kop_bgcolor['b']);
...
*/
   ...
   function HeaderPERFG_L87($object)
	{
    $pdfObject = &$object;
...
*/
  ...
  function HeaderVOLK_L87($object)
	{
    $pdfObject = &$object;
   	$pdfObject->ln();
		$pdfObject->SetFont($pdfObject->rapport_font,$pdfObject->rapport_kop_fontstyle,$pdfObject->rapport_fontsize);
...
function HeaderOIS_L87($object)
{
  $pdfObject = &$object;
  $pdfObject->ln();
  $pdfObject->SetFillColor($pdfObject->rapport_kop_bgcolor['r'],$pdfObject->rapport_kop_bgcolor['g'],$pdfObject->rapport_kop_bgcolor['b']);
  $pdfObject->Rect($pdfObject->marge, $pdfObject->getY(), $pdfObject->w-$pdfObject-$pdfObject->marge*2, 8 , 'F');
  $pdfObject->SetTextColor($pdfObject->rapport_kop_fontcolor['r'],$pdfObject->rapport_kop_fontcolor['g'],$pdfObject->rapport_kop_fontcolor['b']);
  
  $pdfObject->SetWidths(array(55,35,12,17,17,20,20,18,18,18,17,17,16));
  ...
  $pdfObject->row(array("\n".vertaalTekst("Fondsomschrijving",$pdfObject->rapport_taal),
                    ...
                    "\n".vertaalTekst("Waarde",$pdfObject->rapport_taal),
                    "\n".vertaalTekst("Waarde ".$teken,$pdfObject->rapport_taal),
                    vertaalTekst("Gewicht in portefeuille",$pdfObject->rapport_taal),
                    vertaalTekst("Fonds\nresultaat",$pdfObject->rapport_taal),
                    vertaalTekst("Directe opbrengst ".$teken,$pdfObject->rapport_taal),
