...
class ATTberekening_L105
{
  
  function ATTberekening_L105($rapportData)
  {
  ...
  function getPerf($portefeuille, $datumBegin, $datumEind,$valuta='EUR',$details=false)
  {
    ...
    if($startJaar<2020)
    {
      if(db2jul($datumEind)<db2jul('2020-01-01'))
      {
      ...
      else
      {
        if(db2jul($datumEind)>=db2jul('2020-01-01'))
        {
          $eerste = $index->getWaarden($datumBegin, '2019-12-31', $portefeuille, '', 'maanden', $valuta);
          $tweede = $index->getWaarden('2020-01-01', $datumEind, $portefeuille, '', 'TWR', $valuta);
        }
      }
    }
    else
    {
      $eerste = $index->getWaarden($datumBegin, $datumEind, $portefeuille, '', 'TWR', $valuta);
    }
