...
class RapportVOLK_L105
{
	function RapportVOLK_L105($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
  ...
  function getDividend($fonds)
  {
    ...
    $this->pdf->templateVars['VOLKPaginas']=$this->pdf->page;
		...
		$actueleWaardePortefeuille = 0;
			...
			" TijdelijkeRapportage.hoofdcategorie, SUM(TijdelijkeRapportage.beginPortefeuilleWaardeEuro) / ".$this->pdf->ValutaKoersBegin. " as subtotaalbegin,".
