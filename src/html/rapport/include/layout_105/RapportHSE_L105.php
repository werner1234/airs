...
class RapportHSE_L105
{
	function RapportHSE_L105($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum, $valuta = 'EUR')
	{
		$this->pdf = &$pdf;
...
*/
    ...
    $this->pdf->templateVars['HSEPaginas']=$this->pdf->page;
		...
		$query = "SELECT TijdelijkeRapportage.hoofdcategorieOmschrijving as BeleggingscategorieOmschrijving, ".
    ...
    printRendement_L105($this->pdf,$this->portefeuille, $this->rapportageDatum, $this->rapportageDatumVanaf,false,$this->pdf->rapportageValuta);
