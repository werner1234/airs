...
$Log: RapportSCENARIO_L56.php,v $
Revision 1.8  2020/03/28 16:26:42  rvv
*** empty log message ***

Revision 1.7  2019/04/06 17:11:28  rvv
*** empty log message ***

Revision 1.6  2018/02/04 15:47:35  rvv
*** empty log message ***

Revision 1.5  2016/10/23 11:32:33  rvv
*** empty log message ***

Revision 1.4  2016/01/23 17:53:31  rvv
*** empty log message ***
...
class RapportSCENARIO_L56
{
	function RapportSCENARIO_L56($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
  ...
  function formatGetalKoers($waarde, $dec , $start = false)
    ...
    $this->pdf->setY(50+$this->yCorrectie);
    ...
    //
     ...
     $this->pdf->setY(80+$this->yCorrectie);
...
//    {
    ...
    $this->pdf->setXY(160,125+$this->yCorrectie);
    $this->pdf->SetFont($this->pdf->rapport_font,'b',$this->pdf->rapport_fontsize);
    $this->pdf->Cell(130,0,'Kans op behalen doelstelling bij diverse profielen',0,0,'C');
    $this->pdf->setXY(160,130+$this->yCorrectie);
...
//
    ...
    $this->pdf->setXY($this->pdf->marge,50+$this->yCorrectie);
    $this->pdf->SetFont($this->pdf->rapport_font,'b',$this->pdf->rapport_fontsize);
    ...
    $this->pdf->setXY(20,125+$this->yCorrectie);
    $this->pdf->SetFont($this->pdf->rapport_font,'b',$this->pdf->rapport_fontsize);
    $this->pdf->Cell(125,0,'Scenario-analyse',0,0,'C');
    $this->pdf->setXY(20,130+$this->yCorrectie);
    if($this->pdf->lastPOST['scenario_werkelijkVerloop']==1)
    {
    ...
    $this->pdf->setY(90+$this->yCorrectie);
   ...
   // listarray($this->scenarioKleur);
    //$this->pdf->rapport_voettext.=
    $this->pdf->SetXY($this->pdf->marge,198+$this->yCorrectie);
...
function scatterplot($w, $h, $data,$maxStdev=25,$beste)
  {
    ...
    $rood=array(125,165,215);//array(180,50,50);
    $groen=array(200,200,200);
    $steps=100;
