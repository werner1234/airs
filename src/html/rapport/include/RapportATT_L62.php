...
/*
Author  						: $Author: rvv $
Laatste aanpassing	: $Date: 2015/12/16 17:06:48 $
File Versie					: $Revision: 1.4 $

$Log: RapportATT_L62.php,v $
Revision 1.4  2015/12/16 17:06:48  rvv
*** empty log message ***
...
include_once($__appvar["basedir"]."/html/rapport/include/ATTberekening_L62.php");


class RapportATT_L62
{
	function RapportATT_L62($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
...
//listarray($this->categorieVolgorde);
  ...
  $index=new indexHerberekening_L62();
...
foreach ($indexData as $index=>$data)
{
  ...
  //$barGraph['Index'][$data['datum']]['leeg']=0;
    ...
    GROUP BY hoofdcategorie  ORDER BY hoofdcategorieVolgorde asc"; //WHERE Beleggingscategorie IN('LIQ','ZAK','VAR','Liquiditeiten')
		...
		{
		  if($data['Beleggingscategorie']=='G-LIQ')
