...
/*
Author  						: $Author: rvv $
Laatste aanpassing	: $Date: 2019/07/27 18:00:44 $
File Versie					: $Revision: 1.3 $

$Log: RapportTRANSFEE_L72.php,v $
Revision 1.3  2019/07/27 18:00:44  rvv
*** empty log message ***

Revision 1.2  2017/05/25 14:35:58  rvv
*** empty log message ***

Revision 1.1  2017/04/15 19:11:50  rvv
*** empty log message ***
...
class RapportTRANSFEE_L72
{
	function RapportTRANSFEE_L72($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
		...
		$this->pdf->excelData[]=array("Datum",'Aan/verkoop','Aantal','Fonds','ISIN Code','Aankoopkoers in valuta','Aankoopwaarde in valuta','Aankoopwaarde in EUR',
	...
	function writeRapport()
	{
		...
		$query = "SELECT Fondsen.Omschrijving, ".
			"Fondsen.Fondseenheid,Fondsen.ISINCode, ".
