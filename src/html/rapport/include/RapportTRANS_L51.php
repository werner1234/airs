...
$Log: RapportTRANS_L51.php,v $
Revision 1.7  2019/08/07 15:30:49  rvv
*** empty log message ***

Revision 1.6  2015/12/31 09:20:18  rvv
*** empty log message ***
...
Revision 1.3  2014/06/11 15:35:21  rvv
*** empty log message ***

Revision 1.2  2014/05/03 15:47:40  rvv
*** empty log message ***
...
class RapportTRANS_L51
{
	function RapportTRANS_L51($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
	...
	function writeRapport()
	{
	  ...
	  if ($this->pdf->rapportageValuta != "EUR" || $this->pdf->rapportageValuta != '')
	   $koersQuery =	" / (SELECT Koers FROM Valutakoersen WHERE Valuta='".$this->pdf->rapportageValuta."' AND Datum <= Rekeningmutaties.Boekdatum ORDER BY Datum DESC LIMIT 1 ) ";
		...
		{
		// voor data
		$this->pdf->widthB = array(14,12,20,50,20,22,22,20,22,22,23,22,12);
...
//	echo "lopende -> ".$resultaatlopende." <-  voorgaande ".$resultaatvoorgaande. " -  <br>" ;
      ...
      if($beginditjaar <> 0)
        $beginditjaarTxt=$this->formatGetal($beginditjaar,$this->pdf->rapport_TRANS_decimaal);
      else
        $beginditjaarTxt='';  
				...
				$this->pdf->row(array(date("d-m-y",db2jul($mutaties['Boekdatum'])),
											...
											$this->formatAantal($mutaties['Aantal'],0,true),
											"",
											$aankoop_koers,
											$aankoop_waardeinValuta,
											$aankoop_waarde,
