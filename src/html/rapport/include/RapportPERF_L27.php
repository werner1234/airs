...
/*
Author  						: $Author: rvv $
Laatste aanpassing	: $Date: 2017/11/09 06:49:14 $
File Versie					: $Revision: 1.2 $

$Log: RapportPERF_L27.php,v $
Revision 1.2  2017/11/09 06:49:14  rvv
*** empty log message ***

Revision 1.1  2017/11/08 17:12:56  rvv
*** empty log message ***
...
class RapportPERF_L27
{

	function RapportPERF_L27($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
...
//listarray($grafiekData);
      ...
      $DB->SQL($query);
		...
		$vkm=new RapportHulpVKM_L27($this->portefeuille, $this->rapportageDatumVanaf, $this->rapportageDatum);
		$this->pdf->setY(50);
