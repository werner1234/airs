...
class RapportDOORKIJK_L49
{
	function RapportDOORKIJK_L49($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = $pdf;
...
KeuzePerVermogensbeheerder.categorie='Beleggingscategorien' ";
		...
		if(count($beleggingscategorien)>0)
		{
			...
			$this->pdf->Cell(100,4,'Allocaties inclusief uitsplitsing zakelijke waarden');
