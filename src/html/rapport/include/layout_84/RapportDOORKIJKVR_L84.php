...
$Log: RapportDOORKIJKVR_L84.php,v $
Revision 1.7  2020/02/29 16:23:08  rvv
*** empty log message ***

Revision 1.6  2019/09/07 16:08:37  rvv
*** empty log message ***

Revision 1.5  2019/09/04 15:33:05  rvv
*** empty log message ***

Revision 1.4  2019/08/31 12:21:30  rvv
*** empty log message ***

Revision 1.3  2019/08/07 12:34:52  rvv
*** empty log message ***
...
class RapportDOORKIJKVR_L84
{
	function RapportDOORKIJKVR_L84($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = $pdf;
...
KeuzePerVermogensbeheerder.categorieIXP='Obligaties' ";
		...
		{
			$this->pdf->rapport_titel = "Allocaties inclusief doorkijk obligaties";
			$this->pdf->AddPage();
