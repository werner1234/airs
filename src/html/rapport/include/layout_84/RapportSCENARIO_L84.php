...
/*
Author  						: $Author: rvv $
Laatste aanpassing	: $Date: 2019/08/03 17:03:51 $
File Versie					: $Revision: 1.2 $

$Log: RapportSCENARIO_L84.php,v $
Revision 1.2  2019/08/03 17:03:51  rvv
*** empty log message ***

Revision 1.1  2019/07/27 18:01:41  rvv
*** empty log message ***
...
class RapportSCENARIO_L84
{
	function RapportSCENARIO_L84($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
...
//
    ...
    if($this->pdf->lastPOST['scenario_werkelijkVerloop']==1)
    {
      ...
      $this->LineDiagram(125,45,$grafiek,$sc->werkelijkVerloop,$sc->CRMdata['doelvermogen']);
    }
    else
      $this->LineDiagram(125,45,$sc->scenarioGemiddelde,'',$sc->CRMdata['doelvermogen']);
