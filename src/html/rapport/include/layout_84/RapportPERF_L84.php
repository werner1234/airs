...
$Log: RapportPERF_L84.php,v $
Revision 1.6  2019/10/05 17:39:27  rvv
*** empty log message ***

Revision 1.5  2019/07/24 15:48:02  rvv
*** empty log message ***
...
include_once("rapport/include/layout_84/ATTberekening_L84.php");
include_once("rapport/include/ATTberekening_L56.php");

class RapportPERF_L84
{

	function RapportPERF_L84($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
    ...
    $this->att=new ATTberekening_L84($this);
	}
  ...
  function getPerformance($fonds,$vanaf,$tot,$valuta=false)
  {
    ...
    foreach($maanden as $maand)
    {
      ...
      //echo "m $fonds ".($jaarPerf-$voorPerf)." = $totalPerf <br>\n";
    }
