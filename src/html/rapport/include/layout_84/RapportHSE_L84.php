...
/*
Author  						: $Author: rvv $
Laatste aanpassing	: $Date: 2019/06/05 16:40:11 $
File Versie					: $Revision: 1.1 $

$Log: RapportHSE_L84.php,v $
...
class RapportHSE_L84
{
	function RapportHSE_L84($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum, $valuta = 'EUR')
	{
		$this->pdf = &$pdf;
