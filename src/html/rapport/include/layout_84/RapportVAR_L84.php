...
/*
Author  						: $Author: rvv $
Laatste aanpassing	: $Date: 2019/07/05 16:47:00 $
File Versie					: $Revision: 1.1 $

$Log: RapportVAR_L84.php,v $
...
class RapportVAR_L84
{
	function RapportVAR_L84($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
