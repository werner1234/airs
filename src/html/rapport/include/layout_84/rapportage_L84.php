...
*/
        ...
        $pdf->rapport_logoKleurBlauw=array(0,166,217);
        $pdf->rapport_logoKleurPaars=array(98,41,119);
        $pdf->grafiekAchtergrondKleur=array(255,255,255);
        $pdf->rapport_kop_bgcolor = array('r' => $pdf->rapport_logoKleurPaars[0], 'g' => $pdf->rapport_logoKleurPaars[1], 'b' => $pdf->rapport_logoKleurPaars[2]); //35/45/104 //33/43/105 //'r'=>88,'g'=>119,'b'=>255
