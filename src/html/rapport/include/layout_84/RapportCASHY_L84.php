...
/*
    ...
    Author  						: $Author: rvv $
 		Laatste aanpassing	: $Date: 2019/12/04 15:57:47 $
 		File Versie					: $Revision: 1.1 $

 		$Log: RapportCASHY_L84.php,v $
 		Revision 1.1  2019/12/04 15:57:47  rvv
 		*** empty log message ***
...
class RapportCASHY_L84
{
	function RapportCASHY_L84($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
	 //
		$this->pdf = &$pdf;
...
$this->pdf->CellBorders = array();
	...
	function VBarDiagram($w, $h, $data,$titel)
  {
      ...
      $colors=array('rente'=>$this->pdf->rapport_logoKleurPaars,
      'lossing'=>$this->pdf->rapport_logoKleurBlauw);
