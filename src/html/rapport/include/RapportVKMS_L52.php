...
Revision 1.2  2018/02/22 07:45:39  rvv
*** empty log message ***

Revision 1.1  2018/02/21 17:15:09  rvv
*** empty log message ***
...
class RapportVKMS_L52
{
	function RapportVKMS_L52($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		if(is_object($pdf))
		{
			$this->pdf = &$pdf;
