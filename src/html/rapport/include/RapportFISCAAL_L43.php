...
/*
Author  						: $Author: rvv $
Laatste aanpassing	: $Date: 2015/08/26 15:49:46 $
File Versie					: $Revision: 1.1 $

$Log: RapportFISCAAL_L43.php,v $
Revision 1.1  2015/08/26 15:49:46  rvv
*** empty log message ***
...
class RapportFISCAAL_L43
{
	function RapportFISCAAL_L43($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
    ...
    $fiscaleWaardeEffecten=0;
        ...
        $fiscaleWaardering=min($subdata['historischeWaardeTotaalValuta'],$subdata['actuelePortefeuilleWaardeEuro']);
				  ...
				  $this->pdf->row(array("",
												"",
                        $this->formatAantal($subdata['totaalAantal'],$this->pdf->rapport_VHO_decimaal,true),
