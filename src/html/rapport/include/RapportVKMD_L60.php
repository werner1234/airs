...
include_once($__appvar["basedir"]."/html/rapport/include/RapportVKMS_L60.php");

class RapportVKMD_L60
{

	function RapportVKMD_L60($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->vkm=new RapportVKMS_L60($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum);
	}
