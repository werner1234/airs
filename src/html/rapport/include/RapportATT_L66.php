...
/*
Author  						: $Author: rvv $
Laatste aanpassing	: $Date: 2016/03/09 17:24:31 $
File Versie					: $Revision: 1.2 $

$Log: RapportATT_L66.php,v $
...
class RapportATT_L66
{
	function RapportATT_L66($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
