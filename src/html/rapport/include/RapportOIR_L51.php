...
$Log: RapportOIR_L51.php,v $
Revision 1.5  2019/03/10 14:08:16  rvv
*** empty log message ***

Revision 1.4  2019/03/09 18:46:18  rvv
*** empty log message ***

Revision 1.3  2019/02/13 16:42:08  rvv
*** empty log message ***

Revision 1.2  2019/01/20 12:14:00  rvv
*** empty log message ***

Revision 1.1  2018/11/04 11:15:32  rvv
*** empty log message ***
...
class RapportOIR_L51
{
	function RapportOIR_L51($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
  ...
  function formatGetalKoers($waarde, $dec , $start = false)
    ...
    $this->pdf->AddPage();
    $this->pdf->templateVars['OIRPaginas']=$this->pdf->page;
    $this->pdf->templateVarsOmschrijving['OIRPaginas']=$this->pdf->rapport_titel;
    ...
    $query = "SELECT Portefeuilles.vermogensbeheerder,Portefeuilles.startDatum, Clienten.Naam, Clienten.Naam1, Portefeuilles.Depotbank, Portefeuilles.AEXVergelijking, Portefeuilles.SpecifiekeIndex, Portefeuilles.Vermogensbeheerder, Portefeuilles.ClientVermogensbeheerder, Portefeuilles.Risicoklasse, Portefeuilles.Client FROM Portefeuilles, Clienten WHERE Portefeuille = '".$this->portefeuille."' AND Portefeuilles.Client = Clienten.Client ";
		...
		//$oibData=$this->oib->categorien;
		$oibData['totaal']['port']['procent']=1;
//listarray($oibData);
    
    //$verdeling=ophalenVerdelingsData_L51($this,$this->portefeuille,$this->portefeuille,'');

    //$oibData=$verdeling[$this->portefeuille]['beleggingscategorie'];
    //$categorieOmschrijvingen=$verdeling['beleggingscategorien'];
   ...
   foreach ($this->jaarTotalen as $categorie=>$jaarWaarden)
    {
     ...
     // listarray($this->maandTotalen);
      ...
      $colors=array('allocate effect'=>array(85,140,200),'selectie effect'=>array(100,230,60));//,'Totaal'=>array(0, 52, 121)); //'attributie effect'=>,array(87,165,25)
      $xval=25;$yval=185;
    ...
    //  $colors=array('allocate effect'=>array(0,52,121),'selectie effect'=>array(87,165,25),'attributie effect'=>array(108,31,128)); //
     $colors=array('allocate effect'=>array(85,140,200),'selectie effect'=>array(100,230,60),'attributie effect'=>array(255,0,0)); //
...
function LineDiagram($x,$y,$w, $h, $data, $title,$color=null, $maxVal=0, $minVal=0, $horDiv=4, $verDiv=4,$jaar=0)
  {
   ...
   // $color=array(200,0,0);
    ...
    $colors=array('allocateEffect'=>array(85,140,200),'selectieEffect'=>array(100,230,60),'attributieEffect'=>array(255,0,0)); //
  ...
  function VBarDiagram2($w, $h, $data, $format, $color=null,$nbDiv=4,$numBars=0)
  {
      ...
      $colors=array('allocateEffect'=>array(85,140,200),'selectieEffect'=>array(100,230,60));//,'totaalEffect'=>array(0, 52, 121)); //
