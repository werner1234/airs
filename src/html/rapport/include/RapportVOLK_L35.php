...
$Log: RapportVOLK_L35.php,v $
Revision 1.4  2017/04/05 15:39:45  rvv
*** empty log message ***

Revision 1.3  2012/10/31 16:59:18  rvv
*** empty log message ***

Revision 1.2  2012/05/02 15:53:13  rvv
*** empty log message ***
...
class RapportVOLK_L35
{
	function RapportVOLK_L35($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
     ...
     "
      ...
      ".
        ...
        WHERE ".
				...
				.$__appvar['TijdelijkeRapportageMaakUniek'].
				" ORDER BY TijdelijkeRapportage.Lossingsdatum, fondsVolgorde,OptieBovenliggendFonds,TijdelijkeRapportage.fondsOmschrijving";//exit;
