...
$Log: RapportVAR_L70.php,v $
Revision 1.2  2020/07/15 16:38:19  rvv
*** empty log message ***
...
class RapportVAR_L70
{
	function RapportVAR_L70($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
...
$this->pdf->fillCell = array($this->pdf->cellColorLight,$this->pdf->cellColorLight,$this->pdf->cellColorDark,$this->pdf->cellColorLight,$this->pdf->cellColorDark,$this->pdf->cellColorLight,$this->pdf->cellColorLight,$this->pdf->cellColorDark,$this->pdf->cellColorLight,$this->pdf->cellColorDark,$this->pdf->cellColorLight,$this->pdf->cellColorDark,$this->pdf->cellColorLight,$this->pdf->cellColorDark,1);
				$this->pdf->row(array("",
