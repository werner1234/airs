...
/*
Author  						: $Author: rvv $
Laatste aanpassing	: $Date: 2015/11/29 13:13:22 $
File Versie					: $Revision: 1.1 $

$Log: RapportVHO_L65.php,v $
...
Revision 1.4  2015/03/04 16:30:29  rvv
*** empty log message ***
...
class RapportVHO_L65
{
	function RapportVHO_L65($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
...
//     " Rekeningmutaties.Boekdatum >= '".	$this->rapportageDatumVanaf."' AND ".
	...
	function writeRapport()
	{
		...
		$this->pdf->widthB = array(5,55,18,15,20,21,1,16,21,21,17,17,17,17,21);
		$this->pdf->alignB = array('R','L','R','R','R','R','R','R','R','R','R','R','R','R','R','R');

		// voor kopjes
		$this->pdf->widthA = array(   60,18,15,20,21,1,16,21,21,17,17,17,17,21);
