...
/*
    ...
    Author  						: $Author: rvv $
 		Laatste aanpassing	: $Date: 2015/07/11 14:20:20 $
 		File Versie					: $Revision: 1.2 $

 		$Log: RapportCASHY_L54.php,v $
 		Revision 1.2  2015/07/11 14:20:20  rvv
 		*** empty log message ***
...
class RapportCASHY_L54
{
	function RapportCASHY_L54($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
	 //
		$this->pdf = &$pdf;
...
$this->pdf->CellBorders = array();
	...
	function VBarDiagram($w, $h, $data,$titel)
  {
      ...
      $colors=array('rente'=>array(181,190,24),
      'lossing'=>array(74,174,66));
