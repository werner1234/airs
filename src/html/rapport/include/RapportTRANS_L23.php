...
Revision 1.1  2010/03/10 19:53:17  rvv
*** empty log message ***
...
class RapportTRANS_L23
{
	function RapportTRANS_L23($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
	...
	function writeRapport()
	{
	  ...
	  if ($this->pdf->rapportageValuta != "EUR" || $this->pdf->rapportageValuta != '')
	   $koersQuery =	" / (SELECT Koers FROM Valutakoersen WHERE Valuta='".$this->pdf->rapportageValuta."' AND Datum <= Rekeningmutaties.Boekdatum ORDER BY Datum DESC LIMIT 1 ) ";
		...
		{
		// voor data
		$this->pdf->widthA = array(15,18,40,18,40,25,22,22,22,22,30);
		$this->pdf->alignA = array('L','R','L','R','L','L','R','R','R','R');
     ...
     Rekeningmutaties.omschrijving as rekeningOmschrijving,
		...
		foreach ($buffer as $mutaties)
		{
			...
			$mutaties['realAantal'] = $mutaties[Aantal];
...
//			$this->pdf->Cell($this->pdf->widthB[2],4,"");
	//		$this->pdf->Cell($this->pdf->widthB[3],4,);
