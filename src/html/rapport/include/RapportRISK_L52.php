...
$Log: RapportRISK_L52.php,v $
Revision 1.3  2019/04/24 13:12:12  rvv
*** empty log message ***

Revision 1.2  2019/04/24 12:01:24  rvv
*** empty log message ***

Revision 1.1  2018/04/18 16:17:33  rvv
*** empty log message ***

Revision 1.1  2017/11/01 16:51:06  rvv
*** empty log message ***
...
class RapportRISK_L52
{

	function RapportRISK_L52($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
