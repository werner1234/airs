...
/*
    ...
    Author  						: $Author: rvv $
 		Laatste aanpassing	: $Date: 2019/12/28 11:28:02 $
 		File Versie					: $Revision: 1.5 $

 		$Log: ATTberekening_L80.php,v $
 		Revision 1.5  2019/12/28 11:28:02  rvv
 		*** empty log message ***
 		
 		Revision 1.4  2019/12/07 17:48:23  rvv
 		*** empty log message ***
 		
 		Revision 1.3  2019/12/01 17:55:28  rvv
 		*** empty log message ***
...
class ATTberekening_L80
{

	function ATTberekening_L80($rapportData,$periode='maanden')
	{
...
//	     $AttributieStortingenOntrekkingen['totaal'] += $nietToegerekendeKosten['kostenTotaal'];
      ...
      $resultaatBruto=       ($eindwaarde - $beginwaarde) - $AttributieStortingenOntrekkingenBruto['totaal']+ $RekeningDirecteKostenOpbrengsten['kostenTotaal'];
...
//listarray($RekeningDirecteKostenOpbrengsten); ob_flush();
  ...
  'stort'=>$AttributieStortingenOntrekkingenBruto['totaal'],
        'storting'=>$AttributieStortingenOntrekkingenBruto['storting'],
        'onttrekking'=>$AttributieStortingenOntrekkingenBruto['onttrekking'],

        'stortBruto'=>$AttributieStortingenOntrekkingen['totaal'],
        'stortingBruto'=>$AttributieStortingenOntrekkingen['storting'],
        'onttrekkingBruto'=>$AttributieStortingenOntrekkingen['onttrekking'],
