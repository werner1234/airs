...
$Log: RapportTRANS_L56.php,v $
Revision 1.11  2019/06/21 14:52:45  rm
7880

Revision 1.10  2019/05/11 16:48:39  rvv
*** empty log message ***

Revision 1.9  2018/12/29 13:57:23  rvv
*** empty log message ***
...
class RapportTRANS_L115
{
	function RapportTRANS_L115($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
	  ...
	  if ($this->pdf->rapportageValuta != "EUR" || $this->pdf->rapportageValuta != '')
	   $koersQuery =	" / (SELECT Koers FROM Valutakoersen WHERE Valuta='".$this->pdf->rapportageValuta."' AND Datum <= Rekeningmutaties.Boekdatum ORDER BY Datum DESC LIMIT 1 ) ";
		...
		$db2 = new DB();
			...
			// voor data
		$this->pdf->widthB = array(15,16,17,38,16,22,25,16,22,25,19.5,19.5,19,11);
...
//	echo "lopende -> ".$resultaatlopende." <-  voorgaande ".$resultaatvoorgaande. " -  <br>" ;
    ...
    $this->pdf->SetFont($this->pdf->rapport_font,$this->pdf->rapport_fontstyle,$this->pdf->rapport_fontsize);
		$this->pdf->SetTextColor($this->pdf->rapport_default_fontcolor[r],$this->pdf->rapport_default_fontcolor[g],$this->pdf->rapport_default_fontcolor[b]);
    //$this->pdf->ln();
    //$txt="De gedane transacties sluiten ons inziens goed aan op uw doelstellingen, uw persoonlijke situatie, uw beleggingshorizon en uw risicobereidheid.";
