...
class RapportMUT_L115
{
	function RapportMUT_L115($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
...
//		$this->pdf->Line($totaal2+2,$this->pdf->GetY(),$totaal2 + $this->pdf->widthA[7],$this->pdf->GetY());
    ...
    $totaaldebet=0;
      ...
      {
        $mutaties['gbOmschrijving']='Servicefee '.$this->pdf->portefeuilledata['DepotbankOmschrijving'];
      }
      elseif($mutaties['Grootboekrekening']=='KOST')
      {
        $mutaties['gbOmschrijving']='Transactiekosten '.$this->pdf->portefeuilledata['DepotbankOmschrijving'];
      }
