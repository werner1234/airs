...
class RapportFront_L115
{
	function RapportFront_L115($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
...
//echo $this->pdf->rapport_logo;exit;
    ...
    $this->pdf->row(array('',vertaalTekst('Verslagperiode',$this->pdf->rapport_taal),":",$rapportagePeriode));
		$this->pdf->ln();
		$this->pdf->row(array(' ',vertaalTekst('Relatienummer',$this->pdf->rapport_taal),':',$this->pdf->portefeuilledata['Portefeuille']));
    $this->pdf->ln();
