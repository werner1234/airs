...
/*
Author  						: $Author: rvv $
Laatste aanpassing	: $Date: 2013/07/04 15:40:04 $
File Versie					: $Revision: 1.4 $

$Log: RapportTemplate_L48.php,v $
...
class RapportTemplate_L48
{
	function RapportTemplate_L48($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
