...
include_once("rapport/include/layout_96/ATTberekening_L96.php");

class RapportPERF_L96
{

	function RapportPERF_L96($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
    ...
    $this->att=new ATTberekening_L96($this);
	}
...
function addResultaat()
{
  ...
  */
  ...
  $vetralingGrootboek=$this->getGrootboeken();
    ...
    $att=new ATTberekening_L96($this);
