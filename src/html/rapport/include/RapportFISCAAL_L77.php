...
/*
Author  						: $Author: rvv $
Laatste aanpassing	: $Date: 2016/09/19 11:28:56 $
File Versie					: $Revision: 1.4 $

$Log: RapportFISCAAL.php,v $

*/
include_once("rapportRekenClass.php");
include_once($__appvar["basedir"]."/html/rapport/rapportVertaal.php");

class RapportFISCAAL_L77
{
	function RapportFISCAAL_L77($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
	...
	function printSubTotaal($title, $totaalA, $totaalB, $totaalC, $totaalD, $totaalD2,$totaalE, $totaalF)
	{
	...
	function writeRapport()
	{
		...
		$this->pdf->widthB = array(2,55,18,15,28,26,5,24,24,26,5,26,26,25,15);
				  ...
				  $this->pdf->row(array("",
                        ...
                        '',
												$this->formatGetal($fiscaleWaardering,$this->pdf->rapport_VHO_decimaal),
														($fondsResultaat<0?$this->formatGetal($fondsResultaat,$this->pdf->rapport_VHO_decimaal):''),
													)
												);
