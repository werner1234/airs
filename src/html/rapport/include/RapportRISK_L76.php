...
class RapportRISK_L76
{
	function RapportRISK_L76($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
	 //
		$this->pdf = &$pdf;
...
$this->pdf->Row(array("**","Berekening van de werkelijke volatiliteit van de portefeuille op basis van de laatste 36, 24 en 12 maanden voor de aangegeven datum."));
  ...
  function printVAR()
  {
    ...
    include_once($__appvar["basedir"]."/html/rapport/include/RapportVAR_L76.php");
    include_once($__appvar["basedir"]."/html/rapport/include/RapportOIS_L76.php");

    $var=new RapportVAR_L76($this->pdf,$this->portefeuille,$this->rapportageDatumVanaf,$this->rapportageDatum);
    $var->dataOnly=true;
    $var->writeRapport();
...
//	  $this->pdf->setXY(160,190);
    ...
    $ois=new RapportOIS_L76($this->pdf,$this->portefeuille,$this->rapportageDatumVanaf,$this->rapportageDatum);
    $ois->dataOnly=true;
    $ois->writeRapport();
    $oisData=$ois->oisData;
