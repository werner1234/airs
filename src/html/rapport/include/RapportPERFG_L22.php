...
/*
    ...
    Author  						: $Author: rvv $
 		Laatste aanpassing	: $Date: 2016/08/17 16:01:13 $
 		File Versie					: $Revision: 1.26 $

 		$Log: RapportPERFG_L22.php,v $
 		Revision 1.26  2016/08/17 16:01:13  rvv
 		*** empty log message ***
 		
 		Revision 1.25  2016/04/18 06:17:46  rvv
 		*** empty log message ***
 		
 		Revision 1.24  2016/04/16 17:12:30  rvv
 		*** empty log message ***
 		
 		Revision 1.23  2016/04/10 15:48:34  rvv
 		*** empty log message ***
 		
 		Revision 1.22  2016/03/27 17:34:16  rvv
 		*** empty log message ***
 		
 		Revision 1.21  2016/01/28 08:12:43  rvv
 		*** empty log message ***
 		
 		Revision 1.20  2016/01/27 17:08:53  rvv
 		*** empty log message ***
 		
 		Revision 1.19  2016/01/25 07:43:16  rvv
 		*** empty log message ***
 		
 		Revision 1.18  2016/01/23 17:53:31  rvv
 		*** empty log message ***
 		
 		Revision 1.17  2016/01/20 17:18:02  rvv
 		*** empty log message ***
 		
 		Revision 1.16  2016/01/14 08:21:34  rvv
 		*** empty log message ***
 		
 		Revision 1.15  2016/01/13 17:13:54  rvv
 		*** empty log message ***
 		
 		Revision 1.14  2013/11/23 17:23:24  rvv
 		*** empty log message ***
 		
 		Revision 1.13  2013/11/13 15:48:56  rvv
 		*** empty log message ***
 		
 		Revision 1.12  2013/07/20 16:26:07  rvv
 		*** empty log message ***
 		
 		Revision 1.11  2013/02/17 11:00:30  rvv
 		*** empty log message ***
 		
 		Revision 1.10  2012/05/08 07:22:14  rvv
 		*** empty log message ***
 		
 		Revision 1.9  2012/05/06 12:01:49  rvv
 		*** empty log message ***
 		
 		Revision 1.8  2012/03/28 15:55:19  rvv
 		*** empty log message ***
...
class RapportPERFG_L22
{

  function RapportPERFG_L22($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
...
if($this->pdf->lastPOST['perfPstart'] == 1 || $plotData=='VAR')
{
  if($datum['id'] > 0)
  {
    if($datum['month'] <10)
...
$this->pdf->setWidths(array(26,30,28,28,28,28,28,28));
...
////
$this->pdf->setXY(30,190);
if(count($grafiekData['jaren']['datum'])>0)
  $this->VBarDiagram(190,50,$grafiekData['jaren'],'',$color);
}
else
{
