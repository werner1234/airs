...
/*
Author  						: $Author: rvv $
Laatste aanpassing	: $Date: 2012/07/08 07:03:49 $
File Versie					: $Revision: 1.6 $

$Log: RapportATT_L37.php,v $
Revision 1.6  2012/07/08 07:03:49  rvv
*** empty log message ***

Revision 1.5  2012/07/04 16:05:11  rvv
*** empty log message ***
...
class RapportATT_L37
{

	function RapportATT_L37($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		global $__appvar;
  ...
  function createRows()
  {
    ...
    foreach ($this->categorien as $categorie=>$omschrijving)
    {
      ...
      if($categorie=='totaal')
      {
        ...
        $this->waarden['rapportagePeriode'][$categorie]['onttrekking']=getOnttrekkingen($this->portefeuille,$this->rapportageDatumVanaf,$this->rapportageDatum)*-1;
...
$this->pdf->hcatData['lopendeJaar']=$hcatData;
    ...
    $this->pdf->widthC = array(1,95,42,5,42,5,42,5,42,5,42,5,42,5,42,5);
