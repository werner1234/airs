...
/*
Author  						: $Author: rvv $
Laatste aanpassing	: $Date: 2016/09/25 18:53:45 $
File Versie					: $Revision: 1.1 $

$Log: RapportHSE_L22.php,v $
...
class RapportHSE_L22
{
	function RapportHSE_L22($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
        ...
        $totaalDividendCorrected =0;
			...
			if($categorien['valuta'] == $this->pdf->rapportageValuta)
			  ...
			  $beginQuery = $this->pdf->ValutaKoersBegin;
				...
				$this->printKop($categorien['beleggingssectorOmschrijving']." in ".$categorien['valuta'], "");
