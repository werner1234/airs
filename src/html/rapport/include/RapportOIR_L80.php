...
/*
Author  						: $Author: rvv $
Laatste aanpassing	: $Date: 2020/03/15 10:25:30 $
File Versie					: $Revision: 1.2 $

$Log: RapportOIR_L80.php,v $
Revision 1.2  2020/03/15 10:25:30  rvv
*** empty log message ***

Revision 1.1  2018/12/29 13:57:07  rvv
*** empty log message ***
...
class RapportOIR_L80
{
	function RapportOIR_L80($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
    $this->oiv=new RapportOIV_L80($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum);
		...
		$this->pdf->rapport_titel = "Onderverdeling naar regio";

   
    $this->oiv->verdeling1='Regio';
