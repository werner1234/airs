...
include_once("rapport/include/layout_94/ATTberekening_L94.php");

class RapportPERF_L94
{

	function RapportPERF_L94($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
    ...
    $this->att=new ATTberekening_L94($this);
	}
...
function addResultaat()
{
  ...
  */
  ...
  $vetralingGrootboek=$this->getGrootboeken();
    ...
    $att=new ATTberekening_L94($this);
