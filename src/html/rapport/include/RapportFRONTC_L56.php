...
/*
Author  						: $Author: rvv $
Laatste aanpassing	: $Date: 2018/07/18 15:46:07 $
File Versie					: $Revision: 1.3 $

$Log: RapportFRONTC_L56.php,v $
...
class RapportFrontC_L56
{
	function RapportFrontC_L56($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
