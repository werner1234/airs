...
/*
Author  						: $Author: rvv $
Laatste aanpassing	: $Date: 2013/06/26 15:55:41 $
File Versie					: $Revision: 1.3 $

$Log: RapportATT_L48.php,v $
...
class RapportATT_L48
{
	function RapportATT_L48($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
