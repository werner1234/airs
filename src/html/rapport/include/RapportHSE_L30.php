...
/*
Author  						: $Author: rvv $
Laatste aanpassing	: $Date: 2015/01/31 20:02:46 $
File Versie					: $Revision: 1.1 $

$Log: RapportHSE_L30.php,v $
Revision 1.1  2015/01/31 20:02:46  rvv
*** empty log message ***
...
class RapportHSE_L30
{
	function RapportHSE_L30($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum, $valuta = 'EUR')
	{
		$this->pdf = &$pdf;
				...
				if($this->pdf->rapport_HSE_volgorde_beginwaarde == 1)
				{
					if($this->pdf->rapport_layout == 4)
					{
						$this->pdf->row(array("",
													...
													"",
													$this->formatGetalKoers($subdata[beginwaardeLopendeJaar],2),
													"",
					...
					else if($this->pdf->rapport_layout == 10)
					{
						$this->pdf->row(array("",
													"",
													$this->formatGetal($subdata[totaalAantal],0),
				  ...
				  if($this->pdf->rapport_layout == 8)
					{
					  ...
					  // 2006-08-18, cvs, Attica layout 8 aantal met 4 decimalen, was 0
					  $this->pdf->row(array("",
													"",
													$this->formatGetal($subdata[totaalAantal],4),
													$this->formatGetal($subdata[actueleFonds],2),
													$this->formatGetal($subdata[actuelePortefeuilleWaardeInValuta],$this->pdf->rapport_decimaal),
													$this->formatGetalKoers($subdata[actuelePortefeuilleWaardeEuro],$this->pdf->rapport_decimaal),
													"",
