...
$Log: RapportMODEL_L66.php,v $
Revision 1.8  2020/05/02 15:57:50  rvv
*** empty log message ***

Revision 1.7  2020/03/11 16:21:41  rvv
*** empty log message ***

Revision 1.6  2018/04/21 17:56:04  rvv
*** empty log message ***

Revision 1.5  2017/02/16 11:33:43  rvv
*** empty log message ***

Revision 1.4  2017/02/16 06:35:33  rvv
*** empty log message ***

Revision 1.3  2017/02/15 17:07:28  rvv
*** empty log message ***
...
Revision 1.17  2015/11/11 17:21:56  rvv
*** empty log message ***

Revision 1.16  2015/10/07 19:38:13  rvv
*** empty log message ***

Revision 1.15  2014/12/21 10:32:26  rvv
*** empty log message ***

Revision 1.14  2014/10/22 15:48:54  rvv
*** empty log message ***

Revision 1.13  2014/09/27 16:04:29  rvv
*** empty log message ***
...
class RapportModel_L66
{
	...
	*/
	...
	function RapportModel_L66($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
	  $this->pdf = &$pdf;
		$this->selectData =
            ...
            $aankoopStuks=ceil($aankoopStuks/100)*100;
				...
				if($aankoopStuks < 0)
				{
					if(round($fdata['percentageModel'],1)==0)
						$verkoopStuks=$fdata['totaalAantal']*-1;
					else
					  $verkoopStuks = $aankoopStuks;
					$aankoopStuks = 0;
				}
