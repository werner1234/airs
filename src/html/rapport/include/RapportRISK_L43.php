...
/*
Author  						: $Author: rvv $
Laatste aanpassing	: $Date: 2017/01/21 17:48:04 $
File Versie					: $Revision: 1.3 $

$Log: RapportRISK_L43.php,v $
Revision 1.3  2017/01/21 17:48:04  rvv
*** empty log message ***
...
class RapportRISK_L43
{

	function RapportRISK_L43($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
		$this->pdf->rapport_type = "PERF";
		$this->pdf->rapport_datum = db2jul($rapportageDatum);
		$this->pdf->rapport_datumvanaf = db2jul($rapportageDatumVanaf);
		$this->pdf->rapport_titel = "Rendement en risico-kenmerken";
...
function addPerfGrafiek($stdev)
{
    ...
    $indexKleur=array(69,87,133);//=array(87,165,25);
    $perfGrafiek['titel']='Portefeuille rendement';
    $this->LineDiagram(120, 50, $perfGrafiek,array($portKleur,$indexKleur),0,0,6,5);//50
...
function addStdevGrafieken($stdev)
{
    ...
    $this->pdf->setXY(20,54);
    
    $portKleur=array($this->pdf->rapport_kop_fontcolor['r'],$this->pdf->rapport_kop_fontcolor['g'],$this->pdf->rapport_kop_fontcolor['b']);
    $indexKleur=array(69,87,133);//array(87,165,25);
    $this->LineDiagram(120, 50, $grafiekData['totaal'],array($portKleur,$indexKleur),0,0,6,5,1);//50
    $this->pdf->setXY(160,54);
    $this->LineDiagram(120, 50, $grafiekData['afm'],array($portKleur,$indexKleur),0,0,6,5,1);//50
