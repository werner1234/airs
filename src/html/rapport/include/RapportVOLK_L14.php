...
/*
    ...
    Author  						: $Author: rvv $
 		Laatste aanpassing	: $Date: 2011/07/08 08:06:43 $
 		File Versie					: $Revision: 1.7 $

 		$Log: RapportVOLK_L14.php,v $
...
class RapportVOLK_L14
{
	function RapportVOLK_L14($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
	...
	function printSubTotaal($title, $totaalA, $totaalB, $totaalC, $totaalD, $totaalE, $totaalF, $TotaalG = 0, $totaalH = 0)
	{
		...
		$this->printCol(1,$title,"tekst");
			...
			if($totaalF <>0)
				$this->printCol(14,$this->formatGetal($totaalF,$this->pdf->rapport_VOLK_decimaal_proc),"subtotaal",8);
			if($totaalG <>0)
...
//echo $subquery."<br><br>";exit;
       ...
       $fondsResultaat  +=	$valutaResultaat;
