...
$Log: RapportFRONT_L65.php,v $
Revision 1.4  2018/10/20 18:05:20  rvv
*** empty log message ***

Revision 1.3  2017/06/10 18:08:40  rvv
*** empty log message ***
...
class RapportFront_L65
{
	function RapportFront_L65($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
   ...
   //background
    ...
    {
      $logopos=$this->pdf->marge+30;
      $this->pdf->Image($this->pdf->rapport_logo, $logopos, 3+$yOffset, 100);
    }
    ...
    $this->pdf->row(array('',vertaalTekst('Verslagperiode',$this->pdf->rapport_taal),":",$rapportagePeriode));
		$this->pdf->ln();
		$this->pdf->row(array(' ',vertaalTekst('Rekeningnr.',$this->pdf->rapport_taal),':',formatPortefeuille($portefeuilledata['Portefeuille'])));
    $this->pdf->ln();
