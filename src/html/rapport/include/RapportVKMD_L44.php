...
include_once($__appvar["basedir"]."/html/rapport/include/RapportVKMS_L44.php");

class RapportVKMD_L44
{

	function RapportVKMD_L44($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->vkm=new RapportVKMS_L44($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum);
	}
