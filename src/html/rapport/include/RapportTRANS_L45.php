...
Revision 1.9  2013/07/31 15:45:41  rvv
*** empty log message ***

Revision 1.8  2013/06/26 15:55:41  rvv
*** empty log message ***

Revision 1.7  2013/05/29 11:46:50  rvv
*** empty log message ***

Revision 1.6  2013/05/12 11:19:21  rvv
*** empty log message ***

Revision 1.5  2013/05/01 15:53:08  rvv
*** empty log message ***
...
Revision 1.1  2013/04/10 15:58:01  rvv
*** empty log message ***
...
class RapportTRANS_L45
{
	function RapportTRANS_L45($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
	...
	function writeRapport()
	{
	  ...
	  if ($this->pdf->rapportageValuta != "EUR" || $this->pdf->rapportageValuta != '')
	   $koersQuery =	" / (SELECT Koers FROM Valutakoersen WHERE Valuta='".$this->pdf->rapportageValuta."' AND Datum <= Rekeningmutaties.Boekdatum ORDER BY Datum DESC LIMIT 1 ) ";
		...
		// voor data
    $w=297-($this->pdf->marge*2);
   // echo ($w-15-15-22-40)/7;exit;
		$this->pdf->widthB = array(15,15,70,25,26,26,26,26,26,26,25,25,25,1);
		$this->pdf->alignB = array('L','L','L','R','R','R','R','R','R','R','R','R','R','R');
		// voor kopjes
...
//	echo "lopende -> ".$resultaatlopende." <-  voorgaande ".$resultaatvoorgaande. " -  <br>" ;
        ...
        if($aankoop_waarde=='')
          $aankoop_waarde= $result_historischkostprijs; 
       
       $resultaat=$resultaatlopende+$resultaatvoorgaande;
       if($resultaat <> 0)
         $resultaatTxt=$this->formatGetal($resultaat,0);
       else
         $resultaatTxt='';  
            ...
            //listarray($this->pdf->widths);
		      ...
		      else
		      {
				...
				$this->pdf->row(array($datum,
                      ...
                      rclip($mutaties['Omschrijving'],33),
...
/*
		...
		$this->pdf->row(array("",
								...
								"",
								"",
								$this->formatGetal($totaalResultaat,$this->pdf->rapport_TRANS_decimaal)));
