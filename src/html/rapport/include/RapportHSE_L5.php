...
/*
Author  						: $Author: rvv $
Laatste aanpassing	: $Date: 2014/12/13 19:24:44 $
File Versie					: $Revision: 1.1 $

$Log: RapportHSE_L5.php,v $
...
class RapportHSE_L5
{
	function RapportHSE_L5($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum, $valuta = 'EUR')
	{
		$this->pdf = &$pdf;
