...
class RapportTemplate_L95
{
	function RapportTemplate_L95($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
	  global $__appvar;
		$this->pdf = &$pdf;
    ...
    $totPagina = ($lastpage-$startpagina+$paginaCorrectie);//-1
       ...
       $this->pdf->ln(10);
        ...
        {
          if(isset($inhoudsItems[$key]) || isset($this->pdf->templateVarsOmschrijving[$key])) //
          {
            if(isset($this->pdf->templateVarsOmschrijving[$key][$key]))
