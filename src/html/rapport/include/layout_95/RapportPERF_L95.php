...
include_once("rapport/include/layout_95/ATTberekening_L95.php");

class RapportPERF_L95
{

	function RapportPERF_L95($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
    ...
    $this->att=new ATTberekening_L95($this);
	}
...
function addResultaat()
{
  ...
  */
  ...
  $vetralingGrootboek=$this->getGrootboeken();
    ...
    $att=new ATTberekening_L95($this);
