...
class RapportHSE_L95
{
	function RapportHSE_L95($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum, $valuta = 'EUR')
	{
		$this->pdf = &$pdf;
    ...
    $totaalactueel=0;
		while($categorien = $DB->NextRecord())
		{
		  ...
		  // $this->printKop(vertaalTekst($this->pdf->rapport_valuta_voorzet,$this->pdf->rapport_taal)." ".$categorien['valuta'], $this->pdf->rapport_kop4_fontstyle);
			...
			$subquery = "SELECT TijdelijkeRapportage.fondsOmschrijving,TijdelijkeRapportage.type, ".
...
*/
    ...
    printRendement_L95($this->pdf,$this->portefeuille, $this->rapportageDatum, $this->rapportageDatumVanaf,false,$this->pdf->rapportageValuta);
    $this->pdf->SetTextColor($this->pdf->rapport_fonds_fontcolor['r'],$this->pdf->rapport_fonds_fontcolor['g'],$this->pdf->rapport_fonds_fontcolor['b']);
