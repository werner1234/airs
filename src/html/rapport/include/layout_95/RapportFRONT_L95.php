...
class RapportFront_L95
{
	function RapportFront_L95($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
    ...
    $this->pdf->AddPage('L');
		...
		{
		  $logopos=($this->pdf->w)/2-($this->pdf->logoXsize*2)/2;
	    $this->pdf->Image($this->pdf->rapport_logo, $logopos, $this->pdf->marge, $this->pdf->logoXsize*2);
		}
