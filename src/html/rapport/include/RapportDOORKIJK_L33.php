...
class RapportDOORKIJK_L33
{
	function RapportDOORKIJK_L33($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = $pdf;
	...
	function vulPagina($belCategorien='')
	{
      ...
      $doorKijk['details']=$newDetail;
			...
			if($grafiekTonen==true)
			  $this->printPie( $grafiekdata,30+$xOffset,135,$doorkijkTitels[$doorkijkCategorieSoort]); //+$yOffset);
			$pieTeller++;
		}
