...
/*
Author  						: $Author: rvv $
Laatste aanpassing	: $Date: 2016/11/13 16:27:53 $
File Versie					: $Revision: 1.4 $

$Log: RapportVOLKD_L19.php,v $
Revision 1.4  2016/11/13 16:27:53  rvv
*** empty log message ***
...
class RapportVOLKD_L19
{
	function RapportVOLKD_L19($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
	...
	function writeRapport()
	{
   	...
   	$this->pdf->SetTextColor($this->pdf->rapport_default_fontcolor[r],$this->pdf->rapport_default_fontcolor[g],$this->pdf->rapport_default_fontcolor[b]);
		...
		unset($this->pdf->CellBorders);
		 ...
		 $att=new ATTberekening_L34();
     $waarden=$att->berekenPortefeuilleWaarde($this->portefeuille, $this->rapportageDatum,false,'EUR',$this->rapportageDatumVanaf);
