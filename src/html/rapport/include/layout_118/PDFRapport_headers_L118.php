<?php
function Header_basis_L118($object)
{
 $pdfObject = &$object;
    ...
    {  
      ...
      $pdfObject->MultiCell(40,4, $pdfObject->portefeuilledata['Naam'],0,'L');
      if ( ! empty($pdfObject->portefeuilledata['Naam1'])) {
        $pdfObject->MultiCell(40, 4, $pdfObject->portefeuilledata['Naam1'], 0, 'L');
      }
      $pdfObject->MultiCell(40,4, $pdfObject->portefeuilledata['Portefeuille'],0,'L');
	...
	function HeaderVKM_L118($object)
	{
		$pdfObject = &$object;
		$pdfObject->HeaderVKM();
	}
	
	  function HeaderFRONT_L118($object)
	  {
	    $pdfObject = &$object;
	    //$pdfObject->headerSCENARIO();

	  }
	  function HeaderSCENARIO_L118($object)
	  {
	    $pdfObject = &$object;
	    //$pdfObject->headerSCENARIO();
    ...
    function HeaderRISK_L118($object)
    {
	    $pdfObject = &$object;
			$pdfObject->Ln();
    ...
    function HeaderGRAFIEK_L118($object)
    {
	    $pdfObject = &$object;
    }

    function HeaderEND_L118($object)
    {
     	$pdfObject = &$object;
			$pdfObject->Ln();
			$pdfObject->SetFillColor($pdfObject->rapport_kop_bgcolor['r'],$pdfObject->rapport_kop_bgcolor['g'],$pdfObject->rapport_kop_bgcolor['b']);
    ...
    function HeaderPERFD_L118($object)
    {
      $pdfObject = &$object;
      HeaderPERF_L118($object);
      $pdfObject->SetTextColor($pdfObject->rapport_fontcolor['r'],$pdfObject->rapport_fontcolor['g'],$pdfObject->rapport_fontcolor['b']);
    }
  
    
    function HeaderTRANS_L118($object)
	  {
	    $pdfObject = &$object;
    ...
    function HeaderMUT_L118($object)
	  {
	    $pdfObject = &$object;
   		$pdfObject->SetFont($pdfObject->rapport_font,$pdfObject->rapport_kop_fontstyle,$pdfObject->rapport_fontsize);
  	  $pdfObject->SetX(100);
	  ...
	  function HeaderAFM_L118($object)
	  {
	    $pdfObject = &$object;
...
$pdfObject->ln(2);
	  ...
	  function HeaderINHOUD_L118($object)
	  {
	    $pdfObject = &$object;
	    //$pdfObject->headerSCENARIO();

	  }	  
 	  function HeaderPERF_L118($object)
	  {
	    $pdfObject = &$object;
      $pdfObject->ln();
      $pdfObject->SetFillColor($pdfObject->rapport_kop_bgcolor['r'],$pdfObject->rapport_kop_bgcolor['g'],$pdfObject->rapport_kop_bgcolor['b']);
...
$pdfObject->ln();
    ...
    function HeaderINDEX_L118($object)
	  {
	    $pdfObject = &$object;
	  }
    function HeaderOIB_L118($object)
	  {
	    $pdfObject = &$object;
      $pdfObject->Ln();
      		$pdfObject->SetFillColor($pdfObject->rapport_kop_bgcolor['r'],$pdfObject->rapport_kop_bgcolor['g'],$pdfObject->rapport_kop_bgcolor['b']);
  ...
  function HeaderATT_L118($object)
	{
    $pdfObject = &$object;
...
*/
   ...
   function HeaderPERFG_L118($object)
	{
    $pdfObject = &$object;
...
*/
  ...
  function HeaderVOLK_L118($object)
	{
    $pdfObject = &$object;
   	$pdfObject->ln();
		$pdfObject->SetFont($pdfObject->rapport_font,$pdfObject->rapport_kop_fontstyle,$pdfObject->rapport_fontsize);
...
function HeaderVHO_L118($object)
	{
    $pdfObject = &$object;
   	$pdfObject->ln();
		$pdfObject->SetFont($pdfObject->rapport_font,$pdfObject->rapport_kop_fontstyle,$pdfObject->rapport_fontsize);
