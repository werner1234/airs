...
class RapportFront_L118
{
	function RapportFront_L118($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
   ...
   //background
    ...
    $tekst = 'Hierbij ontvangt u de kwartaalrapportage van uw beleggingsportefeuille. De rapportage is met zorg voor u samengesteld en is een weergave van de waardeontwikkeling van uw beleggingen bij Yield.inc. Mocht u vragen hebben over de inhoud dan kunt u contact met ons opnemen via de Yield.inc app, per e-mail via info@yieldinc.com of telefonisch via 088-1037 700.

Yield.inc B.V. | www.yieldinc.com | koninginnegracht 19 | 2514 AB  Den Haag';
    $this->pdf->MultiCell(290,4,$tekst,0,'L');
