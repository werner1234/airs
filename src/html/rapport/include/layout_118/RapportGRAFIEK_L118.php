...
class RapportGRAFIEK_L118
{
	function RapportGRAFIEK_L118($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
...
$this->pdf->Pie3D($grafiekData['OIV']['Percentage'],$grafiekData['OIV']['Kleur'],$Xas,$yas+80,$diameter,$hoek,$dikte,"Valutaverdeling");
