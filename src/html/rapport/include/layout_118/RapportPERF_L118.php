...
include_once("rapport/include/layout_118/ATTberekening_L118.php");

class RapportPERF_L118
{

	function RapportPERF_L118($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
    ...
    $this->att=new ATTberekening_L118($this);
	}
...
function addResultaat()
{
  ...
  $vetralingGrootboek=$this->getGrootboeken();
    ...
    $att=new ATTberekening_L118($this);
