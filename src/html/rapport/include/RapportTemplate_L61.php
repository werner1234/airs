...
/*
Author  						: $Author: rvv $
Laatste aanpassing	: $Date: 2016/11/02 16:34:11 $
File Versie					: $Revision: 1.2 $

$Log: RapportTemplate_L61.php,v $
Revision 1.2  2016/11/02 16:34:11  rvv
*** empty log message ***
...
class RapportTemplate_L61
{
	function RapportTemplate_L61($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
	  global $__appvar;
		$this->pdf = &$pdf;
    ...
    $totPagina = ($lastpage-$startpagina+$paginaCorrectie);//-1
       ...
       //$this->pdf->SetFont($pdfObject->rapport_font,'',$this->pdf->rapport_fontsize+8);
	     ...
	     $this->pdf->SetWidths(array(20,220,10));
       $this->pdf->ln(10);
