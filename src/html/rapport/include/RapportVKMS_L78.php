...
Revision 1.2  2018/06/24 11:13:16  rvv
*** empty log message ***

Revision 1.1  2018/06/20 16:40:16  rvv
*** empty log message ***
...
class RapportVKMS_L78
{
	function RapportVKMS_L78($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		if(is_object($pdf))
		{
			$this->pdf = &$pdf;
...
ORDER BY Grootboekrekeningen.Afdrukvolgorde";
		...
		if($this->pdfVullen==true)
		{
			...
			$this->pdf->row(array('Doorlopende kosten','',''));
			$this->pdf->SetFont($this->pdf->rapport_font, '', $this->pdf->rapport_fontsize);
...
" $rekeningFondsenWhere ";
	...
	function writeRapport()
	{
      ...
      $this->pdf->templateVarsOmschrijving['VKMDPaginas']=$this->pdf->rapport_titel;
