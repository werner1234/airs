...
/*
    ...
    Author  						: $Author: rvv $
 		Laatste aanpassing	: $Date: 2016/08/27 16:26:45 $
 		File Versie					: $Revision: 1.2 $

 		$Log: RapportCASHY_L51.php,v $
...
class RapportCASHY_L51
{
	function RapportCASHY_L51($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
	 //
		$this->pdf = &$pdf;
...
$this->pdf->CellBorders = array();
	...
	function VBarDiagram($w, $h, $data,$titel)
  {
      ...
      $colors=array('rente'=>array($this->pdf->rapport_kop_fontcolor[r],$this->pdf->rapport_kop_fontcolor[g],$this->pdf->rapport_kop_fontcolor[b]), 
      'lossing'=>array(230,230,230));
