...
/*
Author  						: $Author: rvv $
Laatste aanpassing	: $Date: 2016/02/20 15:18:29 $
File Versie					: $Revision: 1.6 $

$Log: RapportKERNZ_L22.php,v $
...
class RapportKERNZ_L22
{

	function RapportKERNZ_L22($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
