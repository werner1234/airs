...
/*
    ...
    Author  						: $Author: rvv $
 		...
 		$Log: ATTberekening_L60.php,v $
 		Revision 1.8  2017/07/08 17:17:33  rvv
 		*** empty log message ***
 		
 		Revision 1.7  2017/06/14 16:11:15  rvv
 		*** empty log message ***
 		
 		Revision 1.6  2017/06/07 16:28:08  rvv
 		*** empty log message ***
 		
 		Revision 1.5  2017/05/26 16:45:07  rvv
 		*** empty log message ***
 		
 		Revision 1.4  2016/03/20 14:32:23  rvv
 		*** empty log message ***
 ...
 */
class rapportHulp_L60
{
  function rapportHulp_L60()
  {
    $this->test='';
  }
}

class ATTberekening_L60
{

	function ATTberekening_L60($rapportData)
	{
  ...
  {
    $this->rapport = new rapportHulp_L60();
    $db=new DB();
