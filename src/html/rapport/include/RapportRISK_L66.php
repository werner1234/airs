...
class RapportRISK_L66
{

	function RapportRISK_L66($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
...
WHERE Portefeuilles.Portefeuille = '$this->portefeuille'";
    ...
    $this->pdf->Rect($this->pdf->marge+10,130,120,count($benchmarks)*4+4);
