...
/*
Author  						: $Author: rvv $
Laatste aanpassing	: $Date: 2019/05/04 18:44:05 $
File Versie					: $Revision: 1.1 $

$Log: RapportVKMS_L61.php,v $
Revision 1.1  2019/05/04 18:44:05  rvv
*** empty log message ***
...
class RapportVKMS_L61
{
	function RapportVKMS_L61($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		if(is_object($pdf))
		{
			$this->pdf = &$pdf;
