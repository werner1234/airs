    ...
    foreach ($this->pdf->grafiekData['Hoofdcategorie']['grafiek'] as $omschrijving=>$waarde)
    {
      ...
      $grafiekData['OIH']['Percentage'][]=$waarde;
		...
		//	$onderY = 80;
			...
			$this->pdf->Pie3D($grafiekData['OIH']['Percentage'], $this->pdf->grafiekData['Hoofdcategorie']['grafiekKleur'], $Xas + $xRechts, $yas, $diameter, $hoek, $dikte, "Verdeling over categorieën", 'titel');
