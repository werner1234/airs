...
$Log: RapportMUT_L71.php,v $
Revision 1.3  2020/03/18 17:44:11  rvv
*** empty log message ***
...
class RapportMUT_L71
{
	function RapportMUT_L71($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
