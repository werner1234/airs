...
/*
    ...
    Author  						: $Author: rvv $
 		...
 		$Log: RapportATT_L19.php,v $
 		Revision 1.2  2018/08/18 12:40:14  rvv
 		php 5.6 & consolidatie
 		
 		Revision 1.1  2015/10/11 16:51:46  rvv
 		*** empty log message ***
...
class RapportATT_L19
{
	function RapportATT_L19($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
