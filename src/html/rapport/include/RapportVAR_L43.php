...
/*
Author  						: $Author: rvv $
Laatste aanpassing	: $Date: 2017/05/27 09:45:52 $
File Versie					: $Revision: 1.3 $

$Log: RapportVAR_L43.php,v $
Revision 1.3  2017/05/27 09:45:52  rvv
*** empty log message ***
...
class RapportVAR_L43
{
	function RapportVAR_L43($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
