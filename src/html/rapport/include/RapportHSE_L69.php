...
/*
Author  						: $Author: rvv $
Laatste aanpassing	: $Date: 2016/12/04 10:08:56 $
File Versie					: $Revision: 1.2 $

$Log: RapportHSE_L69.php,v $
...
class RapportHSE_L69
{
	function RapportHSE_L69($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
