...
/*
    ...
    Author  						: $Author: rvv $
 		...
 		$Log: RapportTRANS_L13.php,v $
 		Revision 1.6  2020/06/06 15:48:23  rvv
 		*** empty log message ***
 		...
 		*** empty log message ***
 		...
 		Revision 1.3  2010/12/08 18:29:07  rvv
 		*** empty log message ***
...
class RapportTRANS_L13
{
	function RapportTRANS_L13($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
...
*/
	  ...
	  if ($this->pdf->rapportageValuta != "EUR" || $this->pdf->rapportageValuta != '')
	   $koersQuery =	" / (SELECT Koers FROM Valutakoersen WHERE Valuta='".$this->pdf->rapportageValuta."' AND Datum <= Rekeningmutaties.Boekdatum ORDER BY Datum DESC LIMIT 1 ) ";
		...
		// voor data
		if($this->pdf->lastPOST['TRANS_RESULT'])
		{
		...
		{
		  $this->pdf->widthA = array(15,15,20,70,25,25,25,25,25,25);
		  $this->pdf->alignA = array('L','L','R','L','R','R','R','R','R','R','R','R','R','R');
