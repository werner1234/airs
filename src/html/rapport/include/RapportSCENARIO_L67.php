...
/*
Author  						: $Author: rvv $
Laatste aanpassing	: $Date: 2017/09/13 15:45:00 $
File Versie					: $Revision: 1.1 $

$Log: RapportSCENARIO_L67.php,v $
Revision 1.1  2017/09/13 15:45:00  rvv
*** empty log message ***
...
class RapportSCENARIO_L67
{
	function RapportSCENARIO_L67($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
...
//    {
      ...
      $this->pdf->widthA = array(25,30);
		  $this->pdf->widthB = array(50,25,25,25,25);
...
//
    ...
    $this->pdf->SetFont($this->pdf->rapport_font,'b',$this->pdf->rapport_fontsize);
    $this->pdf->setY(170);
    $this->pdf->widthB = array(40,30,20);
    ...
    $this->pdf->SetFont($this->pdf->rapport_font,'b',$this->pdf->rapport_fontsize);
    $this->pdf->Cell(120,0,vertaalTekst('Scenario-analyse',$this->pdf->rapport_taal),0,0,'C');
    $this->pdf->setXY(20,100);
    if($this->pdf->lastPOST['scenario_werkelijkVerloop']==1)
    {
      ...
      $this->LineDiagram(120,50,$sc->scenarioGemiddelde,'',$sc->CRMdata['doelvermogen']);
    ...
    $this->pdf->setY(70);
		$this->pdf->widthB = array(5,55,30,30);
		$this->pdf->alignB = array('L','L','R','R');
    $this->pdf->SetWidths($this->pdf->widthB);
    $this->pdf->SetAligns($this->pdf->alignB);
    $this->pdf->SetFont($this->pdf->rapport_font,'b',$this->pdf->rapport_fontsize);
