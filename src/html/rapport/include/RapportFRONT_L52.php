...
/*
Author  						: $Author: rvv $
Laatste aanpassing	: $Date: 2019/04/08 06:05:33 $
File Versie					: $Revision: 1.2 $

$Log: RapportFRONT_L52.php,v $
...
class RapportFront_L52
{
	function RapportFront_L52($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
