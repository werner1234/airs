...
$Log: RapportFISCAAL_L42.php,v $
Revision 1.2  2017/08/12 12:17:24  rvv
*** empty log message ***

Revision 1.1  2017/07/29 17:18:20  rvv
*** empty log message ***
...
class RapportFISCAAL_L42
{
	function RapportFISCAAL_L42($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
	...
	function writeRapport()
	{
		...
		$this->pdf->widthB = array(10,50,18,15,28,28,10,24,24,28,15,28,15,22,15);
    ...
    $this->pdf->templateVars['FISCAALPaginas']=$this->pdf->page;
		...
		$query = "SELECT
		     ...
		     TijdelijkeRapportage.beleggingssector, TijdelijkeRapportage.beleggingssectorOmschrijving,
		     TijdelijkeRapportage.BeleggingscategorieOmschrijving as Omschrijving, TijdelijkeRapportage.valuta, ".
    ...
    $fiscaleWaardeEffecten=0;
        ...
        $totaalfiscaleWaardering=0;
			...
			// subkop (valuta)
				...
				$tekst = vertaalTekst("Waarden",$this->pdf->rapport_taal)." ".$categorien['beleggingssectorOmschrijving'];
				$this->printKop($tekst, "");
			...
			.$__appvar['TijdelijkeRapportageMaakUniek'].
			" ORDER BY TijdelijkeRapportage.hoofdsectorVolgorde,
TijdelijkeRapportage.beleggingscategorieVolgorde,
TijdelijkeRapportage.beleggingssectorVolgorde,
TijdelijkeRapportage.fondsOmschrijving";
