...
$Log: RapportTemplate_L78.php,v $
Revision 1.2  2018/10/13 17:18:13  rvv
*** empty log message ***
...
class RapportTemplate_L78
{
	function RapportTemplate_L78($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
	  global $__appvar;
		$this->pdf = &$pdf;
    ...
    $totPagina = ($lastpage-$startpagina+$paginaCorrectie);//-1
       ...
       $this->pdf->ln(10);
	     ...
	     $inhoudsItems=array('PERFPaginas'=>'Performancemeting over de categorieën',
