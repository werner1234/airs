...
/*
    ...
    Author  						: $Author: rvv $
 		...
 		*** empty log message ***
 		...
 		Revision 1.1  2014/05/14 15:28:41  rvv
 		*** empty log message ***

 		Revision 1.2  2013/10/26 15:42:47  rvv
 		*** empty log message ***
...
class ATTberekening_L18
{

	function ATTberekening_L18($rapportData)
	{
...
if($stapeling == true)
{
 ...
 $query = "SELECT  Grootboekrekeningen.Opbrengst,Grootboekrekeningen.Kosten, Grootboekrekeningen.Grootboekrekening,".
  ...
  {
    $perioden[]=array('start'=>date('Y-m-d',$julBegin),'stop'=>date('Y-m-d',$julEind));
    return $perioden;
