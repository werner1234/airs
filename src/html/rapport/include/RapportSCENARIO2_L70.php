...
$Log: RapportSCENARIO2_L70.php,v $
Revision 1.8  2019/12/01 07:51:04  rvv
*** empty log message ***

Revision 1.7  2019/03/07 20:03:33  rvv
*** empty log message ***

Revision 1.6  2019/01/19 18:05:31  rvv
*** empty log message ***

Revision 1.5  2018/11/24 19:11:26  rvv
*** empty log message ***

Revision 1.4  2018/11/10 18:20:33  rvv
*** empty log message ***
...
Revision 1.3  2016/07/02 09:36:54  rvv
*** empty log message ***
...
class RapportSCENARIO2_L70
{
  function RapportSCENARIO2_L70($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
  {
    $this->pdf = &$pdf;
  ...
  function formatGetalKoers($waarde, $dec=0 , $start = false)
  {
    if ($start == false)
  ...
  function writeRapport()
  {
    ...
    $this->pdf->AddPage('P');
    $this->pdf->templateVars['SCENARIO2Paginas']=$this->pdf->page;
    $this->pdf->templateVarsOmschrijving['SCENARIO2Paginas'] = $this->pdf->rapport_titel;
    $this->pdf->setY(50);
...
//
    ...
    */
    ...
    $this->pdf->setY(110);
    $this->pdf->widthB = array(5,35,30,40);
    $this->pdf->alignB = array('L','L','R','R');
    $this->pdf->SetWidths($this->pdf->widthB);
    $this->pdf->SetAligns($this->pdf->alignB);
    $this->pdf->SetFont($this->pdf->rapport_font,'b',$this->pdf->rapport_fontsize);
