...
/*
Author  						: $Author: rvv $
Laatste aanpassing	: $Date: 2018/01/31 17:21:26 $
File Versie					: $Revision: 1.16 $

$Log: RapportRISK_L61.php,v $
Revision 1.16  2018/01/31 17:21:26  rvv
*** empty log message ***

Revision 1.15  2017/08/30 15:03:56  rvv
*** empty log message ***

Revision 1.14  2017/08/07 05:38:59  rvv
*** empty log message ***

Revision 1.13  2017/08/02 18:23:27  rvv
*** empty log message ***

Revision 1.12  2017/07/30 10:19:36  rvv
*** empty log message ***

Revision 1.11  2017/04/26 15:19:25  rvv
*** empty log message ***

Revision 1.10  2017/04/19 15:39:24  rvv
*** empty log message ***

Revision 1.9  2016/11/13 10:11:20  rvv
*** empty log message ***

Revision 1.8  2016/10/30 13:02:59  rvv
*** empty log message ***

Revision 1.7  2016/10/24 06:35:13  rvv
*** empty log message ***

Revision 1.6  2016/10/23 11:32:33  rvv
*** empty log message ***

Revision 1.5  2016/05/25 14:15:31  rvv
*** empty log message ***

Revision 1.4  2016/03/19 16:51:09  rvv
*** empty log message ***

Revision 1.3  2015/12/31 09:20:18  rvv
*** empty log message ***

Revision 1.2  2015/12/30 19:52:52  rvv
*** empty log message ***
...
class RapportRISK_L61
{

	function RapportRISK_L61($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
    ...
    $data=$DB->nextRecord();
    if($data['aantal'] > 0)
      $gebruikHistorischePortefeuilleIndex=2;
    else
