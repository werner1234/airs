...
$Log: RapportTRANS_L58.php,v $
Revision 1.4  2019/06/21 14:52:45  rm
7880
...
class RapportTRANS_L58
{
	function RapportTRANS_L58($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
...
ORDER BY BeleggingscategoriePerFonds.Beleggingscategorie, Rekeningmutaties.Boekdatum, Rekeningmutaties.Fonds";
		$DB = new DB();
		$DB->SQL($query); 
		$DB->Query();
