...
/*
Author  						: $Author: rvv $
Laatste aanpassing	: $Date: 2015/09/05 16:48:05 $
File Versie					: $Revision: 1.1 $

$Log: RapportTemplate_L62.php,v $
...
class RapportTemplate_L62
{
	function RapportTemplate_L62($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
	  global $__appvar;
		$this->pdf = &$pdf;
