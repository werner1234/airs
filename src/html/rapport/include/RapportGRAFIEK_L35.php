...
/*
    ...
    Author  						: $Author: rvv $
 		...
 		$Log: RapportGRAFIEK_L35.php,v $
 		Revision 1.12  2018/08/18 12:40:14  rvv
 		php 5.6 & consolidatie
 		
 		Revision 1.11  2018/01/13 19:10:29  rvv
 		*** empty log message ***
...
class RapportGRAFIEK_L35
{
	function RapportGRAFIEK_L35($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
...
$grafiekData['ZAK']['titel']=vertaalTekst('Verloop standaarddeviatie zakelijke waarden',$this->pdf->rapport_taal);
$grafiekData['VAR']['titel']=vertaalTekst('Verloop standaarddeviatie vastrentende waarden',$this->pdf->rapport_taal);
$grafiekData['totaal']['titel']=vertaalTekst('Verloop standaarddeviatie portefeuille',$this->pdf->rapport_taal);
$grafiekData['afm']['titel']=vertaalTekst('Verloop AFM-standaarddeviatie wekelijks gemeten',$this->pdf->rapport_taal);
$grafiekData['totaalTrackingError']['titel']=vertaalTekst('Tracking error',$this->pdf->rapport_taal);
$grafiekData['totaalInformatieratio']['titel']=vertaalTekst('Informatieratio',$this->pdf->rapport_taal);
$portefeuilleTxt=vertaalTekst('portefeuille' ,$this->pdf->rapport_taal);
$benchmarkTxt=vertaalTekst('benchmark',$this->pdf->rapport_taal);
$grafiekData['ZAK']['legenda']=array($portefeuilleTxt,$benchmarkTxt);
$grafiekData['VAR']['legenda']=array($portefeuilleTxt,$benchmarkTxt);
$grafiekData['totaal']['legenda']=array($portefeuilleTxt,$benchmarkTxt);
$grafiekData['afm']['legenda']=array($portefeuilleTxt);
$grafiekData['totaalTrackingError']['legenda']=array($portefeuilleTxt);
$grafiekData['totaalInformatieratio']['legenda']=array($portefeuilleTxt);
