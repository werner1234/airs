...
/*
Author  						: $Author: rvv $
Laatste aanpassing	: $Date: 2018/04/04 15:48:38 $
File Versie					: $Revision: 1.9 $

$Log: RapportTemplate_L55.php,v $
...
class RapportTemplate_L55
{
	function RapportTemplate_L55($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
	  global $__appvar;
		$this->pdf = &$pdf;
    ...
    $totPagina = ($lastpage-$startpagina+$paginaCorrectie);//-1
       ...
       $this->pdf->ln(10);
	     ...
	     $inhoudsItems=array('PERFPaginas'=>'Performancemeting',
                           ...
                           'ATT2Paginas'=>'Performance attributie lopend jaar',
...
*/
	  ...
	  //   $extraBlank=1;
       ...
       $tekst=date("j",$this->pdf->rapport_datum)." ".vertaalTekst($this->pdf->__appvar["Maanden"][date("n",$this->pdf->rapport_datum)],$this->pdf->rapport_taal)." ".date("Y",$this->pdf->rapport_datum)."\n";
	     ...
	     $this->pdf->SetFont($this->pdf->rapport_font,'',$this->pdf->rapport_fontsize);
       $this->pdf->setXY(297-50-$this->pdf->marge,$Y);
