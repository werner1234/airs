...
$Log: RapportVOLKD_L70.php,v $
Revision 1.4  2020/07/15 16:38:19  rvv
*** empty log message ***

Revision 1.3  2016/08/13 16:55:26  rvv
*** empty log message ***
...
Revision 1.1  2014/09/17 15:16:31  rvv
*** empty log message ***
...
class RapportVOLKD_L70
{
	function RapportVOLKD_L70($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum, $valuta = 'EUR')
	{
		$this->pdf = &$pdf;
		$this->pdf->rapport_type = "VOLKD";
		$this->pdf->rapport_datum = db2jul($rapportageDatum);

		$this->pdf->rapport_titel = "Opbouw portefeuille";
...
//				$this->pdf->Line($begin,$this->pdf->GetY(),$begin + $this->pdf->widthB[5],$this->pdf->GetY());
		...
		if($this->pdf->rapport_HSE_volgorde_beginwaarde == 1)
		{
			$this->pdf->Cell($this->pdf->widthB[5],4,'', 0,0, "R");//$totaalAtxt
...
//			  $totaalAtxt = $this->formatGetal($totaalA,$this->pdf->rapport_decimaal,true);//Koers
    ...
    $maxDagenOud=$dagen['VerouderdeKoersDagen'];
	  ...
	  $this->pdf->widthB = array(10,55,20,78,1,1,15,20,30,30,15);
		$this->pdf->alignB = array('L','L','R','L','R','R','R','R','R','R','R');

		// voor kopjes
		$this->pdf->widthA = array(65,20,78,1,1,15,20,30,30,15);
		...
		while($categorien = $DB->NextRecord())
		{
		  ...
		  $DB2 = new DB();
		   ...
		   $this->printKop(vertaalTekst($this->pdf->rapport_valuta_voorzet,$this->pdf->rapport_taal)." ".$categorien[valuta], $this->pdf->rapport_kop4_fontstyle);
			...
			$subquery = "SELECT TijdelijkeRapportage.fondsOmschrijving, Fondsen.ISINCode, ".
...
$this->pdf->fillCell = array($this->pdf->cellColorLight,$this->pdf->cellColorLight,$this->pdf->cellColorDark,
                             $this->pdf->cellColorLight,$this->pdf->cellColorLight,
                             $this->pdf->cellColorLight,$this->pdf->cellColorLight,$this->pdf->cellColorDark,
