...
/*
Author  						: $Author: rvv $
Laatste aanpassing	: $Date: 2019/06/15 20:53:26 $
File Versie					: $Revision: 1.5 $

$Log: RapportPERFD_L33.php,v $
...
class RapportPERFD_L33
{

	function RapportPERFD_L33($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
    ...
    //echo "$rendementProcent  	= performanceMeting(".$this->portefeuille.", ".$this->rapportageDatumVanaf.", ".$this->rapportageDatum.", ".$this->pdf->portefeuilledata['PerformanceBerekening'].",".$this->pdf->rapportageValuta." ";exit;
		...
		$query = "SELECT SUM(actuelePortefeuilleWaardeEuro / ".$this->pdf->ValutaKoersEind." - beginPortefeuilleWaardeEuro / ".$this->pdf->ValutaKoersBegin.")  AS resultaatEUR,
		...
		$ongerealiseerdeKoersResultaat = $totaal['resultaatEUR'];
...
$RapStartJaar = date("Y", db2jul($this->rapportageDatumVanaf));
		...
		$this->pdf->row(array("",vertaalTekst("Ongerealiseerde fondsresultaten",$this->pdf->rapport_taal),$this->formatGetal($ongerealiseerdFondsResultaat,2),""));
		...
		//$this->pdf->row(array("",vertaalTekst("Gerealiseerde koersresultaten",$this->pdf->rapport_taal),$this->formatGetal($gerealiseerdeKoersResultaat['totaal'],2),""));

			if(round($koersResulaatValutas,2) != 0.00)
			  $this->pdf->row(array("",vertaalTekst("Koersresultaten vreemde valuta rekeningen",$this->pdf->rapport_taal),$this->formatGetal($koersResulaatValutas,2),""));
