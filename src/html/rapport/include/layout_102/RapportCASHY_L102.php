...
class RapportCASHY_L102
{
	function RapportCASHY_L102($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
	 //
		$this->pdf = &$pdf;
...
$maanden=array(0,'jan','feb','mrt','apr','mei','jun','jul','aug','sep','okt','nov','dec');
    ...
    $this->pdf->Row(array('',vertaalTekst('maand',$this->pdf->rapport_taal),vertaalTekst('kapitaal',$this->pdf->rapport_taal),vertaalTekst('coupon',$this->pdf->rapport_taal),vertaalTekst('totaal',$this->pdf->rapport_taal)));
    $this->pdf->SetFont($this->pdf->rapport_font,'',$this->pdf->rapport_fontsize);
    $totalen=array();
...
$this->pdf->CellBorders = array();
		...
		$this->pdf->SetFont($this->pdf->rapport_font,'B',$this->pdf->rapport_fontsize);
		$this->pdf->Row(array('',vertaalTekst('jaar',$this->pdf->rapport_taal),vertaalTekst('kapitaal',$this->pdf->rapport_taal),vertaalTekst('coupon',$this->pdf->rapport_taal),vertaalTekst('totaal',$this->pdf->rapport_taal)));
		$this->pdf->SetFont($this->pdf->rapport_font,'',$this->pdf->rapport_fontsize);
    $this->pdf->SetFont($this->pdf->rapport_font,'',$this->pdf->rapport_fontsize);
    $totalen=array();
...
$this->pdf->CellBorders = array();
	...
	function VBarDiagram($w, $h, $data,$titel)
  {
    ...
    $datumTotalen=array();
      ...
      $colors=array('rente'=>array(23,232,56),
      'lossing'=>array(44,114,231));
   ...
   $vertaling['lossing']=vertaalTekst('kapitaal',$this->pdf->rapport_taal);
