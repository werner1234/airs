...
$Log: RapportDOORKIJK_L102.php,v $
Revision 1.3  2020/02/29 16:23:08  rvv
*** empty log message ***

Revision 1.2  2018/04/25 16:45:28  rvv
*** empty log message ***
...
class RapportDOORKIJK_L102
{
	function RapportDOORKIJK_L102($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = $pdf;
		$this->pdf->rapport_type = "DOORKIJK";
		$this->pdf->rapport_datum = db2jul($rapportageDatum);
  	$this->pdf->rapport_titel = "Regio's en sectoren";
		...
		if($this->debug)
		{
			...
			foreach($wegingSoorten as $wegingSoort)
			{
				...
				foreach($doorkijkCategorieSoorten as $index=>$doorkijkCategorieSoort)
				{
					...
					$this->pdf->row(array('',vertaalTekst("fonds",$this->pdf->rapport_taal),vertaalTekst("categorie",$this->pdf->rapport_taal), vertaalTekst("perc",$this->pdf->rapport_taal),vertaalTekst("waarde",$this->pdf->rapport_taal)));
					...
					{
						$this->pdf->row(array('', vertaalTekst("Totaal",$this->pdf->rapport_taal), $categorie, '', $this->formatGetal($waarden['waarde'], 2)));
...
KeuzePerVermogensbeheerder.categorie='Beleggingscategorien' ";
    ...
    $this->pdf->templateVarsOmschrijving[$this->pdf->rapport_type.'Paginas']=$this->pdf->rapport_titel;
		$this->vulPagina($beleggingscategorien);//'AAND'
