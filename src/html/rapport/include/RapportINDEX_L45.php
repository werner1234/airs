...
class RapportINDEX_L45
{
	function RapportINDEX_L45($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
  ...
  function formatGetalKoers($waarde, $dec , $start = false)
    ...
    unset($this->pdf->CellBorders);
		...
		$this->pdf->SetFont($this->pdf->rapport_font,'',$this->pdf->rapport_fontsize);
			$this->pdf->CellBorders = array('U','U','U','U','U','U','U','U','U','U');
		$this->pdf->row(array('',vertaalTekst('Resultaat',$this->pdf->rapport_taal),vertaalTekst('Performance',$this->pdf->rapport_taal)."\n".vertaalTekst('categorie',$this->pdf->rapport_taal)."  ",vertaalTekst('Performance',$this->pdf->rapport_taal)."\n".vertaalTekst('contributie',$this->pdf->rapport_taal)."  ",'','',
		vertaalTekst('Resultaat',$this->pdf->rapport_taal),vertaalTekst('Performance',$this->pdf->rapport_taal)."\n".vertaalTekst('categorie',$this->pdf->rapport_taal)."  ",vertaalTekst('Performance',$this->pdf->rapport_taal)."\n".vertaalTekst('contributie',$this->pdf->rapport_taal)."  "));
