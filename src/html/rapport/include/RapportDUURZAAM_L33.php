...
/*
Author  						: $Author: rvv $
Laatste aanpassing	: $Date: 2018/09/08 17:43:29 $
File Versie					: $Revision: 1.2 $

$Log: RapportDUURZAAM_L33.php,v $
Revision 1.2  2018/09/08 17:43:29  rvv
*** empty log message ***

Revision 1.1  2018/09/06 15:33:11  rvv
*** empty log message ***
...
class RapportDUURZAAM_L33
{
	function RapportDUURZAAM_L33($pdf,$portefeuille, $rapportageDatumVanaf, $rapportageDatum )
	{
		$this->pdf = &$pdf;
    ...
    $this->verdeling='regio';
		$this->vastWhere=" AND TijdelijkeRapportage.hoofdcategorie='G-RISM' ";
		$this->vastWhereAtt=" AND HoofdBeleggingscategorien.Beleggingscategorie='G-RISM' ";
		$this->hse=new RapportHSE_L33($this->pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum);
		$this->berekenTotaal();
    $this->pdf->rapport_titel = "Overzicht risicomijdende beleggingen per regio (met beginkoers)";//"Vermogensoverzicht regio (met beginkoers)";
...
if(TijdelijkeRapportage.type='rekening',200,TijdelijkeRapportage.".$type."Volgorde) as afdrukvolgorde,
TijdelijkeRapportage.type,
...
ORDER BY afdrukvolgorde,TijdelijkeRapportage.fondsOmschrijving";
		$DB->SQL($query);
