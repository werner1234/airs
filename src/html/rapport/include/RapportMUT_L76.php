...
$Log: RapportMUT_L76.php,v $
Revision 1.5  2020/03/18 17:44:11  rvv
*** empty log message ***

Revision 1.4  2018/05/02 16:13:47  rvv
*** empty log message ***
...
class RapportMUT_L76
{
	function RapportMUT_L76($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
