...
/*
Author  						: $Author: rvv $
Laatste aanpassing	: $Date: 2018/02/11 13:27:19 $
File Versie					: $Revision: 1.1 $

$Log: RapportHSE_L25.php,v $
...
class RapportHSE_L25
{
	function RapportHSE_L25($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum, $valuta = 'EUR')
	{
		$this->pdf = &$pdf;
