...
$Log: RapportTemplate_L10.php,v $
Revision 1.2  2019/02/20 16:50:39  rvv
*** empty log message ***
...
class RapportTemplate_L10
{
	function RapportTemplate_L10($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
	  global $__appvar;
		$this->pdf = &$pdf;
    ...
    $totPagina = ($lastpage-$startpagina+$paginaCorrectie);//-1
       ...
       $this->pdf->ln(10);
	     ...
	     $inhoudsItems=array('PERFPaginas'=>'Performance over de beleggingscategorieën',
                           ...
                           'RISKPaginas'=>'Rendement en Risico vergelijking',
