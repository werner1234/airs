...
$Log: RapportVKMS_L55.php,v $
Revision 1.8  2019/02/03 15:50:24  rvv
*** empty log message ***
...
Revision 1.4  2018/03/03 17:13:43  rvv
*** empty log message ***

Revision 1.3  2018/02/25 08:37:54  rvv
*** empty log message ***

Revision 1.2  2018/02/24 18:33:46  rvv
*** empty log message ***
...
class RapportVKMS_L55
{
	function RapportVKMS_L55($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		if(is_object($pdf))
		{
			$this->pdf = &$pdf;
...
foreach ($perCategorie as $hoofdcategorie=>$categorieData)
{
 ...
 WHERE Portefeuilles.portefeuille='".$this->portefeuille."'";
    ...
    for($i=$this->pdf->rapport_jaar; $i<=$doelJaar; $i++)
		...
		$waardeZonderKostenKleur=array(140,178,209);
		$waardeNaKostenKleur=array(40,200,40);
