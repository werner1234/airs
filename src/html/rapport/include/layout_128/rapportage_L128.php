...
$Log: rapportage_L99.php,v $

*/

// KNOX
$pdf->rapport_layout = 128;
$pdf->marge = 8;
...
/*
if (file_exists(FPDF_FONTPATH . 'Aeonik.php'))
{
  if (!isset($pdf->fonts['aeonik']))
  {
    $pdf->AddFont('aeonik', '', 'Aeonik.php');
    $pdf->AddFont('aeonik', 'B', 'AeonikB.php');
    $pdf->AddFont('aeonik', 'I', 'AeonikI.php');
    $pdf->AddFont('aeonik', 'BI', 'AeonikBI.php');
  }
  $pdf->rapport_font = 'aeonik';
}
*/
...
$pdf->rapport_kop_bgcolor = array('r' => 65, 'g' => 94, 'b' => 91); //35/45/104 //33/43/105 //'r'=>88,'g'=>119,'b'=>255
$pdf->rapport_kop_fontcolor = array('r'=>255,'g'=>255,'b'=>255);//array('r'=>127,'g'=>128,'b'=>132);
$pdf->rapport_kop_fontstyle = 'b';

$pdf->rapport_background_fill = array(204,204,204);
$pdf->rapport_groen = array(65, 94, 91);
