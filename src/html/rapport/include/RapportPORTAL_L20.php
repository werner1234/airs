...
class RapportPORTAL_L20
{
	function RapportPORTAL_L20($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
    ...
    $this->pdf->SetFont($this->pdf->rapport_font,$this->pdf->rapport_fontstyle,$this->pdf->rapport_fontsize);
     ...
     Rekeningmutaties.omschrijving as rekeningOmschrijving,
		...
		"Rekeningmutaties.Transactietype NOT IN('B','D','L') AND ".
