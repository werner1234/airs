...
include_once($__appvar["basedir"]."/html/rapport/include/RapportATT_L45.php");


class RapportOIB_L45
{
	function RapportOIB_L45($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
  ...
  function barChart()
  {
    $this->att=new RapportATT_L45($this->pdf, $this->portefeuille, $this->rapportageDatumVanaf, $this->rapportageDatum);
