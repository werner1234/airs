...
$Log: RapportPERF_L4.php,v $
Revision 1.3  2016/11/30 16:48:42  rvv
*** empty log message ***

Revision 1.2  2016/04/16 17:12:30  rvv
*** empty log message ***
...
class RapportPERF_L4
{

	function RapportPERF_L4($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
...
//rvv end
      ...
      if($this->pdf->rapport_layout == 5)
		...
		{
		  if($key=='BEW')
        $kostenPerGrootboek[$key]['Omschrijving']='Banking fee';
