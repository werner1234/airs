...
class RapportVOLK_L98
{
	function RapportVOLK_L98($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
  ...
  function getDividend($fonds)
  {
	...
	function writeRapport()
	{
		...
		$this->pdf->widthB = array(55,18,18,20,21,1,17,21,21,18,18,18,18,18);
		$this->pdf->widthA = array(60,18,18,20,21,1,17,21,21,18,18,18,18,18);
