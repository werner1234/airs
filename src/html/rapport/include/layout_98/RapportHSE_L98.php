...
class RapportHSE_L98
{
	function RapportHSE_L98($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum, $valuta = 'EUR')
	{
		$this->pdf = &$pdf;
    ...
    $maxDagenOud=$dagen['VerouderdeKoersDagen'];
	  ...
	  $this->pdf->widthB = array(10,55,20,10,20,30,30,15,20,30,30,10);
		$this->pdf->alignB = array('L','L','R','R','R','R','R','R','R','R','R','R');

		// voor kopjes
		$this->pdf->widthA = array(65,20,10,20,30,30,15,20,30,30,10);
		$this->pdf->alignA = array('L','R','R','R','R','R','R','R','R','R','R');
    ...
    $totaalLiquiditeitenEuro = 0;
		...
		while($data = $DB1->NextRecord())
		{
			...
			$omschrijving = vertaalTekst(str_replace("{Rekening}",substr($data['rekening'],0,-3).' '.substr($data['rekening'],-3,3),$omschrijving),$this->pdf->rapport_taal);
    ...
    printRendement_L98($this->pdf,$this->portefeuille, $this->rapportageDatum, $this->rapportageDatumVanaf,false,$this->pdf->rapportageValuta);
