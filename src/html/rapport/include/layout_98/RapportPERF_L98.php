...
include_once("rapport/include/layout_98/ATTberekening_L98.php");

class RapportPERF_L98
{

	function RapportPERF_L98($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
    ...
    $this->att=new ATTberekening_L98($this);
	}
...
function addResultaat()
{
  ...
  */
  ...
  $vetralingGrootboek=$this->getGrootboeken();
    ...
    $att=new ATTberekening_L98($this);
