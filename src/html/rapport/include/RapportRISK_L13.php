...
$Log: RapportRISK_L13.php,v $
Revision 1.2  2019/05/15 15:32:37  rvv
*** empty log message ***
...
class RapportRISK_L13
{
	function RapportRISK_L13($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
    ...
    date('d-m-Y',$this->pdf->rapport_datum),'Mutaties','Resultaat','Gemiddeld vermogen','Resultaat %','Weging');
...
ORDER BY HoofdBeleggingscategorien.Afdrukvolgorde, Beleggingscategorien.Afdrukvolgorde,fondsVolgorde,OptieBovenliggendFonds,FondsOmschrijving ";//Regios.Afdrukvolgorde,
...
ORDER BY HoofdBeleggingscategorien.Afdrukvolgorde, Beleggingscategorien.Afdrukvolgorde";//Regios.Afdrukvolgorde,
