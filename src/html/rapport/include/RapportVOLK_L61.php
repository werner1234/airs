...
/*
Author  						: $Author: rvv $
Laatste aanpassing	: $Date: 2018/11/17 17:34:53 $
File Versie					: $Revision: 1.6 $

$Log: RapportVOLK_L61.php,v $
Revision 1.6  2018/11/17 17:34:53  rvv
*** empty log message ***

Revision 1.5  2018/09/29 16:19:30  rvv
*** empty log message ***

Revision 1.4  2016/04/16 17:12:30  rvv
*** empty log message ***

Revision 1.3  2015/09/30 15:53:11  rvv
*** empty log message ***
...
class RapportVOLK_L61
{
	function RapportVOLK_L61($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
	...
	function formatAantal($waarde, $dec, $VierDecimalenZonderNullen=false)
	{
	  if ($VierDecimalenZonderNullen)
	  {
	   ...
	   if ($decimaalDeel != '0000' )
	   {
	     ...
	     return number_format($waarde * $this->aandeel,$newDec,",",".");
	   }
	  else
	   return number_format($waarde * $this->aandeel,$dec,",",".");
	  }
	  else
	   return number_format($waarde * $this->aandeel,$dec,",",".");
	}
  ...
  function getDividend($fonds)
  {
    ...
    return array('totaal'=>$totaal* $this->aandeel,'corrected'=>$totaalCorrected* $this->aandeel);
  }
	...
	function writeRapport()
	{
		...
		$this->pdf->widthB = array(5,68,15,22,15,20,2,16,21,20,22,20,20,15);
		$this->pdf->alignB = array('R','L','R','R','R','R','R','R','R','R','R','R','R','R','R','R');

		// voor kopjes
		$this->pdf->widthA = array(   73,15,22,15,20,2,16,21,20,22,20,20,15);
    ...
    $this->pdf->templateVars['VOLKPaginas']=$this->pdf->page;
		...
		$totaalWaarde = $totaalWaarde['totaal']*$this->aandeel;
	    ...
	    " SUM(IF (TijdelijkeRapportage.valuta = '".$this->pdf->rapportageValuta."', 
          TijdelijkeRapportage.beginPortefeuilleWaardeEuro / beginwaardeValutaLopendeJaar * ".$this->aandeel.",
          TijdelijkeRapportage.beginPortefeuilleWaardeEuro * ".$this->aandeel.")  ) as subtotaalbegin,".
