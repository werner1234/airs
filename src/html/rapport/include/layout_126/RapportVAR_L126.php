...
include_once("rapport/include/layout_126/RapportFRONT_L126.php");
include_once("rapport/include/layout_126/RapportEND_L126.php");
include_once("rapport/include/layout_126/RapportPERFG_L126.php");
include_once($__appvar["basedir"]."/html/rapport/Zorgplichtcontrole.php");

class RapportVAR_L126
{
	function RapportVAR_L126($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
	...
	function getCRMdata()
  {
	...
	function writeRapport()
	{
		...
		$rapport = new RapportFRONT_L126($this->pdf, $this->portefeuille,$this->rapportageDatumVanaf,$this->rapportageDatum);
    ...
    $this->toelichting();
		...
		$rapport = new RapportEND_L126($this->pdf, $this->portefeuille,$this->rapportageDatumVanaf,$this->rapportageDatum);
...
*/
	...
	function risicoMeter()
  {
    ...
    $perfg=new RapportPERFG_L126($this->pdf, $this->portefeuille,$this->rapportageDatumVanaf,$this->rapportageDatum);
