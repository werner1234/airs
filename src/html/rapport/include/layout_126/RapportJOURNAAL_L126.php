...
class RapportJOURNAAL_L126
{
	function RapportJOURNAAL_L126($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
		...
		if($this->pdf->rapport_JOURNAAL_titel)
			$this->pdf->rapport_titel = vertaalTekst($this->pdf->rapport_JOURNAAL_titel,$this->pdf->rapport_taal);
		else
			$this->pdf->rapport_titel = vertaalTekst("Journaal",$this->pdf->rapport_taal)." ".date("j",$this->pdf->rapport_datumvanaf)." ".
