...
$Log: RapportVOLK_L30.php,v $
Revision 1.6  2017/05/29 06:28:02  rvv
*** empty log message ***

Revision 1.4  2013/01/02 16:50:38  rvv
*** empty log message ***

Revision 1.3  2012/03/21 19:08:58  rvv
*** empty log message ***

Revision 1.2  2012/02/01 19:27:44  rvv
*** empty log message ***

Revision 1.1  2011/10/05 18:00:14  rvv
*** empty log message ***
...
class RapportVOLK_L30
{
	function RapportVOLK_L30($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
	...
	function writeRapport()
	{
		...
		if($this->pdf->rapport_VOLK_volgorde_beginwaarde == 2)
		{
			$this->pdf->widthB = array(22,50+$omschrijvingExtra,18,21,21,15,21,21,13,22,$fondsresultwidth,21,21,13);
