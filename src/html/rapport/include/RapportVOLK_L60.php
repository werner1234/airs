...
/*
Author  						: $Author: rvv $
Laatste aanpassing	: $Date: 2016/03/20 14:32:23 $
File Versie					: $Revision: 1.3 $

$Log: RapportVOLK_L60.php,v $
Revision 1.3  2016/03/20 14:32:23  rvv
*** empty log message ***

Revision 1.2  2015/08/05 15:58:53  rvv
*** empty log message ***
...
class RapportVOLK_L60
{
	function RapportVOLK_L60($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
 ...
 function getDividend($fonds)
  {
    ...
    $maxDagenOud=$dagen['VerouderdeKoersDagen'];
			...
			$this->pdf->widthB = array(19,50+$omschrijvingExtra,18,18,21,21,5,25,25,5,21,$fondsresultwidth,15,12,15);
			$this->pdf->alignB = array('R','L','R','R','R','R','R','R','R','R','R','R','R','R');
		// voor kopjes
			$this->pdf->widthA = array(68+$omschrijvingExtra,18,15,21,21,15,20,20,15,22,21,$fondsresultwidth,15,15);
