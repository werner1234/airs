...
Revision 1.3  2015/05/02 14:57:32  rvv
*** empty log message ***
...
class RapportMUT_L65
{
	function RapportMUT_L65($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
...
//		$this->pdf->Line($totaal2+2,$this->pdf->GetY(),$totaal2 + $this->pdf->widthA[7],$this->pdf->GetY());
	...
	function writeRapport()
	{
      ...
      $mutaties['Omschrijving']=vertaalTekst($mutaties['Omschrijving'],$this->pdf->rapport_taal);
			$parts=explode(' ',$mutaties['Omschrijving']);
      $parts[0]=vertaalTekst($parts[0],$this->pdf->rapport_taal);
      $mutaties['Omschrijving']=implode(' ',$parts);
