...
/*
Author  						: $Author: rvv $
Laatste aanpassing	: $Date: 2017/04/09 10:13:59 $
File Versie					: $Revision: 1.3 $

$Log: RapportKERNZ_L70.php,v $
...
class RapportKERNZ_L70
{

	function RapportKERNZ_L70($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
...
function rechtsOnder($riskData)
{
    ...
    $this->pdf->ln(2);
    $this->pdf->row(array('','Tracking Error','',''));//'De Tracking-error geeft een indicatie weer van de mate van afwijking van het rendement van de portefeuille ten opzichte van de benchmark.'
    $this->pdf->ln(2);
