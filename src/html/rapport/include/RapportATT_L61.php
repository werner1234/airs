...
/*
Author  						: $Author: rvv $
Laatste aanpassing	: $Date: 2018/10/13 17:18:13 $
File Versie					: $Revision: 1.8 $

$Log: RapportATT_L61.php,v $
Revision 1.8  2018/10/13 17:18:13  rvv
*** empty log message ***

Revision 1.7  2017/09/06 16:29:58  rvv
*** empty log message ***
...
class RapportATT_L61
{
	function RapportATT_L61($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
...
foreach ($indexData as $index=>$data)
{
  ...
  $barGraph['Index'][$data['datum']]['leeg']=0;
    ...
    WHERE categorie='Beleggingscategorien' AND Vermogensbeheerder = '".$beheerder."' ORDER BY KeuzePerVermogensbeheerder.Afdrukvolgorde ";
