...
/*
Author  						: $Author: rvv $
Laatste aanpassing	: $Date: 2014/06/29 15:38:56 $
File Versie					: $Revision: 1.11 $

$Log: RapportATT_L5.php,v $
Revision 1.11  2014/06/29 15:38:56  rvv
*** empty log message ***
...
class RapportATT_L5
{
	function RapportATT_L5($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
   ...
   if(count($rendamentWaarden) > 0)
   {
     ...
     //   $this->pdf->CellBorders = array('','US','US','US','US','US','US','US','US','US','US','US');
       ...
       //$this->pdf->SetFillColor(230,230,230);
        //$this->pdf->SetFillColor(100,145,191);
