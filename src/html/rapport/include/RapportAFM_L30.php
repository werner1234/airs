...
/*
Author  						: $Author: rvv $
Laatste aanpassing	: $Date: 2017/10/04 16:09:09 $
File Versie					: $Revision: 1.1 $

$Log: RapportAFM_L30.php,v $
...
class RapportAFM_L30
{
	function RapportAFM_L30($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
	  global $__appvar;
		$this->pdf = &$pdf;
