...
class RapportVHO_L5
{
	function RapportVHO_L5($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
	...
	function writeRapport()
	{
		...
		$this->pdf->widthB = array(5,55,18,15,22,22,1,15,22,22,15,22,15,22,15);
				 ...
				 //   $valutaResultaat ='';
				  //  $fondsResultaat ='';
				  					$this->pdf->row(array("",
												...
												$this->formatGetal($subdata[historischeWaarde] * $subdata[historischeValutakoers],2),
												"",
