...
class RapportZORG_L70
{
	...
	*/
	...
	function RapportZORG_L70($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
    ...
    $this->pdf->setWidths(array(90,30,30,30,30,30,30,30));
      ...
      $this->pdf->templateVarsOmschrijving['ZORGPaginas']=$this->pdf->rapport_titel;
        ...
        $this->pdf->row(array($zpdata['fondsOmschrijving'], 
                              ...
                              $this->formatGetal($zpdata['Percentage'],1),
												    	...
												    	$this->formatGetal($zpdata['actuelePortefeuilleWaardeEuro']/$zpwaarde['totaalWaarde']*100,1).'%'));
