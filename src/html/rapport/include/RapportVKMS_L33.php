...
Revision 1.9  2018/12/13 08:02:21  rvv
*** empty log message ***

Revision 1.8  2018/12/13 07:39:31  rvv
*** empty log message ***

Revision 1.7  2018/12/12 16:19:08  rvv
*** empty log message ***

Revision 1.6  2018/05/09 13:22:09  rvv
*** empty log message ***

Revision 1.5  2018/04/11 09:14:19  rvv
*** empty log message ***

Revision 1.4  2018/04/07 15:21:44  rvv
*** empty log message ***

Revision 1.3  2017/12/06 16:50:06  rvv
*** empty log message ***

Revision 1.2  2017/11/27 06:36:48  rvv
*** empty log message ***

Revision 1.1  2017/11/25 20:25:19  rvv
*** empty log message ***
...
class RapportVKMS_L33
{
	function RapportVKMS_L33($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		if(is_object($pdf))
		{
			$this->pdf = &$pdf;
...
if(Rekeningmutaties.Grootboekrekening='BEW','KNBA',Rekeningmutaties.Grootboekrekening) as Grootboekrekening,
if(Grootboekrekeningen.Omschrijving='Bewaarloon','Bankkosten',Grootboekrekeningen.Omschrijving) as Omschrijving
FROM Rekeningmutaties
JOIN Rekeningen ON Rekeningmutaties.Rekening=Rekeningen.Rekening
...
" $rekeningFondsenWhere ";
	...
	function writeRapport()
	{
		...
		if($this->pdfVullen==true)
		{
			...
			$this->pdf->AddPage();
			$this->pdf->templateVars['VKMPaginas'] = $this->pdf->customPageNo;
...
foreach ($perCategorie as $hoofdcategorie=>$categorieData)
{
 ...
 $perfTotaal['percentageIndirectVermogenMetKostenfactor']=$percentageIndirectVermogenMetKostenfactor;
		...
		if($this->skipDetail==true)
		{
			...
			$this->pdf->vmkHeaderOnderdrukken = true;
			$this->pdf->addPage();
			$this->pdf->templateVars['VKMSPaginas'] = $this->pdf->customPageNo;
			$this->pdf->SetFont($this->pdf->rapport_font, '', $this->pdf->rapport_fontsize);
		}
      ...
      while($data=$DB->nextRecord())
      {
        ...
        if($data['Grootboekrekening']=='BEH')
          $data['Omschrijving']='Vergoeding BA van Doorn';
