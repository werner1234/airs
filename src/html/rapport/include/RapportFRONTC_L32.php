...
$Log: RapportFRONTC_L32.php,v $
Revision 1.2  2018/07/07 17:35:19  rvv
*** empty log message ***
...
class RapportFrontC_L32
{
	function RapportFrontC_L32($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
...
*/
   ...
   $this->pdf->SetWidths(array(30,40+25+120));
    if($_POST['anoniem']!=1)
    {
       $this->pdf->row(array('',($portefeuilledata['ClientVermogensbeheerder']<>''?$portefeuilledata['ClientVermogensbeheerder']:$portefeuilledata['Portefeuille'])));//,$pdata['Depotbank'],$pdata['Naam']
       $this->pdf->Ln(1);
    }
    $this->pdf->SetWidths($this->pdf->widthA);
    $this->pdf->ln(8); 
