...
$Log: RapportRISK_L40.php,v $
Revision 1.2  2017/04/09 10:13:59  rvv
*** empty log message ***
...
class RapportRISK_L40
{

	function RapportRISK_L40($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
...
function addStdevGrafieken($stdev)
{
  ...
  function LineDiagram($w, $h, $data, $color=null, $maxVal=0, $minVal=0, $horDiv=4, $verDiv=4)
  {
    ...
    $this->pdf->Rect($XDiag, $YDiag, $w-$margin, $h,'FD','',array(200,200,200));
