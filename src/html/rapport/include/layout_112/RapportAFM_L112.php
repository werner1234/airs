...
class RapportAFM_L112
{
	function RapportAFM_L112($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
...
*/
  ...
  //  listarray($waarden);
    ...
    $this->waarden['Historie']=$att->bereken($rapportageStartJaar,  $this->rapportageDatum,'Beleggingscategorie');//Hoofdcategorie
