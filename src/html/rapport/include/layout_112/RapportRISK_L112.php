...
class RapportRISK_L112
{
	function RapportRISK_L112($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
...
FROM HistorischePortefeuilleIndex WHERE HistorischePortefeuilleIndex.Portefeuille='$cPortefeuille' AND HistorischePortefeuilleIndex.Datum='$dag' AND HistorischePortefeuilleIndex.periode='m'";
   ...
   // listarray($stdev);
    ...
    $drawDownReeksen=array('totaal'=>'portefeuille','benchmarkTot'=>'specifiekeIndex');
    $waarden=array();
