...
$pdf->rapport_kop_bgcolor = array('r' => 0, 'g' => 0, 'b' => 78); //35/45/104 //33/43/105 //'r'=>88,'g'=>119,'b'=>255
...
$pdf->rapport_rentekleur = array(121,199,152);
$pdf->rapport_lossingkleur = array(75,91,154);
$pdf->rapport_portefeuillekleur=$pdf->rapport_rentekleur;
$pdf->rapport_benchmarkkleur=$pdf->rapport_lossingkleur;
$pdf->rapport_grafiek_afm=$pdf->rapport_lossingkleur;
