...
$Log: RapportVKMS_L10.php,v $
Revision 1.6  2019/06/29 18:24:12  rvv
*** empty log message ***

Revision 1.5  2019/02/20 16:50:39  rvv
*** empty log message ***

Revision 1.4  2019/02/03 15:50:24  rvv
*** empty log message ***

Revision 1.3  2019/01/16 16:28:10  rvv
*** empty log message ***
...
class RapportVKMS_L10
{
	function RapportVKMS_L10($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		if(is_object($pdf))
		{
			$this->pdf = &$pdf;
 ...
 WHERE Portefeuilles.portefeuille='".$this->portefeuille."'";
    ...
    if(!isset($this->pdf->rapport_grafiek_icolor))
      $this->pdf->rapport_grafiek_icolor=array(176,160,122);//array(rand(0,255),rand(0,255),rand(0,255));
		...
		$waardeNaKostenKleur=$this->pdf->rapport_grafiek_icolor;
		$cumulatieveKostenKleur=array($this->pdf->rapport_logoKleur[0],$this->pdf->rapport_logoKleur[1],$this->pdf->rapport_logoKleur[2]);
