...
/*
Author  						: $Author: rvv $
Laatste aanpassing	: $Date: 2017/09/13 15:44:03 $
File Versie					: $Revision: 1.15 $

$Log: RapportMOD.php,v $
Revision 1.15  2017/09/13 15:44:03  rvv
*** empty log message ***
...
class RapportMOD_L13
{
	function RapportMOD_L13($pdf, $portefeuille, $rapportageDatum)
	{
		$this->pdf = &$pdf;
    ...
    $this->rapportageDatum = $rapportageDatum;
  	...
  	$this->pdf->rapport_koptext = "Portefeuille voorstel: ". $this->pdf->portefeuilledata['naam'] . ' ' . $this->pdf->rapport_naam1."\n".$this->pdf->selectData['mutatieportefeuille_customNaam'];
	...
	function writeRapport()
	{
		...
		while($data = $DB1->NextRecord())
		{
			...
			$omschrijving = str_replace("{Rekening}",'',$omschrijving); //Leeg tonen
			$omschrijving = str_replace("{PortefeuilleVoorzet}",'',$omschrijving); //Leeg tonen
