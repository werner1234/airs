...
/*
    ...
    Author  						: $Author: rvv $
 		...
 		$Log: RapportCASHY_L57.php,v $
 		Revision 1.2  2020/03/04 16:40:47  rvv
 		*** empty log message ***
...
class RapportCASHY_L57
{
	function RapportCASHY_L57($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
	 //
		$this->pdf = &$pdf;
	...
	function VBarDiagram($w, $h, $data,$titel)
  {
      ...
      $colors=array('rente'=>array(189,214,221),
      'lossing'=>array(23,91,126));
