...
$Log: RapportVOLKD_L24.php,v $
Revision 1.1  2019/02/06 16:07:12  rvv
*** empty log message ***

Revision 1.2  2017/03/04 19:21:42  rvv
*** empty log message ***
...
class RapportVOLKD_L24
{
	function RapportVOLKD_L24($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
 ...
 function getDividend($fonds)
  {
    ...
    $omschrijvingExtra=10;
		...
		// voor data
			...
			$this->pdf->widthB = array(18,50+$omschrijvingExtra,18,21,21,15,21,21,5,22,19,20,20,15);
			$this->pdf->alignB = array('R','L','R','R','R','R','R','R','R','R','R','R','R','R');
		// voor kopjes
			$this->pdf->widthA = array(66+$omschrijvingExtra,18,15,21,21,15,21,21,5,22,20,19,20,15);
