...
class RapportCASHY_L70
{
	function RapportCASHY_L70($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
	 //
		$this->pdf = &$pdf;
...
$maanden=array(0,'jan','feb','mrt','apr','mei','jun','jul','aug','sep','okt','nov','dec');
    ...
    $this->pdf->SetFont($this->pdf->rapport_font,'',$this->pdf->rapport_fontsize);
		...
		{
       $this->pdf->fillCell = array(0,$this->pdf->cellColorLight,$this->pdf->cellColorDark,$this->pdf->cellColorLight,$this->pdf->cellColorDark);
...
$this->pdf->CellBorders = array();
	...
	function VBarDiagram($w, $h, $data,$titel)
  {
      ...
      $colors=array('rente'=>$this->pdf->frontRood,'lossing'=>$this->pdf->frontBlauw);
