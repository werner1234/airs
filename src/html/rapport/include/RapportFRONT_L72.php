...
$Log: RapportFRONT_L72.php,v $
Revision 1.16  2020/07/29 13:56:12  rvv
*** empty log message ***

Revision 1.15  2018/08/25 17:11:27  rvv
*** empty log message ***

Revision 1.14  2018/06/16 17:42:56  rvv
*** empty log message ***

Revision 1.13  2018/02/17 19:18:57  rvv
*** empty log message ***

Revision 1.12  2017/08/30 15:03:56  rvv
*** empty log message ***

Revision 1.11  2017/08/26 17:37:43  rvv
*** empty log message ***

Revision 1.10  2017/08/19 18:18:00  rvv
*** empty log message ***

Revision 1.9  2017/07/22 18:26:57  rvv
*** empty log message ***
...
Revision 1.6  2017/02/08 12:32:32  rvv
*** empty log message ***
...
class RapportFront_L72
{
	function RapportFront_L72($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
   ...
   //background
    ...
    if($this->pdf->portefeuilledata['ondernemingsvorm']=='Persoon' && $this->pdf->portefeuilledata['Naam1'] <> '')
    {
      $this->pdf->ln(1);
      $this->pdf->row(array('',$this->pdf->portefeuilledata['Naam1']));
    }
		elseif($this->pdf->portefeuilledata['verzendPaAanhef'] <> '')
		{
			$this->pdf->ln(1);
			$this->pdf->row(array('',$this->pdf->portefeuilledata['verzendPaAanhef']));
		}
		/*
