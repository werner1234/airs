...
class RapportVHO_L81
{
	function RapportVHO_L81($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
...
//     " Rekeningmutaties.Boekdatum >= '".	$this->rapportageDatumVanaf."' AND ".
	...
	function writeRapport()
	{
		...
		$this->pdf->widthB = array(5,55,18,15,20,22,1,15,21,22,17,19,19,18,12);
		$this->pdf->alignB = array('R','L','R','R','R','R','R','R','R','R','R','R','R','R','R','R');

		// voor kopjes
		$this->pdf->widthA = array(   60,18,15,20,22,1,15,21,22,17,19,19,18,12);
