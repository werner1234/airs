...
/*
    ...
    Author  						: $Author: rvv $
 		...
 		$Log: ATTberekening_L81.php,v $
 		Revision 1.2  2020/07/20 04:38:16  rvv
 		*** empty log message ***
...
class ATTberekening_L81
{

	function ATTberekening_L81($rapportData,$periode='maanden')
	{
...
if($stapeling == true)
{
  ...
  {
    if($categorie=='H-Liq')
      $filter= "AND ( ".$rekeningRekeningenWhere." AND Rekeningmutaties.Fonds='')";
    else
      $filter = $fondsenWhere;
  }
