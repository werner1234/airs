...
class RapportOIB_L81
{
	function RapportOIB_L81($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
...
$this->pdf->SetFont($this->pdf->rapport_font,'b',$this->pdf->rapport_fontsize);
$this->pdf->row(array('','Totaal '.date("d-m-Y",db2jul($rapportageDatumVanaf)), $this->formatGetalKoers($regelTotaal['beleggingscategorieBegin']['waardeEur'],0,true),$this->formatGetal($regelTotaal['beleggingscategorieBegin']['percentage'],0).'%','',
'Totaal '.date("d-m-Y",db2jul($rapportageDatum)), $this->formatGetalKoers($regelTotaal['beleggingscategorieEind']['waardeEur'],0),$this->formatGetal($regelTotaal['beleggingscategorieEind']['percentage'],0).'%'
,'','Totaal '.date("d-m-Y",db2jul($rapportageDatum)), $this->formatGetalKoers($regelTotaal['valutaVerdeling']['waardeEur'],0),$this->formatGetal($regelTotaal['valutaVerdeling']['percentage'],0).'%'
));
$this->pdf->SetFont($this->pdf->rapport_font,'',$this->pdf->rapport_fontsize);
