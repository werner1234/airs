...
/*
Author  						: $Author: rvv $
Laatste aanpassing	: $Date: 2019/01/16 08:37:13 $
File Versie					: $Revision: 1.2 $

$Log: RapportTRANSFEE_L81.php,v $
Revision 1.2  2019/01/16 08:37:13  rvv
*** empty log message ***
...
class RapportTRANSFEE_L81
{
	function RapportTRANSFEE_L81($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		if(is_object($pdf))
		{
			$this->pdf = &$pdf;
