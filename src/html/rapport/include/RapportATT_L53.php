...
/*
Author  						: $Author: rvv $
Laatste aanpassing	: $Date: 2014/11/08 18:37:31 $
File Versie					: $Revision: 1.5 $

$Log: RapportATT_L53.php,v $
...
class RapportATT_L53
{
	function RapportATT_L53($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
 ...
 return number_format($getal,$decimaal,',','');
  ...
  $julEind = db2jul($datumEind);
    ...
    $categorieVerdeling=$this->categorieVolgorde;
      ...
      {
        $categorieVerdeling['ICP_Liq'] += $regel['actuelePortefeuilleWaardeEuro'];
      }
