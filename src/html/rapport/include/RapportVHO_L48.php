...
$Log: RapportVHO_L48.php,v $
Revision 1.6  2019/12/11 11:17:44  rvv
*** empty log message ***

Revision 1.5  2019/12/07 17:48:23  rvv
*** empty log message ***
...
Revision 1.2  2013/07/17 08:11:22  rvv
*** empty log message ***

Revision 1.1  2013/06/15 15:55:18  rvv
*** empty log message ***
...
class RapportVHO_L48
{
	function RapportVHO_L48($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
...
Left Join Fondsen as optie ON Fondsen.OptieBovenliggendFonds = optie.Fonds   
 ...
 //$this->pdf->SetFillColor($this->pdf->rapport_kop_bgcolor['r']*1.2,$this->pdf->rapport_kop_bgcolor['g']*1.2,$this->pdf->rapport_kop_bgcolor['b']*1.2);
    ...
    $ytm='';        
       ...
       // $totaalbegin=$fonds['historischeWaardeTotaalRapportageValuta'];
      ...
      $resultaat=$fonds['actuelePortefeuilleWaardeEuro'] - $fonds['historischeWaardeTotaalRapportageValuta'];
  		$procentResultaat = (($fonds['actuelePortefeuilleWaardeEuro'] - $fonds['historischeWaardeTotaalRapportageValuta']) / ($fonds['historischeWaardeTotaalRapportageValuta'] /100));
			if($fonds['historischeWaardeTotaalRapportageValuta'] < 0)
...
if($fonds['type']=='rekening')
{
  ...
  $fonds['historischeWaarde']=0;
         ...
         // listarray($fonds);
				$this->pdf->row(array('',//$fonds['regioOmschrijving'],
                          ...
                          $this->formatGetal($fonds['historischeWaarde'],2),
													$this->formatGetal($fonds['historischeWaardeTotaalRapportageValuta'],$this->pdf->rapport_VOLK_decimaal),
        ...
        $hcatTotaal['totaalbegin'] += $fonds['historischeWaardeTotaalRapportageValuta'];
