...
/*
Author  						: $Author: rvv $
Laatste aanpassing	: $Date: 2010/11/14 10:37:47 $
File Versie					: $Revision: 1.1 $

$Log: RapportOIS_L11.php,v $
...
class RapportOIS_L11
{
	function RapportOIS_L11($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
