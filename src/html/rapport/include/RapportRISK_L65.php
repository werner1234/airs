...
/*
    ...
    Author  						: $Author: rvv $
 		Laatste aanpassing	: $Date: 2018/07/21 15:54:40 $
 		File Versie					: $Revision: 1.3 $

 		$Log: RapportRISK_L65.php,v $
...
class RapportRISK_L65
{
  function RapportRISK_L65($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
  {
    $this->pdf = &$pdf;
...
$kleuren=array(array(51,102,204),array(255,153,0),array(120,170,0));
  ...
  function rechtsBoven($riskData)
  {
    ...
    $this->pdf->row(array('','Value at Risk',$this->formatGetal(100-$riskData['valueAtRisk'],1).'%',''));//'Value at Risk geeft het verwachte maximale verlies aan met een waarschijnlijkheid van 95%. De historische VaR is bepaald aan de hand van de werkelijke jaarlijkse rendementsverdeling over de afgelopen tien jaar.'
