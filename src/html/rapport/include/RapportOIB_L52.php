...
$Log: RapportOIB_L52.php,v $
Revision 1.3  2019/04/10 15:50:36  rvv
*** empty log message ***

Revision 1.2  2019/04/07 11:07:21  rvv
*** empty log message ***
...
class RapportOIB_L52
{
	function RapportOIB_L52($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
