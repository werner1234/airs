...
$Log: RapportTemplate_L104.php,v $
...
class RapportTemplate_L104
{
	function RapportTemplate_L104($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
	  global $__appvar;
		$this->pdf = &$pdf;
    ...
    $totPagina = ($lastpage-$startpagina+$paginaCorrectie);//-1
       ...
       $this->pdf->ln(10);
	     ...
	     $inhoudsItems=array('PERFPaginas'=>'Performance over de beleggingscategorieën',
                           ...
                           'HUISPaginas'=>'Disclaimer',
                           'ENDPaginas'=>'Verklarende woordenlijst',
