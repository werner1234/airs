...
include_once("rapport/include/layout_104/ATTberekening_L104.php");

class RapportPERF_L104
{

	function RapportPERF_L104($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
    ...
    $this->att=new ATTberekening_L104($this);
	}
...
function addResultaat()
{
  ...
  */
  ...
  $vetralingGrootboek=$this->getGrootboeken();
    ...
    $att=new ATTberekening_L104($this);
