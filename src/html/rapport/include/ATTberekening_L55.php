...
/*
    ...
    Author  						: $Author: rvv $
 		Laatste aanpassing	: $Date: 2019/03/09 18:45:47 $
 		File Versie					: $Revision: 1.16 $

 		$Log: ATTberekening_L55.php,v $
 ...
 */
class rapportHulp_L55
{
  function rapportHulp_L55()
  {
    $this->test='';
  }
}
...
class ATTberekening_L55
{

	function ATTberekening_L55($rapportData)
	{
  ...
  {
    $this->rapport = new rapportHulp_L55();
    $db=new DB();
