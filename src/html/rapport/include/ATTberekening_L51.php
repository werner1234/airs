...
/*
    ...
    Author  						: $Author: rvv $
 		...
 		$Log: ATTberekening_L51.php,v $
 		Revision 1.2  2019/03/09 18:46:18  rvv
 		*** empty log message ***
 		
 		Revision 1.1  2019/01/20 12:14:00  rvv
 		*** empty log message ***
...
class ATTberekening_L51
{

	function ATTberekening_L51($rapportData)
	{
...
ORDER BY HoofdBeleggingscategorien.Afdrukvolgorde,Beleggingscategorien.Afdrukvolgorde,Fondsen.Omschrijving ";
        ...
        $perCategorie[$data['Beleggingscategorie']]['Beleggingscategorie']=$data['Beleggingscategorie'];
...
//echo $fondsData['Hoofdcategorie']." ".round($performance*100,2)."= ((($eindwaarde - $beginwaarde) - ". $AttributieStortingenOntrekkingen['totaal'].") / $gemiddelde) <br>\n";
      ...
      $indexData=$this->indexPerformance($fondsData['Beleggingscategorie'],$datumBegin,$datumEind);
    ...
    //  listarray($fondsData);
//echo  $fondsData['Beleggingscategorie']." $weging=$gemiddelde/$totaalGemiddelde <br>\n";
