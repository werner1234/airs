...
class RapportPERFG_L32
{
	function RapportPERFG_L32($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
...
$grafiekData['Datum'][]="$RapStartJaar-12-01";
    ...
    */
    $meerjaren=true;
        ...
        if($meerjaren==true)
        {
          $this->VBarDiagram2(120, 60, $jaarGrafiek, true,true);
        }
        else
        {
