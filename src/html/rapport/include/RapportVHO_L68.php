...
$Log: RapportVHO_L68.php,v $
Revision 1.46  2020/03/25 16:43:07  rvv
*** empty log message ***

Revision 1.45  2019/09/28 17:20:17  rvv
*** empty log message ***

Revision 1.44  2019/09/18 14:52:23  rvv
*** empty log message ***

Revision 1.43  2019/09/11 15:48:05  rvv
*** empty log message ***

Revision 1.42  2019/08/25 11:29:05  rvv
*** empty log message ***

Revision 1.41  2019/08/24 16:59:19  rvv
*** empty log message ***

Revision 1.40  2019/08/21 10:41:17  rvv
*** empty log message ***

Revision 1.39  2019/06/30 11:29:43  rvv
*** empty log message ***

Revision 1.38  2019/06/29 18:24:12  rvv
*** empty log message ***

Revision 1.37  2019/04/10 15:50:36  rvv
*** empty log message ***

Revision 1.36  2019/02/09 18:40:17  rvv
*** empty log message ***

Revision 1.35  2019/01/23 16:27:16  rvv
*** empty log message ***

Revision 1.34  2019/01/19 13:54:10  rvv
*** empty log message ***

Revision 1.33  2019/01/05 18:38:35  rvv
*** empty log message ***

Revision 1.32  2018/11/24 19:11:26  rvv
*** empty log message ***

Revision 1.31  2018/09/02 12:02:03  rvv
*** empty log message ***

Revision 1.30  2018/08/18 12:40:15  rvv
php 5.6 & consolidatie

Revision 1.29  2018/08/04 11:54:53  rvv
*** empty log message ***

Revision 1.28  2018/07/28 14:45:48  rvv
*** empty log message ***

Revision 1.27  2018/06/27 16:13:50  rvv
*** empty log message ***

Revision 1.26  2018/06/21 05:59:23  rvv
*** empty log message ***

Revision 1.25  2018/06/20 16:40:16  rvv
*** empty log message ***

Revision 1.24  2018/05/28 05:44:27  rvv
*** empty log message ***

Revision 1.23  2018/05/26 17:23:51  rvv
*** empty log message ***

Revision 1.22  2018/04/14 17:23:49  rvv
*** empty log message ***

Revision 1.21  2018/02/05 07:07:44  rvv
*** empty log message ***

Revision 1.20  2018/02/04 15:47:35  rvv
*** empty log message ***

Revision 1.19  2017/12/02 19:13:32  rvv
*** empty log message ***

Revision 1.18  2017/10/11 14:57:30  rvv
*** empty log message ***

Revision 1.17  2017/09/17 15:03:24  rvv
*** empty log message ***

Revision 1.16  2017/09/13 15:45:00  rvv
*** empty log message ***

Revision 1.15  2017/09/09 18:01:12  rvv
*** empty log message ***
...
class RapportVHO_L68
{
	function RapportVHO_L68($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
...
//listarray($this->waarden['historie']);
        ...
        $index = ((1 + ($laatsteIndex / 100)) * (1 + ($data['procent'] / 100)) - 1) * 100;
        $data['index'] = $index;
        $laatsteIndex=$index;// ;
...
//listarray($data);
   ...
   if(count($periodeWaarden[$verdeling]) > 0)
   {
       ...
       // $this->pdf->SetFillColor(221,224,229);
          ...
          if($verdeling=='kwartaal')
          {
            if(isset($laatsteJaar)&& $laatsteJaar<>$jaar)//
            {
              ...
              $this->pdf->ln(1);
							//if($laatsteJaar>$rapportageJaar-2)
     ...
     $this->pdf->CellBorders = array('','UU','UU','UU','UU','UU','UU','UU',$benchmarkSub,'','UU');
        ...
        $this->LineDiagram(270-50, 30, $grafiekData,array($this->pdf->rapport_grafiek_pcolor,$this->pdf->rapport_grafiek_icolor),0,0,6,5,false);//50
    ...
    $maxVal=100;
      foreach ($data as $datum=>$waarden)
      {
        ...
        foreach ($waarden as $categorie=>$waarde)
        {
          ...
          if(!isset($colors[$categorie]) && isset($this->categorieVolgorde[$categorie]))
