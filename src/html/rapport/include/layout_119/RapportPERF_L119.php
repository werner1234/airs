...
include_once("rapport/include/layout_119/ATTberekening_L119.php");

class RapportPERF_L119
{

	function RapportPERF_L119($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
    ...
    $this->att=new ATTberekening_L119($this);
	}
...
function addResultaat()
{
  ...
  $vetralingGrootboek=$this->getGrootboeken();
    ...
    $att=new ATTberekening_L119($this);
