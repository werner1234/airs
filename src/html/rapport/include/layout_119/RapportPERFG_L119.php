...
$Log: RapportPERFG_L119.php,v $
Revision 1.3  2020/03/25 16:43:07  rvv
*** empty log message ***
...
class RapportPERFG_L119
{
	function RapportPERFG_L119($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
