...
/*
    ...
    Author  						: $Author: rvv $
 		...
 		$Log: RapportVOLK_L20.php,v $
 		Revision 1.51  2017/05/31 16:09:43  rvv
 		*** empty log message ***
 		
 		Revision 1.50  2015/12/19 08:29:17  rvv
 		*** empty log message ***
 		
 		Revision 1.49  2012/07/29 10:24:33  rvv
 		*** empty log message ***
 		
 		Revision 1.48  2011/09/14 09:26:56  rvv
 		*** empty log message ***

 		Revision 1.47  2010/07/31 16:07:40  rvv
 		*** empty log message ***

 		Revision 1.46  2010/07/30 06:57:09  rvv
 		*** empty log message ***

 		Revision 1.45  2010/07/14 17:33:49  rvv
 		*** empty log message ***

 		Revision 1.44  2010/06/16 19:15:03  rvv
 		*** empty log message ***

 		Revision 1.41  2010/01/09 13:04:02  rvv
 		*** empty log message ***

 		Revision 1.40  2009/12/20 14:36:33  rvv
 		*** empty log message ***

 		Revision 1.39  2009/12/06 15:59:00  rvv
 		*** empty log message ***

 		Revision 1.38  2009/11/04 16:14:36  rvv
 		*** empty log message ***

 		Revision 1.37  2009/08/12 12:32:52  rvv
 		*** empty log message ***

 		Revision 1.36  2009/07/06 07:15:25  cvs
 		*** empty log message ***

 		Revision 1.35  2009/06/21 18:24:27  rvv
 		*** empty log message ***

 		Revision 1.34  2009/04/15 08:24:29  rvv
 		*** empty log message ***

 		Revision 1.33  2009/04/11 14:31:42  rvv
 		*** empty log message ***

 		Revision 1.32  2009/03/27 14:30:53  cvs
 		*** empty log message ***

 		Revision 1.31  2009/03/27 14:21:43  cvs
 		*** empty log message ***

 		Revision 1.30  2009/03/21 13:49:43  rvv
 		*** empty log message ***

 		Revision 1.29  2009/03/18 11:06:06  rvv
 		*** empty log message ***

 		Revision 1.28  2009/03/18 08:23:42  rvv
 		*** empty log message ***

 		Revision 1.27  2009/03/17 11:10:31  cvs
 		regel 1491
 		$gemiddelde = $beginwaarde +
 		gewijzigd in
 		$gemiddelde = $beginwaarde -

 		Revision 1.26  2009/03/14 11:43:24  rvv
 		tijdelijke rapportage cleanup aangepast

 		Revision 1.25  2009/03/13 14:58:42  rvv
 		*** empty log message ***

 		Revision 1.24  2009/03/13 13:51:57  rvv
 		*** empty log message ***

 		Revision 1.23  2009/03/11 20:27:02  rvv
 		*** empty log message ***

 		Revision 1.22  2009/03/07 15:54:03  rvv
 		*** empty log message ***

 		Revision 1.21  2009/03/04 16:44:23  rvv
 		*** empty log message ***

 		Revision 1.20  2009/02/28 16:43:08  rvv
 		*** empty log message ***

 		Revision 1.19  2009/02/21 11:02:29  rvv
 		*** empty log message ***

 		Revision 1.18  2009/02/19 05:52:14  rvv
 		*** empty log message ***

 		Revision 1.17  2009/02/18 19:18:06  rvv
 		*** empty log message ***

 		Revision 1.16  2009/02/17 15:54:41  cvs
 		index percentages aanpassen

 		Revision 1.15  2009/02/15 11:54:15  rvv
 		*** empty log message ***

 		Revision 1.14  2009/02/14 11:27:23  cvs
 		*** empty log message ***

 		Revision 1.13  2009/02/07 16:34:38  rvv
 		*** empty log message ***

 		Revision 1.12  2009/02/05 17:58:40  rvv
 		*** empty log message ***

 		Revision 1.11  2009/02/05 15:54:07  cvs
 		*** empty log message ***

 		Revision 1.10  2009/01/31 16:42:38  rvv
 		*** empty log message ***

 		Revision 1.9  2009/01/28 17:30:32  rvv
 		*** empty log message ***

 		Revision 1.7  2009/01/27 18:11:58  rvv
 		*** empty log message ***

 		Revision 1.6  2009/01/25 15:15:53  rvv
 		*** empty log message ***

 		Revision 1.5  2009/01/18 15:37:48  rvv
 		*** empty log message ***

 		Revision 1.4  2009/01/17 17:02:31  rvv
 		*** empty log message ***

 		Revision 1.2  2008/12/23 09:16:27  rvv
 		*** empty log message ***
...
class RapportVOLK_L20
{
	function RapportVOLK_L20($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
	  ...
	  $this->pdf->rapport_titel = "Overzicht beleggingen.";
		...
		$this->pdf->rapport_header1 = array('Beheerder',"Aantal","Koers",'Bewaarder',"Regio","Waarde\nlocale valuta\n".date("d-m-y",$this->pdf->rapport_datum),"Waarde\nEUR\n".date("d-m-y",$this->pdf->rapport_datum),
		"Procentuele\nverdeling","Waarde locale valuta\n".date("d-m-y",$this->pdf->rapport_datumvanaf),"Waarde\nEUR\n".date("d-m-y",$this->pdf->rapport_datumvanaf));

		$this->pdf->rapport_header2 = array('Beheerder',"Totaal\nmutaties\nEUR","Stortingen/\nonttrekkingen\nEUR","Beleggings-\nresultaat\nEUR","Beleggings-\nresultaat\n%",//%-bijdrage\ntotaal\nresultaat
		""," ","stortingen en\nonttr.dit jaar\nEUR","Resultaat\ndit jaar\nEUR","Resultaat\ndit jaar\n%");
	  ...
	  foreach ($this->perioden as $periode)
	  {
	    ...
	    $query = "SELECT TijdelijkeRapportage.fondsOmschrijving,
      	       ...
      	       $DB->SQL($query);
		           ...
		           while($data = $DB->NextRecord())
		           {
		            $this->waarden[$periode][$data['beleggingscategorie']][$data['fonds']]= $data;
		...
		$query = "SELECT TijdelijkeRapportage.fondsOmschrijving, ".
			...
			" AND TijdelijkeRapportage.rapportageDatum = '$periode' "
			.$__appvar['TijdelijkeRapportageMaakUniek'].
		...
		if($DB1->records() > 0)
		{
         ...
         $rekeningCategorien[$data['beleggingscategorie']]=$data['beleggingscategorie'];
		            ...
		            $this->waarden[$periode][$data['beleggingscategorie']][$data['rekening']]= $data;
    ...
    $fondsMutaties=$mutaties['jaar'];
	  ...
	  foreach ($this->perioden as $key=>$datum)
	  {
	    ...
	    foreach ($fondsMutaties as $fonds=>$mutatieData)
	    {
	      ...
	      {
	        $query="SELECT BeleggingscategoriePerFonds.Beleggingscategorie,Fondsen.Omschrijving
	                FROM BeleggingscategoriePerFonds JOIN Fondsen ON Fondsen.Fonds = BeleggingscategoriePerFonds.Fonds
		      ...
		      {
  		      $this->waarden[$datum][$categorie['Beleggingscategorie']][$fonds]= array('fonds'=>$fonds);
...
//exit;
  ...
  $query = "SELECT Indices.Beursindex, Indices.specialeIndex, Fondsen.Omschrijving,BeleggingscategoriePerFonds.Beleggingscategorie
...
//supercategorie
                ...
                if($this->waarden[$this->perioden['eind']][$categorie][$fonds]['actuelePortefeuilleWaardeEuro'] <> 0 ||
                   $this->waarden[$this->perioden['start']][$categorie][$fonds]['actuelePortefeuilleWaardeEuro'] <> 0)
       ...
       switch ($categorie)
       {
         case "overzicht":
           ...
           $this->pdf->row(array($data[1]['omschrijving'],
                           ...
                           $data[1]['bewaarder'],
                           $data[1]['regio'],
                           $this->formatGetal($data[1]['actuelePortefeuilleWaardeInValuta'],0),
                           $this->formatGetal($data[1]['actuelePortefeuilleWaardeEuro'],0),
                           $this->formatGetal($data[1]['perc'],1,true,$limit),
                           $this->formatGetal($data[1]['janWaardeVal'],0),
...
//                   {
//                     $this->pdf->SetFont($this->pdf->rapport_font,'i',$this->pdf->rapport_fontsize);
//                     $this->pdf->row(array("  ".$categorieOmschrijving[$categorie],'','',''));
//                   }
                  $this->pdf->SetFont($this->pdf->rapport_font,'',$this->pdf->rapport_fontsize);
                  foreach ($fondsData as $fonds=>$waarden)
                  {
                    ...
                    if($type=='speciale')
                      $this->pdf->row(array("  ".$this->fondsOmschrijvingen[$fonds],$this->formatGetal($waarden['kwartaal'],1,true),$this->formatGetal($waarden['jaar'],1,true),$this->formatGetal($waarden['driejaar'],1,true)));
                    else
                       $this->pdf->row(array('',"  ".$this->fondsOmschrijvingen[$fonds],$this->formatGetal($waarden['kwartaal'],1,true),$this->formatGetal($waarden['jaar'],1,true),$this->formatGetal($waarden['driejaar'],1,true)));
                  }
                }
