...
class RapportPERF_L36
{

	function RapportPERF_L36($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
    ...
    $totaalKosten=0;
		...
		{
      if($kosten['Grootboekrekening'] == "VALK")
        $kosten['Grootboekrekening'] = "KOBU";
		  
      if($kosten['Grootboekrekening'] == "KNBA")
      {
        $kosten['Omschrijving'] = "Bankkosten en provisie";
      }
      if($kosten['Grootboekrekening']=='KOBU')
      {
        $kosten['Omschrijving'] = 'Valuta- en overige kosten depotbank';
      }
