...
class RapportHSE_L50
{
	function RapportHSE_L50($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
    ...
    $this->pdf->excelData[]=array('Hoofdcategorie','Categorie','Fonds','Valuta',date('d-m-Y',$this->pdf->rapport_datumvanaf),
...
ORDER BY HoofdBeleggingscategorien.Afdrukvolgorde, Regios.Afdrukvolgorde,FondsOmschrijving ";
...
$this->pdf->excelData[]=array($hoofdcategorie,
$categorie,
...
$data['resultaat'],
$data['gemWaarde'],
$data['resultaat']/$data['gemWaarde']*100,
$data['weging']*100,
$data['bijdrage']*100);                        
