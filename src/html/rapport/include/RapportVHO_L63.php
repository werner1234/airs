...
class RapportVHO_L63
{
	function RapportVHO_L63($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
  ...
  function addHeader($categorie)
  {
    ...
    $this->pdf->row(array(" \n ","Aantal\n ","Koers\n ","Valuta\n ","Actuele Waarde\n ","Kostprijs (historisch)","Resultaat\n ","Resultaat/\nKostprijs","Belang\n "," \n "));
...
SUM(IF(TijdelijkeRapportage.type = 'rente' , (actuelePortefeuilleWaardeEuro)/".$this->pdf->ValutaKoersEind.",0)) AS rente,
SUM(TijdelijkeRapportage.actuelePortefeuilleWaardeEuro) /".$this->pdf->ValutaKoersEind." AS actuelePortefeuilleWaardeEuro,
 SUM(IF(TijdelijkeRapportage.type = 'fondsen',(TijdelijkeRapportage.totaalAantal * TijdelijkeRapportage.historischeWaarde * TijdelijkeRapportage.historischeValutakoers * TijdelijkeRapportage.fondsEenheid / TijdelijkeRapportage.historischeRapportageValutakoers),0
