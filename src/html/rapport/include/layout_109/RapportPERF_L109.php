...
include_once("rapport/include/layout_109/ATTberekening_L109.php");

class RapportPERF_L109
{
  
  function RapportPERF_L109($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
  {
    $this->pdf = &$pdf;
    ...
    $this->att=new ATTberekening_L109($this);
  }
