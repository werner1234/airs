...
class RapportOIB_L109
{
	function RapportOIB_L109($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
...
//$this->pdf->setXY(175,40);
    ...
    {
      include_once('');
      include_once($__appvar["basedir"]."/html/rapport/include/RapportDOORKIJK_L109.php");
      $doorkijk=new RapportDOORKIJK_L109( $this->pdf,$this->portefeuille,  $this->rapportageDatumVanaf,  $this->rapportageDatum);
      //listarray($kleurdata);
      $kleur=array();
