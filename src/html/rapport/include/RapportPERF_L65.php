...
$Log: RapportPERF_L65.php,v $
Revision 1.16  2020/07/25 15:36:13  rvv
*** empty log message ***

Revision 1.15  2020/04/04 17:43:15  rvv
*** empty log message ***
...
class RapportPERF_L65
{

	function RapportPERF_L65($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
...
//listarray($grafiekData);
    ...
    $this->pdf->setXY(180,48);
		...
		$this->LineDiagram(100, 50, $grafiekData, $color, $maxVal=0, $minVal=0, $horDiv=4, $verDiv=4,true);
	}
