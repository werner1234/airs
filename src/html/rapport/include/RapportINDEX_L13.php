...
include_once($__appvar["basedir"]."/html/rapport/include/ATTberekening_L13.php");

class RapportINDEX_L13
{

  function RapportINDEX_L13($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
  {
    $this->pdf = &$pdf;
  ...
  function writeRapport()
  {
    ...
    else
    {
      ...
      $indexWaarden = $this->att->getPerf($this->portefeuille, $start,$eind, $this->pdf->portefeuilledata['RapportageValuta'], true);
    ...
    if(count($rendamentWaardenTabel) > 0)
    {
      ...
      $this->pdf->SetFillColor(39,62,102);
    ...
    if($this->pdf->getY()>120 || count($rendamentWaardenTabel)>22)
    {
      $this->pdf->addPage();
...
//$color=array(184,134,17);
    ...
    $this->VBarDiagram(120,50,$grafiekData,'',$color);
