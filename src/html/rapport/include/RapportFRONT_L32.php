...
/*
Author  						: $Author: rvv $
Laatste aanpassing	: $Date: 2017/06/10 18:09:58 $
File Versie					: $Revision: 1.3 $

$Log: RapportFRONT_L32.php,v $
...
class RapportFront_L32
{
	function RapportFront_L32($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
   ...
   //background
    ...
    $this->pdf->AddPage('L');
   	...
   	$this->pdf->widthA = array(30,180);
		...
		//$this->pdf->SetXY(297-100-$this->pdf->marge,$this->pdf->marge);
		//$this->pdf->SetFont($this->pdf->rapport_font,'',$fontsize);
		//$this->pdf->MultiCell(100	,4,$this->pdf->portefeuilledata['Portefeuille'],0, "R");
   ...
   // $this->pdf->ln();
    ...
    //$this->pdf->rapport_type = "INHOUD";
	  ...
	  $this->pdf->addPage('L');
		...
		$this->pdf->SetXY(0,24);
		$this->pdf->MultiCell(297,4,vertaalTekst($this->pdf->rapport_titel,$this->pdf->rapport_taal),0,'C');
