...
Revision 1.1  2016/08/21 08:52:52  rvv
*** empty log message ***
...
class RapportRISK_L51
{
	function RapportRISK_L51($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
