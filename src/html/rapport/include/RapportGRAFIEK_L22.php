...
/*
    ...
    Author  						: $Author: rvv $
 		...
 		$Log: RapportGRAFIEK_L22.php,v $
 		Revision 1.2  2013/05/01 15:53:08  rvv
 		*** empty log message ***
...
class RapportGRAFIEK_L22
{
	function RapportGRAFIEK_L22($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
