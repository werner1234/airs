...
Revision 1.4  2018/07/14 14:05:14  rvv
*** empty log message ***
...
class RapportMUT_L75
{
	function RapportMUT_L75($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
		...
		if ($this->pdf->rapportageValuta != 'EUR' && $this->pdf->rapportageValuta != '')
		  $this->pdf->rapport_titel .= " ". vertaalTekst("in",$this->pdf->rapport_taal)." ".$this->pdf->rapportageValuta;
