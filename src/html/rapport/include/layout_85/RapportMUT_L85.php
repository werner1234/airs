...
/*
Author  						: $Author: rvv $
Laatste aanpassing	: $Date: 2020/03/18 17:48:48 $
File Versie					: $Revision: 1.2 $

$Log: RapportMUT_L85.php,v $
Revision 1.2  2020/03/18 17:48:48  rvv
*** empty log message ***
...
class RapportMUT_L85
{
	function RapportMUT_L85($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
