...
/*
Author  						: $Author: rvv $
Laatste aanpassing	: $Date: 2020/01/22 16:12:45 $
File Versie					: $Revision: 1.2 $

$Log: RapportFRONT_L85.php,v $
Revision 1.2  2020/01/22 16:12:45  rvv
*** empty log message ***
...
class RapportFront_L85
{
	function RapportFront_L85($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
   ...
   //background
    ...
    $this->pdf->ln();
    $this->pdf->row(array(' ',vertaalTekst('Beleggingsprofiel',$this->pdf->rapport_taal),':',vertaalTekst($this->pdf->portefeuilledata['Risicoklasse'],$this->pdf->rapport_taal)));
    $this->pdf->ln();
