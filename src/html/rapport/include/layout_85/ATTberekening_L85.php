...
class rapportHulp_L85
{
  function rapportHulp_L85()
  {
    $this->test='';
  }
}
...
class ATTberekening_L85
{

	function ATTberekening_L85($rapportData,$periode='jaar')
	{
  ...
  {
    $this->rapport = new rapportHulp_L85();
    $db=new DB();
