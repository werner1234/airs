...
/* 	
    ...
    Author  						: $Author: rvv $
 		Laatste aanpassing	: $Date: 2020/01/04 18:56:57 $
 		File Versie					: $Revision: 1.6 $
 		
 		$Log: PDFRapport_headers_L85.php,v $
 		...
 		*** empty log message ***
 		...
 		Revision 1.3  2019/10/23 13:34:56  rvv
 		*** empty log message ***
...
*/
function Header_basis_L85($object)
{
 $pdfObject = &$object;
    ...
    {  
	  ...
	  $pdfObject->SetXY($pdfObject->marge,$y);
		...
		$pdfObject->ln(4);
    $pdfObject->SetX(0);
		$pdfObject->MultiCell(297,4,"\n".vertaalTekst($pdfObject->rapport_titel,$pdfObject->rapport_taal),0,'C');
		
		$pdfObject->SetY($y+13);
    $pdfObject->headerStart=$pdfObject->GetY()+18;

    $pdfObject->lastPortefeuille=$pdfObject->portefeuilledata['Portefeuille'];
    }
}

	function HeaderVKM_L85($object)
	{
		$pdfObject = &$object;
		$pdfObject->HeaderVKM();
	}
...
function HeaderVKMS_L85($object)
{
  $pdfObject = &$object;
  $pdfObject->ln(16);
}
	  ...
	  function HeaderFRONT_L85($object)
	  {
	    $pdfObject = &$object;
	    //$pdfObject->headerSCENARIO();

	  }
	  function HeaderSCENARIO_L85($object)
	  {
	    $pdfObject = &$object;
			$pdfObject->Ln();
...
function HeaderHSE_L85($object)
{
	...
	$pdfObject->ln();
	  ...
	  function HeaderDOORKIJK_L85($object)
{
  $pdfObject = &$object;
  $pdfObject->Ln();
  $pdfObject->SetFillColor($pdfObject->rapport_kop_bgcolor['r'],$pdfObject->rapport_kop_bgcolor['g'],$pdfObject->rapport_kop_bgcolor['b']);
...
function HeaderDOORKIJKVR_L85($object)
{
  $pdfObject = &$object;
  $pdfObject->Ln();
  $pdfObject->SetFillColor($pdfObject->rapport_kop_bgcolor['r'],$pdfObject->rapport_kop_bgcolor['g'],$pdfObject->rapport_kop_bgcolor['b']);
  ...
  $pdfObject->Ln(10);
    ...
    function HeaderRISK_L85($object)
    {
	    $pdfObject = &$object;
			$pdfObject->Ln();
			$pdfObject->SetFillColor($pdfObject->rapport_kop_bgcolor['r'],$pdfObject->rapport_kop_bgcolor['g'],$pdfObject->rapport_kop_bgcolor['b']);
    ...
    function HeaderGRAFIEK_L85($object)
    {
	    $pdfObject = &$object;
    }

    function HeaderEND_L85($object)
    {
     	$pdfObject = &$object;
			$pdfObject->Ln();
			$pdfObject->SetFillColor($pdfObject->rapport_kop_bgcolor['r'],$pdfObject->rapport_kop_bgcolor['g'],$pdfObject->rapport_kop_bgcolor['b']);
    ...
    function HeaderPERFD_L85($object)
    {
      $pdfObject = &$object;
      HeaderPERF_L85($object);
      $pdfObject->SetTextColor($pdfObject->rapport_fontcolor['r'],$pdfObject->rapport_fontcolor['g'],$pdfObject->rapport_fontcolor['b']);
    }
  
    
    function HeaderTRANS_L85($object)
	  {
	    $pdfObject = &$object;
    	$pdfObject->SetFont($pdfObject->rapport_font,$pdfObject->rapport_kop_fontstyle,$pdfObject->rapport_fontsize);
  		$pdfObject->SetX(100);
...
$pdfObject->ln(2);
	  ...
	  function HeaderINHOUD_L85($object)
	  {
	    $pdfObject = &$object;
	    //$pdfObject->headerSCENARIO();

	  }	  
 	  function HeaderPERF_L85($object)
	  {
	    $pdfObject = &$object;
      $pdfObject->ln();
      $pdfObject->SetFillColor($pdfObject->rapport_kop_bgcolor['r'],$pdfObject->rapport_kop_bgcolor['g'],$pdfObject->rapport_kop_bgcolor['b']);
...
$pdfObject->ln();
    ...
    function HeaderINDEX_L85($object)
	  {
	    $pdfObject = &$object;
	  }
    function HeaderOIB_L85($object)
	  {
	    $pdfObject = &$object;
      $pdfObject->Ln();
   //		$pdfObject->SetFillColor($pdfObject->rapport_kop_bgcolor['r'],$pdfObject->rapport_kop_bgcolor['g'],$pdfObject->rapport_kop_bgcolor['b']);
...
*/
   ...
   function HeaderPERFG_L85($object)
	{
    $pdfObject = &$object;
...
*/
  ...
  function HeaderVOLK_L85($object)
	{
    $pdfObject = &$object;
   	$pdfObject->ln();
		$pdfObject->SetFont($pdfObject->rapport_font,$pdfObject->rapport_kop_fontstyle,$pdfObject->rapport_fontsize);
