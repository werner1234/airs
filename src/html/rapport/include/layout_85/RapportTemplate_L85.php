...
/*
Author  						: $Author: rvv $
Laatste aanpassing	: $Date: 2020/01/15 16:42:52 $
File Versie					: $Revision: 1.5 $

$Log: RapportTemplate_L85.php,v $
Revision 1.5  2020/01/15 16:42:52  rvv
*** empty log message ***

Revision 1.4  2019/12/14 17:49:52  rvv
*** empty log message ***

Revision 1.3  2019/11/13 15:44:54  rvv
*** empty log message ***

Revision 1.2  2019/11/13 15:30:11  rvv
*** empty log message ***
...
class RapportTemplate_L85
{
	function RapportTemplate_L85($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
	  global $__appvar;
		$this->pdf = &$pdf;
    ...
    $totPagina = ($lastpage-$startpagina+$paginaCorrectie);//-1
       ...
       $this->pdf->ln(10);
	     ...
	     $inhoudsItems=array('PERFPaginas'=>'Performance over de beleggingscategorieën',
                           ...
                           'FACTUURPaginas'=>'Factuur',
                           'TRANSPaginas'=>'Transactie-overzicht',
													 'ENDPaginas'=>'Geschiktheidsrapportage',
													 'SCENARIOPaginas'=>'Scenario-analyse',
