...
/*
Author  						: $Author: rvv $
Laatste aanpassing	: $Date: 2019/08/31 12:20:52 $
File Versie					: $Revision: 1.2 $

$Log: RapportATT_L85.php,v $
...
class RapportATT_L85
{
	function RapportATT_L85($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
           ...
           foreach($perioden as $periode)
           {
                               ...
                               if($periode=='kwartaal')
                               {
                                 ...
                                 $totaal[$periode]['Rendament'] = $qPerf;
		                             ...
		                             $totaal[$periode]['Rendament'] = $perfCumu;
           }
		    $n++;
        $i++;
     ...
     //   $this->pdf->ln(3);
        ...
        $this->pdf->CellBorders = array();
		    $this->pdf->row(array(vertaalTekst('Totaal',$this->pdf->rapport_taal),
		                           ...
		                           '',
		                           $this->formatGetal($totaal['jaar']['Rendament'],2)
