...
$Log: RapportDOORKIJKVR_L85.php,v $
Revision 1.4  2020/02/29 16:23:08  rvv
*** empty log message ***

Revision 1.3  2019/09/07 16:08:58  rvv
*** empty log message ***

Revision 1.2  2019/09/04 15:32:24  rvv
*** empty log message ***
...
class RapportDOORKIJKVR_L85
{
	function RapportDOORKIJKVR_L85($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = $pdf;
...
AND KeuzePerVermogensbeheerder.categorie = 'Beleggingscategorien' AND CategorienPerHoofdcategorie.Hoofdcategorie='H-Obl'";
		$db->SQL($query);
		$db->Query();
