...
$Log: RapportVOLK_L85.php,v $
Revision 1.3  2019/11/13 15:30:11  rvv
*** empty log message ***

Revision 1.2  2019/11/02 15:26:12  rvv
*** empty log message ***
...
class RapportVOLK_L85
{
	function RapportVOLK_L85($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
  ...
  //F $procentResultaat);
			...
			if($totaalF <>0) //$procentResultaat
				$this->printCol(14,$this->formatGetal($totaalF,1),"subtotaal");
			...
			$subquery = "SELECT TijdelijkeRapportage.fondsOmschrijving, ".
				...
				" TijdelijkeRapportage.actueleFonds,
				 ...
				 TijdelijkeRapportage.valuta, TijdelijkeRapportage.portefeuille,
				  if(Fondsen.OptieBovenliggendFonds <> '',Fondsen.OptieBovenliggendFonds,TijdelijkeRapportage.fonds) as primairFonds".
				" FROM TijdelijkeRapportage
				JOIN Fondsen ON TijdelijkeRapportage.fonds=Fondsen.Fonds WHERE ".
				...
				.$__appvar['TijdelijkeRapportageMaakUniek'].
				" ORDER BY TijdelijkeRapportage.Lossingsdatum, primairFonds,Fondsen.OptieBovenliggendFonds, TijdelijkeRapportage.fondsOmschrijving asc";//exit;
...
//echo $subquery."<br><br>";exit;
      ...
      $kopPrinted=false;
        ...
        $dividendtxt='';
				...
				if($subdata['Fondssoort']=='OPT')
          $subdata['fondsOmschrijving']=$subdata['fonds'];
...
//echo $this->pdf->getY().' ';
		if($startY<$this->pdf->getY())
			$this->pdf->setY($startY+2);
	//	echo $startY;exit;
		include_once("rapport/include/layout_85/RapportPERF_L85.php");
		$perf=new RapportPERF_L85($this->pdf,$this->portefeuille,$this->rapportageDatumVanaf ,$this->rapportageDatum );
    $perf->indexVergelijking();
