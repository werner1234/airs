...
/* 	
    ...
    Author  						: $Author: rvv $
 		...
 		$Log: PDFRapport_headers_L97.php,v $


*/
function Header_basis_L97($object)
{
 $pdfObject = &$object;
    ...
    elseif ($pdfObject->rapport_type == "FRONT")
    {
      ...
      $pdfObject->Rect($pdfObject->marge, $pdfObject->getY()+13, 297-$pdfObject->marge*2, 8, 'F');
      $pdfObject->Rect($pdfObject->marge, $pdfObject->h-16,$pdfObject->w-$pdfObject->marge*2, 0.5 , 'F');
    ...
    {  
     ...
     // $pdfObject->memImage($pdfObject->logoString,(297/2)-($pdfObject->logoSize/2),4,$pdfObject->logoSize);
    ...
    $pdfObject->SetLineWidth(0.1);
	  ...
	  function HeaderFRONT_L97($object)
	  {
	    $pdfObject = &$object;
	    //$pdfObject->headerSCENARIO();

	  }
	  function HeaderSCENARIO_L97($object)
	  {
	    $pdfObject = &$object;
	    //$pdfObject->headerSCENARIO();
    ...
    function HeaderKERNV_L97($object)
    {
      $pdfObject = &$object;
      $pdfObject->Ln();
      $pdfObject->SetFillColor($pdfObject->rapport_kop_bgcolor['r'],$pdfObject->rapport_kop_bgcolor['g'],$pdfObject->rapport_kop_bgcolor['b']);
    ...
    function HeaderRISK_L97($object)
    {
	    $pdfObject = &$object;
			$pdfObject->Ln();
			$pdfObject->SetFillColor($pdfObject->rapport_kop_bgcolor['r'],$pdfObject->rapport_kop_bgcolor['g'],$pdfObject->rapport_kop_bgcolor['b']);
    ...
    function HeaderGRAFIEK_L97($object)
    {
	    $pdfObject = &$object;
    }

    function HeaderEND_L97($object)
    {
     	$pdfObject = &$object;
			$pdfObject->Ln();
			$pdfObject->SetFillColor($pdfObject->rapport_kop_bgcolor['r'],$pdfObject->rapport_kop_bgcolor['g'],$pdfObject->rapport_kop_bgcolor['b']);
    ...
    function HeaderPERFD_L97($object)
    {
      $pdfObject = &$object;
    ...
    function HeaderTRANS_L97($object)
	  {
	    $pdfObject = &$object;
...
$pdfObject->ln(2);
	  ...
	  function HeaderINHOUD_L97($object)
	  {
	    $pdfObject = &$object;
	    //$pdfObject->headerSCENARIO();

	  }	  
 	  function HeaderPERF_L97($object)
	  {
	    $pdfObject = &$object;
      $pdfObject->ln();
      $pdfObject->SetFillColor($pdfObject->rapport_kop_bgcolor['r'],$pdfObject->rapport_kop_bgcolor['g'],$pdfObject->rapport_kop_bgcolor['b']);
...
$pdfObject->ln();
    ...
    function HeaderINDEX_L97($object)
	  {
	    $pdfObject = &$object;
	  }

function HeaderDOORKIJK_L97($object)
{
  $pdfObject = &$object;
  $pdfObject->Ln();
  $pdfObject->SetFillColor($pdfObject->rapport_kop_bgcolor['r'],$pdfObject->rapport_kop_bgcolor['g'],$pdfObject->rapport_kop_bgcolor['b']);
...
function HeaderDOORKIJKVR_L97($object)
{
  $pdfObject = &$object;
  $pdfObject->Ln();
  $pdfObject->SetFillColor($pdfObject->rapport_kop_bgcolor['r'],$pdfObject->rapport_kop_bgcolor['g'],$pdfObject->rapport_kop_bgcolor['b']);
...
*/
   ...
   function HeaderPERFG_L97($object)
	{
    $pdfObject = &$object;
...
*/
  ...
  function HeaderVOLK_L97($object)
	{
    $pdfObject = &$object;
   	$pdfObject->ln();
		$pdfObject->SetFont($pdfObject->rapport_font,$pdfObject->rapport_kop_fontstyle,$pdfObject->rapport_fontsize);
