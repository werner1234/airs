...
class RapportTemplate_L97
{
	function RapportTemplate_L97($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
	  global $__appvar;
		$this->pdf = &$pdf;
    ...
    $totPagina = ($lastpage-$startpagina+$paginaCorrectie);//-1
       ...
       $this->pdf->SetTextColor($this->pdf->rapport_fontcolor['r'],$this->pdf->rapport_fontcolor['g'],$this->pdf->rapport_fontcolor['b']);
		   ...
		   $this->pdf->Rect($this->pdf->marge, 26, 297-2*$this->pdf->marge, 8 , 'F');
 ...
 //      $this->pdf->MultiCell(240,4,$this->pdf->rapport_voettext,'0','L');
       ...
       $tekst =  vertaalTekst("Rapportagedatum:",$this->pdf->rapport_taal)." ".date("j",$this->pdf->rapport_datum)." ".vertaalTekst($this->pdf->__appvar["Maanden"][date("n",$this->pdf->rapport_datum)],$this->pdf->rapport_taal)." ".date("Y",$this->pdf->rapport_datum);
	     $tekst .= vertaalTekst("\nPagina",$this->pdf->rapport_taal)." $vanPagina";// van $totPagina"; $portefeuille
	     $this->pdf->SetFont($this->pdf->rapport_font,'',$this->pdf->rapport_fontsize);
