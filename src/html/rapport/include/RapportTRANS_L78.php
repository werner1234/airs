...
$Log: RapportTRANS_L78.php,v $
Revision 1.5  2018/10/13 17:18:13  rvv
*** empty log message ***

Revision 1.4  2018/06/24 11:13:16  rvv
*** empty log message ***

Revision 1.3  2018/06/20 16:40:16  rvv
*** empty log message ***
...
class RapportTRANS_L78
{
	function RapportTRANS_L78($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
	...
	function writeRapport()
	{
		...
		$db2 = new DB();
			...
			// voor data
			$this->pdf->widthB = array(15,8,18,50,16,22,22,16,22,22,22,19,19,10);
			$this->pdf->alignB = array('L','L','R','L','R','R','R','R','R','R','R','R','R','R');
			// voor kopjes
			$this->pdf->widthA = array(15,8,18,50,16,22,22,16,22,22,22,19,19,10);
...
//	echo "lopende -> ".$resultaatlopende." <-  voorgaande ".$resultaatvoorgaande. " -  <br>" ;
			...
			else
			{
				...
				$this->pdf->Cell($this->pdf->widthB[3],4,$omschrijving);
			}
