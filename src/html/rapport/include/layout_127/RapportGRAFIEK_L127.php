...
include_once("rapport/include/layout_127/ATTberekening_L127.php");


class RapportGRAFIEK_L127
{
  function RapportGRAFIEK_L127($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
  {
    $this->pdf = &$pdf;
  ...
  function writeRapport()
  {
   ...
   // $DB = new DB();
    ...
    $att=new ATTberekening_L127($this);
