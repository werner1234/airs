...
$Log: RapportPERFG_L89.php,v $
Revision 1.3  2020/06/10 15:35:05  rvv
*** empty log message ***

Revision 1.6  2018/02/04 15:47:34  rvv
*** empty log message ***
...
class RapportPERFG_L89
{
	function RapportPERFG_L89($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
