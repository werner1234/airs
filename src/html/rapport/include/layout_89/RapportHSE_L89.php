...
/*
Author  						: $Author: rvv $
Laatste aanpassing	: $Date: 2020/04/08 15:45:20 $
File Versie					: $Revision: 1.1 $

$Log: RapportHSE_L89.php,v $
...
class RapportHSE_L89
{
	function RapportHSE_L89($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum, $valuta = 'EUR')
	{
		$this->pdf = &$pdf;
