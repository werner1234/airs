...
/*
    ...
    Author  						: $Author: rvv $
 		Laatste aanpassing	: $Date: 2017/02/18 17:32:08 $
 		File Versie					: $Revision: 1.1 $

 		$Log: RapportCASHY_L72.php,v $
 		Revision 1.1  2017/02/18 17:32:08  rvv
 		*** empty log message ***
...
class RapportCASHY_L72
{
	function RapportCASHY_L72($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
	 //
		$this->pdf = &$pdf;
	...
	function VBarDiagram($w, $h, $data,$titel)
  {
   ...
   $vertaling['lossing']='Lossingen';
         ...
         foreach ($colors as $categorie=>$color)
      {
          ...
          $this->pdf->Cell(0,4,vertaalTekst($vertaling[$categorie],$this->pdf->rapport_taal));
