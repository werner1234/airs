...
$Log: RapportVOLK_L10.php,v $
Revision 1.6  2019/01/26 19:33:28  rvv
*** empty log message ***

Revision 1.5  2019/01/19 18:05:31  rvv
*** empty log message ***
...
class RapportVOLK_L10
{
	function RapportVOLK_L10($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
