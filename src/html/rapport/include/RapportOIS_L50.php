...
$Log: RapportOIS_L50.php,v $
Revision 1.4  2013/09/11 15:40:24  rvv
*** empty log message ***

Revision 1.3  2013/09/04 16:13:24  rvv
*** empty log message ***

Revision 1.2  2013/08/28 16:02:50  rvv
*** empty log message ***
...
class RapportOIS_L50
{
	function RapportOIS_L50($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
		$this->pdf->rapport_type = "OIS";
		$this->pdf->rapport_datum = db2jul($rapportageDatum);

		$this->pdf->rapport_titel = "Verdeling van de aandelen over de verschillende sectoren";
	...
	function writeRapport()
	{
	  ...
	  $q="SELECT grafiek_kleur FROM Vermogensbeheerders WHERE Vermogensbeheerder = '$beheerder'";
		...
		$query = "SELECT SUM(actuelePortefeuilleWaardeEuro) AS totaal ".
						 ...
						 " rapportageDatum ='".$this->rapportageDatum."' AND TijdelijkeRapportage.beleggingscategorie='AAND' AND ".
		...
		" WHERE TijdelijkeRapportage.portefeuille = '".$this->portefeuille."' AND TijdelijkeRapportage.beleggingscategorie='AAND' AND".
    ...
    $grafiekTonen=True;
      ...
      if($percentageVanTotaal < 0)
        $grafiekTonen=False;
		 	...
		 	$this->pieData[vertaalTekst($categorien['beleggingssectorOmschrijving'], $this->pdf->rapport_taal)] = $percentageVanTotaal;
			$this->pieDataKleur[] = array($kleuren[$categorien['beleggingssector']]['R']['value'],$kleuren[$categorien['beleggingssector']]['G']['value'],$kleuren[$categorien['beleggingssector']]['B']['value']);
