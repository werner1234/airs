...
include_once($__appvar["basedir"]."/html/rapport/include/RapportVKMD_L76.php");

class RapportVKMS_L76
{

	function RapportVKMS_L76($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->vkm=new RapportVKMD_L76($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum);
	}
