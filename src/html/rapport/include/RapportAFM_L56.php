...
$Log: RapportAFM_L56.php,v $
Revision 1.9  2018/02/04 15:47:34  rvv
*** empty log message ***
...
class RapportAFM_L56
{
	function RapportAFM_L56($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
	  global $__appvar;
		$this->pdf = &$pdf;
