...
class RapportOIV_L70
{
	function RapportOIV_L70($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
  ...
  function formatGetalKoers($waarde, $dec , $start = false)
    ...
    $this->pdf->templateVars['OIVPaginas']=$this->pdf->page;
		$this->pdf->templateVarsOmschrijving['OIVPaginas'] = $this->pdf->rapport_titel;
		...
		$this->pdf->setY(40);
		$this->pdf->setWidths(array(140,35+35,25,25));
