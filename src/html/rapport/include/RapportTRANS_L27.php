...
$Log: RapportTRANS_L27.php,v $
Revision 1.8  2019/02/23 18:32:59  rvv
*** empty log message ***

Revision 1.7  2019/02/13 14:50:15  rvv
*** empty log message ***

Revision 1.6  2017/06/28 12:23:49  rvv
*** empty log message ***
...
class RapportTRANS_L27
{
	function RapportTRANS_L27($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
     ...
     Rekeningmutaties.omschrijving as rekeningOmschrijving,
        ...
        elseif ($this->pdf->rapportageValuta != 'EUR')
		    ...
		    $beginditjaar         = $beginditjaar         / getValutaKoers($this->pdf->rapportageValuta ,date("Y",db2jul($this->rapportageDatum).'-01-01'));
				...
				$totaal_resultaat_waarde += $result;
    ...
    $this->pdf->SetFont($this->pdf->rapport_font,$this->pdf->rapport_fontstyle,$this->pdf->rapport_fontsize);
    $this->pdf->ln();
    $this->pdf->MultiCell(280,4, 'De geschiktheidsevaluatie van afgelopen kwartaal heeft positief uitgepakt.
Zowel de uitgevoerde mutaties als de huidige samenstelling zijn conform de met u gemaakte afspraken.
Zijn uw omstandigheden of wensen gewijzigd? Meldt het ons dan.', 0, "L");
    $this->pdf->SetFont($this->pdf->rapport_font,$this->pdf->rapport_fontstyle,$this->pdf->rapport_fontsize);
