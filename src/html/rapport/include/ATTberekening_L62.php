...
/*
    ...
    Author  						: $Author: rvv $
 		...
 		*** empty log message ***
 		...
 		Revision 1.5  2017/04/29 17:26:01  rvv
 		*** empty log message ***
...
class ATTberekening_L62
{

	function ATTberekening_L62($rapportData,$periode='maanden')
	{
...
class indexHerberekening_L62
{
	function indexHerberekening_L62( $selectData )
	{
