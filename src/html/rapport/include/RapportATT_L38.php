...
/*
Author  						: $Author: rvv $
Laatste aanpassing	: $Date: 2013/02/27 17:04:41 $
File Versie					: $Revision: 1.8 $

$Log: RapportATT_L38.php,v $
...
class RapportATT_L38
{
	function RapportATT_L38($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
