...
/*
    ...
    Author  						: $Author: rvv $
 		...
 		$Log: RapportVHO_L18.php,v $
 		Revision 1.19  2017/05/28 09:58:52  rvv
 		*** empty log message ***
 		
 		Revision 1.18  2014/07/12 15:30:53  rvv
 		*** empty log message ***
 		
 		Revision 1.17  2014/05/14 15:28:41  rvv
 		*** empty log message ***
 		
 		Revision 1.16  2011/09/25 16:23:28  rvv
 		*** empty log message ***
 		
 		Revision 1.15  2011/07/03 06:42:47  rvv
 		*** empty log message ***

 		Revision 1.14  2011/06/29 16:52:23  rvv
 		*** empty log message ***

 		Revision 1.13  2011/06/02 15:05:05  rvv
 		*** empty log message ***

 		Revision 1.12  2011/04/19 16:41:39  rvv
 		*** empty log message ***

 		Revision 1.11  2009/07/22 15:16:00  rvv
 		*** empty log message ***

 		Revision 1.10  2009/07/12 09:32:42  rvv
 		*** empty log message ***

 		Revision 1.9  2009/05/04 13:37:23  cvs
 		*** empty log message ***

 		Revision 1.8  2009/04/16 07:02:55  cvs
 		*** empty log message ***

 		Revision 1.7  2008/09/15 08:04:05  rvv
 		*** empty log message ***

 		Revision 1.6  2008/07/03 10:38:07  rvv
 		obligatie marktwaarde jaarultimo wissel

 		Revision 1.5  2008/07/02 10:33:18  rvv
 		*** empty log message ***

 		Revision 1.4  2008/07/02 10:25:04  rvv
 		*** empty log message ***
...
class RapportVHO_L18
{
	function RapportVHO_L18($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
  ...
  TijdelijkeRapportage.fonds,
	...
	while ($dbdata=$DB->nextRecord())
	{
      ...
      $gecombeneerdResultaat = $fondsResultaat + $valutaResultaat;
	    ...
	    $data[$dbdata['beleggingscategorie']][$dbdata['fonds']]['winst']=$gecombeneerdResultaat;
...
//$fonds['aankoopprijs']
	  	  $this->pdf->Row(array('',$fonds['munt'],
	                           ...
	                           $this->formatGetal($fonds['winst'],2),
	                            $this->formatGetal($fonds['prijsUltimo'],2),
	                           $this->formatGetal($fonds['marktprijsValuta'],2),

	                           $this->formatGetal($fonds['marktwaarde']),
	                           $this->formatGetal($fonds['opgelopenRente']),
	                           $this->formatGetal($fonds['marktwaarde']/$totaalWaardeCategorie['VAR']*100,1)." %"));
