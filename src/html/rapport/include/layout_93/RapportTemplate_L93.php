...
class RapportTemplate_L93
{
	function RapportTemplate_L93($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
	  global $__appvar;
		$this->pdf = &$pdf;
    ...
    $totPagina = ($lastpage-$startpagina+$paginaCorrectie);//-1
       ...
       //$this->pdf->SetFont($pdfObject->rapport_font,'',$this->pdf->rapport_fontsize+8);
	     ...
	     $this->pdf->SetWidths(array(20,140,100,7));
       $this->pdf->ln(10);
       $this->pdf->SetFont($this->pdf->rapport_font,'B',$this->pdf->rapport_fontsize+2);
       $this->pdf->row(array('','Welkom','Inhoudsopgave'));
       $this->pdf->SetWidths(array(160,100,7));
       $this->pdf->setY(50);
       $this->pdf->SetFont($this->pdf->rapport_font,'',$this->pdf->rapport_fontsize+2);
	     $inhoudsItems=array('PERFPaginas'=>'Performance',
													 'PERFDPaginas'=>'Rendement',
        ...
        foreach ($this->pdf->templateVars as $key=>$value)
        {
          if($inhoudsItems[$key]) //$this->pdf->templateVarsOmschrijving
          {
            ...
            $dots=round((100-$stringWidth)/($this->pdf->CurrentFont['cw']['.']*$this->pdf->FontSize/1000));
