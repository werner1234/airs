...
class RapportSCENARIO_L70
{
	function RapportSCENARIO_L70($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
  ...
  function formatGetalKoers($waarde, $dec=0 , $start = false)
    ...
    $this->pdf->SetFont($this->pdf->rapport_font,'',$this->pdf->rapport_fontsize);
		$this->pdf->AddPage();
    $this->pdf->templateVars['SCENARIOPaginas']=$this->pdf->page;
    $this->pdf->templateVarsOmschrijving['SCENARIOPaginas'] = $this->pdf->rapport_titel;
    $this->pdf->setY(50);
