...
/*
Author  						: $Author: rvv $
Laatste aanpassing	: $Date: 2013/11/23 17:23:25 $
File Versie					: $Revision: 1.1 $

$Log: RapportAFM_L39.php,v $
...
class RapportAFM_L39
{
	function RapportAFM_L39($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
