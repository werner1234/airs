...
/*
    ...
    Author  						: $Author: rvv $
 		Laatste aanpassing	: $Date: 2020/07/12 10:38:49 $
 		File Versie					: $Revision: 1.3 $

 		$Log: ATTberekening_L57.php,v $
 		Revision 1.3  2020/07/12 10:38:49  rvv
 		*** empty log message ***
 		
 		Revision 1.2  2020/07/11 17:30:27  rvv
 		*** empty log message ***
...
class ATTberekening_L57
{

	function ATTberekening_L57($rapportData,$periode='jaren')
	{
  ...
  function genereerMutatieLijst($rapportageDatumVanaf,$rapportageDatum,$fonds='')
    ...
    elseif($fonds!='')
     ...
     Rekeningmutaties.omschrijving as rekeningOmschrijving,
      ...
      {
        //$historischekostprijsValuta = $mutaties['Aantal']*$historie['historischeWaarde']* $mutaties['Fondseenheid'];
