...
/*
    ...
    Author  						: $Author: rvv $
 		...
 		$Log: PDFRapport_headers_L71.php,v $
...
*/
 ...
 function Header_basis_L71($object)
 { 
   $pdfObject = &$object;
...
//echo 'rvv'.$pdfObject->lastPortefeuille." ".$pdfObject->rapportNewPage." | ". $pdfObject->lastPortefeuille." != ".$pdfObject->portefeuilledata['Portefeuille'] ."<br>\n";
  ...
  function HeaderNOTA_L71($object)
	{

	}

  function HeaderEND_L71($object)
  {
	  $pdfObject = &$object;
  }

	function HeaderVKM_L71($object)
	{
		$pdfObject = &$object;
		$pdfObject->HeaderVKM();
	}

function HeaderVKMS_L71($object)
{
	$pdfObject = &$object;
	$pdfObject->HeaderVKM();
}
function HeaderVKMD_L71($object)
{
	$pdfObject = &$object;
	$pdfObject->HeaderVKM();
}

function HeaderMUT_L71($object)
	{
    $pdfObject = &$object;
  ...
  function HeaderTRANS_L71($object)
	{
    $pdfObject = &$object;
    $pdfObject->HeaderTRANS();
	}

function HeaderFACTUUR_L71($object)
{
	$pdfObject = &$object;

}

  function HeaderPERF_L71($object)
	{
    $pdfObject = &$object;
    $pdfObject->HeaderPERF();
	}
      function HeaderOIB_L71($object)
	  {
	    $pdfObject = &$object;
      $pdfObject->Ln();
      		$pdfObject->SetFillColor($pdfObject->rapport_kop_bgcolor['r'],$pdfObject->rapport_kop_bgcolor['g'],$pdfObject->rapport_kop_bgcolor['b']);
 	...
 	function HeaderVOLKD_L71($object)
	{
    $pdfObject = &$object;
  	$pdfObject->ln();
		$pdfObject->SetFont($pdfObject->rapport_font,$pdfObject->rapport_kop_fontstyle,$pdfObject->rapport_fontsize);
...
*/
  ...
  function HeaderVOLK_L71($object)
	{
    $pdfObject = &$object;
   	$pdfObject->ln();
		$pdfObject->SetFont($pdfObject->rapport_font,$pdfObject->rapport_kop_fontstyle,$pdfObject->rapport_fontsize);
...
function HeaderHSE_L71($object)
{
  ...
  function HeaderPERFG_L71($object)
	{
    $pdfObject = &$object;
