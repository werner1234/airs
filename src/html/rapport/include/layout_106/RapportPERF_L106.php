...
include_once("rapport/include/layout_106/ATTberekening_L106.php");

class RapportPERF_L106
{

	function RapportPERF_L106($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
    ...
    $this->att=new ATTberekening_L106($this);
	}
...
function addResultaat()
{
  ...
  $vetralingGrootboek=$this->getGrootboeken();
    ...
    $att=new ATTberekening_L106($this);
