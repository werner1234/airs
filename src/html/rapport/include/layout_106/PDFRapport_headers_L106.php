...
function Header_basis_L106($object)
{
 $pdfObject = &$object;
	...
	function HeaderVKM_L106($object)
	{
		$pdfObject = &$object;
		$pdfObject->HeaderVKM();
	}
	
	  function HeaderFRONT_L106($object)
	  {
	    $pdfObject = &$object;
	    //$pdfObject->headerSCENARIO();

	  }
	  function HeaderSCENARIO_L106($object)
	  {
	    $pdfObject = &$object;
	    //$pdfObject->headerSCENARIO();
...
function HeaderKERNV_L106($object)
{
  $pdfObject = &$object;
  //$pdfObject->headerSCENARIO();
  
}
function HeaderKERNZ_L106($object)
{
  $pdfObject = &$object;
  //$pdfObject->headerSCENARIO();
  
}
    function HeaderRISK_L106($object)
    {
	    $pdfObject = &$object;
			$pdfObject->Ln();
    ...
    function HeaderGRAFIEK_L106($object)
    {
	    $pdfObject = &$object;
    }

    function HeaderEND_L106($object)
    {
     	$pdfObject = &$object;
			$pdfObject->Ln();
			$pdfObject->SetFillColor($pdfObject->rapport_kop_bgcolor['r'],$pdfObject->rapport_kop_bgcolor['g'],$pdfObject->rapport_kop_bgcolor['b']);
    ...
    function HeaderPERFD_L106($object)
    {
      $pdfObject = &$object;
...
function HeaderVAR_L106($object)
{
  $pdfObject = &$object;
  $pdfObject->SetFont($pdfObject->rapport_font,'B',$pdfObject->rapport_fontsize);
  ...
  unset($pdfObject->CellBorders);//"Modified\nduration",
    ...
    function HeaderTRANS_L106($object)
	  {
	    $pdfObject = &$object;
    ...
    function HeaderMUT_L106($object)
	  {
	    $pdfObject = &$object;
   		$pdfObject->SetFont($pdfObject->rapport_font,$pdfObject->rapport_kop_fontstyle,$pdfObject->rapport_fontsize);
  	  $pdfObject->SetX(100);
	  ...
	  function HeaderAFM_L106($object)
    {
  $pdfObject = &$object;
  ...
  $dataWidth=array(45,19,12,20,20,2,20,20,12,2,20,20,15,20,20,14);
  ...
  $pdfObject->SetDrawColor(0);
	  ...
	  function HeaderINHOUD_L106($object)
	  {
	    $pdfObject = &$object;
	    //$pdfObject->headerSCENARIO();

	  }	  
 	  function HeaderPERF_L106($object)
	  {
	    $pdfObject = &$object;
      $pdfObject->ln();
      $pdfObject->SetFillColor($pdfObject->rapport_kop_bgcolor['r'],$pdfObject->rapport_kop_bgcolor['g'],$pdfObject->rapport_kop_bgcolor['b']);
...
$pdfObject->ln();
    ...
    function HeaderINDEX_L106($object)
	  {
	    $pdfObject = &$object;
	  }
    function HeaderOIB_L106($object)
	  {
	    $pdfObject = &$object;
      $pdfObject->Ln();
      		$pdfObject->SetFillColor($pdfObject->rapport_kop_bgcolor['r'],$pdfObject->rapport_kop_bgcolor['g'],$pdfObject->rapport_kop_bgcolor['b']);
  ...
  function HeaderATT_L106($object)
	{
    $pdfObject = &$object;
...
*/
   ...
   function HeaderPERFG_L106($object)
	{
    $pdfObject = &$object;
    $pdfObject->widthA = array(26,25,30,30,23,23,23,24,28,24,26);
		$pdfObject->alignA = array('L','R','R','R','R','R','R','R','R','R','R','R');
...
function HeaderVOLKD_L106($object)
{
  $pdfObject = &$object;
  $pdfObject->ln();
  $pdfObject->SetFont($pdfObject->rapport_font,$pdfObject->rapport_kop_fontstyle,$pdfObject->rapport_fontsize);
  ...
  function HeaderVOLK_L106($object)
	{
    $pdfObject = &$object;
   	$pdfObject->ln();
		$pdfObject->SetFont($pdfObject->rapport_font,$pdfObject->rapport_kop_fontstyle,$pdfObject->rapport_fontsize);
...
function HeaderVHO_L106($object)
	{
    $pdfObject = &$object;
   	$pdfObject->ln();
		$pdfObject->SetFont($pdfObject->rapport_font,$pdfObject->rapport_kop_fontstyle,$pdfObject->rapport_fontsize);
...
if(!function_exists('PieChart_L106'))
{
  function PieChart_L106($pdfObject,$w,$h,$data, $format, $colors=null,$titel='',$legendaStart='')
  {
