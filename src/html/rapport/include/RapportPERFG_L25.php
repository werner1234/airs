...
class RapportPERFG_L25
{

  function RapportPERFG_L25($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
...
//$this->pdf->setXY(15,30);
 ...
 // $this->pdf->Multicell($w,4,"Index Grafiek",'','C');
    if($this->pdf->getY()>95 || count($rendamentWaardenTabel)>12)
    {
      $this->pdf->addPage();
...
$this->VBarDiagram(120,70,$grafiekData,'',$color);
