...
$Log: RapportHSE_L70.php,v $
Revision 1.6  2020/07/15 16:38:19  rvv
*** empty log message ***

Revision 1.5  2016/09/18 08:49:02  rvv
*** empty log message ***

Revision 1.4  2016/08/13 16:55:26  rvv
*** empty log message ***

Revision 1.3  2016/07/06 16:09:31  rvv
*** empty log message ***
...
class RapportHSE_L70
{
	function RapportHSE_L70($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum, $valuta = 'EUR')
	{
		$this->pdf = &$pdf;
    ...
    $maxDagenOud=$dagen['VerouderdeKoersDagen'];
	  ...
	  $this->pdf->widthB = array(5,60,20,20,30,30,15,20,30,30,15);
		...
		while($categorien = $DB->NextRecord())
		{
		  ...
		  $DB2 = new DB();
           ...
           $this->pdf->fillCell = array($this->pdf->cellColorLight,$this->pdf->cellColorLight,$this->pdf->cellColorDark,
                                        ...
                                        $this->pdf->cellColorLight,$this->pdf->cellColorDark,
                                        $this->pdf->cellColorLight,$this->pdf->cellColorDark,
                                        $this->pdf->cellColorLight,$this->pdf->cellColorDark,1);
					$this->pdf->row(array("",
