...
/*
Author  						: $Author: rvv $
Laatste aanpassing	: $Date: 2014/10/08 15:42:52 $
File Versie					: $Revision: 1.1 $

$Log: RapportPERF_L24.php,v $
...
class RapportPERF_L24
{

	function RapportPERF_L24($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
...
//rvv end
        ...
        $kostenPerGrootboek['KOST']['Omschrijving'] = "Transactiekosten";
			...
			elseif($kosten['Grootboekrekening'] == "BEW")
			{
				$kostenPerGrootboek['BEW']['Bedrag'] += ($kosten['totaaldebet'] - $kosten['totaalcredit']);
        $kostenPerGrootboek['BEW']['Omschrijving'] = "Banking fee";
			}      
			else
			{
