...
/*
Author  						: $Author: rvv $
Laatste aanpassing	: $Date: 2017/11/04 18:05:08 $
File Versie					: $Revision: 1.4 $

$Log: RapportTemplate_L66.php,v $
Revision 1.4  2017/11/04 18:05:08  rvv
*** empty log message ***

Revision 1.3  2016/10/16 15:14:53  rvv
*** empty log message ***
...
class RapportTemplate_L66
{
	function RapportTemplate_L66($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
	  global $__appvar;
		$this->pdf = &$pdf;
      ...
      */
	  ...
	  //   $extraBlank=1;
	   ...
	   if($i > $startpagina+$paginaNummerStart)
	   {
			 ...
			 if($factuurAanwezig == true && $i > $this->pdf->templateVars['FACTUURpaginasBegin'] && $i <=$this->pdf->templateVars['FACTUURpaginasEind'] || $this->pdf->selectData['type']=='factuur')
				 continue;
	     $Y=$this->pdf->getY();
