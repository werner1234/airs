...
class rapportHulp_L90
{
  function rapportHulp_L90()
  {
    $this->test='';
  }
}
...
class ATTberekening_L90
{

	function ATTberekening_L90($rapportData)
	{
  ...
  {
    $this->rapport = new rapportHulp_L90();
    $db=new DB();
