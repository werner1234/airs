...
include_once("rapport/include/layout_90/ATTberekening_L90.php");

class RapportPERFG_L90
{

	function RapportPERFG_L90($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
    ...
    $this->att=new ATTberekening_L90($this);
