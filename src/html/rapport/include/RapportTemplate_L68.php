...
/*
Author  						: $Author: rvv $
Laatste aanpassing	: $Date: 2018/11/24 19:11:26 $
File Versie					: $Revision: 1.5 $

$Log: RapportTemplate_L68.php,v $
...
class RapportTemplate_L68
{
	function RapportTemplate_L68($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
	  global $__appvar;
		$this->pdf = &$pdf;
