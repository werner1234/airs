...
include_once("rapport/include/layout_92/ATTberekening_L92.php");

class RapportPERF_L92
{

	function RapportPERF_L92($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
    ...
    $this->att=new ATTberekening_L92($this);
	}
...
function getGrootboeken()
{
  ...
  while($data=$db->nextRecord())
  {
    if($data['Grootboekrekening']=='BEW')
      $data['Omschrijving']='Servicefee '.$this->pdf->portefeuilledata['DepotbankOmschrijving'];
    if($data['Grootboekrekening']=='KOST')
      $data['Omschrijving']='Transactiekosten '.$this->pdf->portefeuilledata['DepotbankOmschrijving'];
...
function addResultaat()
{
  ...
  */
  ...
  $vetralingGrootboek=$this->getGrootboeken();
    ...
    $att=new ATTberekening_L92($this);
