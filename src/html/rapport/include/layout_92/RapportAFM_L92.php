...
class RapportAFM_L92
{
	function RapportAFM_L92($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
	  global $__appvar;
		$this->pdf = &$pdf;
  ...
  function formatGetalKoers($waarde, $dec , $start = false)
	...
	$this->pdf->SetAligns($this->pdf->alignA);
      ...
      $this->pdf->SetTextColor($this->pdf->rapport_fontcolor['r'],$this->pdf->rapport_fontcolor['g'],$this->pdf->rapport_fontcolor['b']);
			...
			$this->pdf->row(array("",
											"",
											$this->formatGetalKoers($categorien['subtotaalactueel'],2),
