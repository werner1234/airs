...
class RapportATT_L92
{
	function RapportATT_L92($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
...
*/
          ...
          $this->pdf->CellBorders = array();
		      $this->pdf->row(array(date("Y",$datum).' '.vertaalTekst($__appvar["Maanden"][date("n",$datum)],$this->pdf->rapport_taal) ,
		                           ...
		                           $this->formatGetal($row['gerealiseerd']+$row['ongerealiseerd']+$row['rente'],2),
     ...
     //   $this->pdf->ln(3);
        ...
        $this->pdf->CellBorders = array();
		    $this->pdf->row(array(vertaalTekst('Totaal',$this->pdf->rapport_taal),
		                           ...
		                           $this->formatGetal($totaal['jaar']['Gerealiseerd']+$totaal['jaar']['Ongerealiseerd']+$totaal['jaar']['Rente'],2),
