...
/*
Author  						: $Author: rvv $
Laatste aanpassing	: $Date: 2018/08/01 17:56:09 $
File Versie					: $Revision: 1.20 $

$Log: RapportVOLK_L22.php,v $
...
class RapportVOLK_L22
{
	function RapportVOLK_L22($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
