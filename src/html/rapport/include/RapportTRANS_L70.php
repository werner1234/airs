...
$Log: RapportTRANS_L70.php,v $
Revision 1.7  2019/06/15 20:53:26  rvv
*** empty log message ***

Revision 1.6  2016/06/22 16:15:05  rvv
*** empty log message ***

Revision 1.5  2016/06/20 06:05:48  rvv
*** empty log message ***
...
class RapportTRANS_L70
{
	function RapportTRANS_L70($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
	...
	function writeRapport()
	{
	  ...
	  if ($this->pdf->rapportageValuta != "EUR" || $this->pdf->rapportageValuta != '')
	   $koersQuery =	" / (SELECT Koers FROM Valutakoersen WHERE Valuta='".$this->pdf->rapportageValuta."' AND Datum <= Rekeningmutaties.Boekdatum ORDER BY Datum DESC LIMIT 1 ) ";
		...
		// voor data
		$this->pdf->widthB = array(14,9,18,54,15,18,18,15,18,18,18,21,21,10);
		//echo array_sum($this->pdf->widthB);exit;//267
