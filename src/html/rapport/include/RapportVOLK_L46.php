...
$Log: RapportVOLK_L46.php,v $
Revision 1.3  2019/02/10 14:26:19  rvv
*** empty log message ***

Revision 1.2  2019/02/09 18:40:17  rvv
*** empty log message ***

Revision 1.1  2016/01/13 17:11:59  rvv
*** empty log message ***
...
class RapportVOLK_L46
{
	function RapportVOLK_L46($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
	...
	function writeRapport()
	{
     ...
     "
      ...
      ".
		...
		{
			if($this->pdf->rapportageValuta<>$categorien['valuta'])
        $valutas[$categorien['valuta']]=$categorien['valuta'];
