...
class rapportHulp_L44
{
  function rapportHulp_L44()
  {
    $this->test='';
  }
}

class ATTberekening_L44
{

	function ATTberekening_L44($rapportData)
	{
  ...
  {
    $this->rapport = new rapportHulp_L44();
    $db=new DB();
...
foreach ($perioden as $periode)
{
    ...
    $datumEind=$periode['stop'];
     ...
     while($grootboekrekening=$DB->nextRecord())
      ...
      if($this->totalen[$datumBegin]['totaalWaardeEur'] == 0 || empty( $storting['gewogen']) &&  $storting['totaal']>0)
