...
$Log: RapportDOORKIJK_L70.php,v $
Revision 1.3  2020/02/29 16:23:08  rvv
*** empty log message ***

Revision 1.2  2019/06/09 14:52:19  rvv
*** empty log message ***

Revision 1.1  2019/05/25 16:22:07  rvv
*** empty log message ***
...
class RapportDOORKIJK_L70
{
	function RapportDOORKIJK_L70($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = $pdf;
