...
$Log: RapportTemplate_L101.php,v $
...
class RapportTemplate_L101
{
	function RapportTemplate_L101($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
	  global $__appvar;
		$this->pdf = &$pdf;
    ...
    $totPagina = ($lastpage-$startpagina+$paginaCorrectie);//-1
       ...
       $this->pdf->ln(10);
        ...
        {
          if($this->pdf->templateVarsOmschrijving[$key] || $inhoudsItems[$key]) //$this->pdf->templateVarsOmschrijving
          {
