...
class RapportPERF_L101
{
  
  function RapportPERF_L101($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
  {
    $this->pdf = &$pdf;
...
//listarray($fill_color);
  ...
  function addResultaat()
  {
    ...
    $this->waarden['Periode']=$this->att->bereken($this->rapportageDatumVanaf,$this->rapportageDatum,'','categorie');
