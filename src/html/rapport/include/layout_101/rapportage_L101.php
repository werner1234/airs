...
$pdf->rapport_layout = 101; #Havermaet
$pdf->marge = 8;
...
if (file_exists(FPDF_FONTPATH . 'gotham.php'))
{
  if (!isset($pdf->fonts['gotham']))
  {
    $pdf->AddFont('gotham', '', 'gotham.php');
    $pdf->AddFont('gotham', 'B', 'gothamB.php');
    $pdf->AddFont('gotham', 'I', 'gothamI.php');
    $pdf->AddFont('gotham', 'BI', 'gothamBI.php');
  }
  $pdf->rapport_font = 'gotham';
}
...
$pdf->rapport_kop_bgcolor = array('r' => 203, 'g' => 187, 'b' => 160); //35/45/104 //33/43/105 //'r'=>88,'g'=>119,'b'=>255
$pdf->rapport_kop_fontcolor = array('r' => 255, 'g' =>255, 'b' => 255);//array('r'=>127,'g'=>128,'b'=>132);
$pdf->rapport_kop_fontstyle = 'b';

$pdf->rapport_background_fill = array(228,220,206);
$pdf->rapport_grafiek_pcolor  = array(0,0,0);
