...
/*
    ...
    Author  						: $Author: rvv $
 		Laatste aanpassing	: $Date: 2012/09/30 11:16:12 $
 		File Versie					: $Revision: 1.8 $

 		$Log: RapportCASHY.php,v $
 		Revision 1.8  2012/09/30 11:16:12  rvv
 		*** empty log message ***
...
class RapportCASHY
{
	function RapportCASHY($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
	 //
		$this->pdf = &$pdf;
