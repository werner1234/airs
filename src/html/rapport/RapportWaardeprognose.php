...
/*
Author  						: $Author: rvv $
Laatste aanpassing	: $Date: 2018/10/06 17:20:00 $
File Versie					: $Revision: 1.10 $

$Log: RapportWaardeprognose.php,v $
Revision 1.10  2018/10/06 17:20:00  rvv
*** empty log message ***

Revision 1.9  2018/09/27 08:00:41  rvv
*** empty log message ***

Revision 1.8  2018/09/19 17:31:53  rvv
*** empty log message ***
...
class RapportWaardeprognose
{
	...
	*/
	...
	function RapportWaardeprognose( $selectData )
	{
		global $__appvar,$USR;
    ...
    $db->SQL($query);
		...
		$kostenVelden=array('waardeprognose_kosten_beheer'=>'Beheerkosten',
												'waardeprognose_kosten_transactie'=>'Transctiekosten',
												'waardeprognose_kosten_bank'=>'Bankkosten',
												'waardeprognose_kosten_indirect'=>'Indirectekosten');
		...
		foreach($kostenVelden as $veld=>$omschrijving)
		{
			...
			{
				$this->pdf->row(array($omschrijving,$this->formatGetal($this->selectData[$veld],2).' %'));
