...
/*
Author  						: $Author: rvv $
Laatste aanpassing	: $Date: 2018/03/10 18:23:19 $
File Versie					: $Revision: 1.28 $

$Log: RapportSCENARIO.php,v $
...
class RapportSCENARIO
{
	function RapportSCENARIO($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = &$pdf;
