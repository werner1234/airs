...
/*
Author  						: $Author: rvv $
Laatste aanpassing	: $Date: 2020/01/18 13:28:08 $
File Versie					: $Revision: 1.13 $

$Log: RapportDOORKIJK.php,v $
Revision 1.13  2020/01/18 13:28:08  rvv
*** empty log message ***
...
class RapportDOORKIJK
{
	function RapportDOORKIJK($pdf, $portefeuille, $rapportageDatumVanaf, $rapportageDatum)
	{
		$this->pdf = $pdf;
    ...
    $this->componenten=array('alles'=>true,'aandelen'=>true);
	}
...
*/
    ...
    if($this->componenten['alles']==true)
    {
      $this->pdf->AddPage();
      $this->vulPagina();
    }

    if($this->componenten['aandelen']==true)
    {
