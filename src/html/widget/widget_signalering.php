...
/*
    ...
    $Log: widget_signalering.php,v $
    Revision 1.8  2020/02/28 15:14:37  cvs
    call 8443
...
$columnData = array(
  ...
  "periode" => array(
    ...
    "title"   => vt("Periode"),
    "btrTitle"   => "Periode",
    "show"    => (int) $columnSettings["periode"],
    "width"   => "5",
    "fixed"   => 1,
    "class"   => "bgEEE borderU ac",
    "format"  => ""
  ...
  "signaleringsPercentage" => array(
    "dbField" => "signaleringsPercentage",
    "koptxt"  => vt("Sig%"),
    "title"   => vt("SignaleringsPercentage"),
    "btrTitle"   => "SignaleringsPercentage",
    "show"    => (int) $columnSettings["signaleringsPercentage"],
    "width"   => "5",
    "fixed"   => 1,
  ...
  "laatsteWaarde" => array(
    ...
    "koptxt"  => vt("Laatste"),
    "title"   => vt("Laatstewaarde"),
    "btrTitle"   => "Laatstewaarde",
    "show"    => (int) $columnSettings["laatsteWaarde"],
    "width"   => "10",
    "fixed"   => 0,
    "class"   => "bgEEE borderU ar",
    "format"  => "@N{.2} "
  ...
  "beginWaarde" => array(
    "dbField" => "beginWaarde",
    "koptxt"  => vt("Begin"),
    "title"   => vt("Beginwaarde"),
    "btrTitle"   => "Beginwaarde",
    "show"    => (int) $columnSettings["beginWaarde"],
    "width"   => "10",
    "fixed"   => 0,
    "class"   => "bgEEE borderU ar",
    "format"  => "@N{.2} "
  ...
  "rendement" => array(
    ...
    "title"   => vt("Rendement"),
    "btrTitle"   => "Rendement",
    "show"    => (int) $columnSettings["rendement"],
    "width"   => "5",
    "fixed"   => 0,
    "class"   => "bgEEE borderU ar",
    "format"  => "@N{.2}% "
...
$query = "
SELECT
  signaleringPortRend.portefeuille,
  signaleringPortRend.periode,
  signaleringPortRend.signaleringsPercentage,
  signaleringPortRend.datum,
...
LEFT JOIN Portefeuilles ON 
  signaleringPortRend.portefeuille = Portefeuilles.Portefeuille
INNER JOIN laatstePortefeuilleWaarde ON 
  signaleringPortRend.portefeuille = laatstePortefeuilleWaarde.portefeuille  
  $extraJoin
WHERE
   $extraWhere
   signaleringPortRend.status='0'
ORDER BY
  signaleringPortRend.datum DESC
";

$parse = array(
  "header"   => vtb("Signalering rendement (%s) ", array(vt($showPort))),
...
{
  $output .= "<div>Geen items gevonden</div>";
}
