...
{
  $_SESSION['submenu']->addItem("Direct naar:");
  $_SESSION['submenu']->addItem("&nbsp;&nbsp;".maakKnop('index.png',array('size'=>16))." Mijn cli�nten","CRM_nawList.php?sql=debiteur",array('style'=>"text-align:left"));
  if(GetModuleAccess("ORDER")==2)
    $orderEdit="ordersEditV2.php";
  else
    $orderEdit="ordersEdit.php";
  $_SESSION['submenu']->addItem("&nbsp;&nbsp;".maakKnop('form_red.png',array('size'=>16))." Nieuwe order",$orderEdit."?action=new&returnUrl=ordersListV2.php?status=ingevoerd",array('style'=>"text-align:left"));
  $_SESSION['submenu']->addItem("&nbsp;&nbsp;".maakKnop('pie-chart.png',array('size'=>16))." Klantrapportage","rapportFrontofficeClientSelectie.php",array('style'=>"text-align:left"));
}
//clear navigatie
$_SESSION['NAV'] = "";
session_write_close();
