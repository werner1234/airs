...
$tst = new SQLman();
$tst->changeField("Fondsen","bucketCode",array("Type"=>"varchar(26)","Null"=>false,'Default'=>'default \'\''));
$tst->changeField("TijdelijkeBulkOrders","depotbank",array("Type"=>"varchar(10)","Null"=>false,'Default'=>'default \'\''));
