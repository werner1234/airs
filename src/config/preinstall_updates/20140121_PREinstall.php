...
/*
    ...
    Author  						: $Author: cvs $
 		Laatste aanpassing	: $Date: 2014/01/21 13:53:38 $
 		File Versie					: $Revision: 1.1 $

 		$Log: 20140121_PREinstall.php,v $
 		Revision 1.1  2014/01/21 13:53:38  cvs
 		*** empty log message ***
...
$tst = new SQLman();
$tst->changeField("CRM_naw","externID",array("Type"=>"varchar(50)","Null"=>false,'Default'=>'default \'\''));
