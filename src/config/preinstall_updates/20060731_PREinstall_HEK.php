...
/*
    ...
    Author  						: $Author: cvs $
 		Laatste aanpassing	: $Date: 2006/07/31 14:11:25 $
 		File Versie					: $Revision: 1.1 $

 		$Log: 20060731_PREinstall_HEK.php,v $
 		Revision 1.1  2006/07/31 14:11:25  cvs
 		*** empty log message ***
...
"INSERT INTO `ae_modulecfg` VALUES (null, 'ORDER', '240834-32976-1177500', '2010-12-31', '".$__appvar['bedrijf']."', null, null);"
);


if (strtoupper($__appvar['bedrijf']) == 'HEK')
{
