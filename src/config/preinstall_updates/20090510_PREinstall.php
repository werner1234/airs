...
/* 	
    ...
    Author  						: $Author: rvv $
 		Laatste aanpassing	: $Date: 2009/05/10 09:06:04 $
 		File Versie					: $Revision: 1.1 $
 		
 		$Log: 20090510_PREinstall.php,v $
...
$tst->changeField("BeleggingscategoriePerFonds","Vanaf",array("Type"=>"date","Null"=>false)); 
$tst->changeField("BeleggingssectorPerFonds","Vanaf",array("Type"=>"date","Null"=>false)); 
