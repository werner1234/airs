...
$tst->changeField("Clienten","Land",array("Type"=>"varchar(50)","Null"=>false)); 
$tst->changeField("Portefeuilles","Aanbrenger",array("Type"=>"varchar(200)","Null"=>false));   
