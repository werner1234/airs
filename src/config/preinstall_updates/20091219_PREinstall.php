...
/* 	
    ...
    Author  						: $Author: rvv $
 		Laatste aanpassing	: $Date: 2009/12/20 14:30:43 $
 		File Versie					: $Revision: 1.1 $
 		
 		$Log: 20091219_PREinstall.php,v $
...
$tst = new SQLman();
$tst->changeField("Portefeuilles","BetalingsinfoMee",array("Type"=>"tinyint(1)","Null"=>false)); 
$tst->changeField("FactuurHistorie","printDate",array("Type"=>"datetime","Null"=>false)); 
