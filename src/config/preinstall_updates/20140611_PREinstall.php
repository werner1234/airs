...
/* 	
    ...
    Author  						: $Author: rvv $
 		Laatste aanpassing	: $Date: 2014/06/11 15:40:17 $
 		File Versie					: $Revision: 1.1 $
 		
 		$Log: 20140611_PREinstall.php,v $
...
$tst = new SQLman();
$tst->changeField("CRM_eigenVelden","trekveldSelectieveld",array("Type"=>"varchar(40)","Null"=>false));
