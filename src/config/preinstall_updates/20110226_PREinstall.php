...
/*
    ...
    Author  						: $Author: rvv $
 		Laatste aanpassing	: $Date: 2011/02/26 15:56:46 $
 		File Versie					: $Revision: 1.1 $

 		$Log: 20110226_PREinstall.php,v $
 		Revision 1.1  2011/02/26 15:56:46  rvv
 		*** empty log message ***
...
$tables['emittenten']="CREATE TABLE `emittenten` (
