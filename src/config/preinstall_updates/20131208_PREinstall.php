...
$tst = new SQLman();
$tst->changeField("Vermogensbeheerders","check_module_SCENARIO",array("Type"=>"tinyint(4)","Null"=>false,'Default'=>'default \'0\''));
$tst->changeField("ModelPortefeuilles","AfdrukNiveau",array("Type"=>"varchar(20)","Null"=>false,'Default'=>'default \'0\''));
?>