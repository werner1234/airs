...
$tst->changeField("Vermogensbeheerders","CrmClientNaam",array("Type"=>"tinyint(1)","Null"=>false)); 
$tst->changeField("Vermogensbeheerders","check_historischePortefeuilleIndex",array("Type"=>"tinyint(4)","Null"=>false)); 
