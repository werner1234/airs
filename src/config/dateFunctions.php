...
function adodb_db2jul($string)
{
  if($string == "0000-00-00")
   return 0;
  $date = explode('-',$string);
  return adodb_mktime(0,0,0,$date[1],$date[2],$date[0]);
}

function adodb_form2jul($string)
{
  if($string == "00-00-0000")
   return 0;
  $date = explode('-',$string);
  return adodb_mktime(0,0,0,$date[1],$date[0],$date[2]);
}

function adodb_jul2db($int)
{
  return adodb_date("Y-m-d",$int);
}
