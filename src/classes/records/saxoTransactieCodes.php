...
class saxoTransactieCodes extends Table
{

  var $data = array();
  var $tableName = "saxoTransactieCodes";

  function saxoTransactieCodes()
  {
    $this->defineData();
    $this->setDefaults();
  ...
  function initModule()
  {
    ...
    $tst->changeField($this->tableName,"bankCode",array("Type"=>"varchar(40)","Null"=>false));
  ...
  */
  function defineData()
  {
    $this->data['name']     = "saxoTransactieCodes";
    ...
    $this->data['identity'] = "id";
		...
		$this->addField('doActie',
                          ...
                          "form_options" => array(
                            ...
                            "BEH"      => "BEH &nbsp;- bankkosten",
                            "BEW"      => "BEW &nbsp;- bewaarloon",
                            "CORP"     => "CORP &nbsp;- Corperate actions",

                            "DIV"      => "DIV - Contant dividend",
                            "EXP"      => "EXP - Expiratie",
                            "EXCASS"   => "EXCASS - Exercise/Assignment",
                            ...
                            "RENOB"    => "RENOB&nbsp;- Coupons",
                            "STUKMUT"  => "STUKMUT&nbsp;- Mutatie stukken",
