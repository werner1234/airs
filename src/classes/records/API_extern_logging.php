...
/* 	
    ...
    Author              : $Author: cvs $
    Laatste aanpassing  : $Date: 2019/03/01 08:55:09 $
    File Versie         : $Revision: 1.1 $
 		
    $Log: API_extern_logging.php,v $
    Revision 1.1  2019/03/01 08:55:09  cvs
    call 7364
...
class API_extern_logging extends Table
{
  /*
  * Object vars
  */
  ...
  */
  function defineData()
  {
    $this->data['name']  = "API extern logs";
    $this->data['table']  = "API_extern_logging";
