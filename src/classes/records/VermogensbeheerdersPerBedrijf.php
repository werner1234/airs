...
/* 	
    ...
    $Log: VermogensbeheerdersPerBedrijf.php,v $
...
class VermogensbeheerdersPerBedrijf extends Table
{
  /*
  * Object vars
  */
  ...
  * Constructor
  */
  function VermogensbeheerdersPerBedrijf()
  {
    $this->defineData();
    $this->setDefaults();
  ...
  */
  ...
  {
    $this->data['name']  = "";
    $this->data['table']  = "VermogensbeheerdersPerBedrijf";
