...
/*
    ...
    $Log: StandaarddeviatiePerRisicoklasse.php,v $
    ...
    *** empty log message ***
    ...
    Revision 1.1  2013/07/17 15:49:49  rvv
    *** empty log message ***
...
class StandaarddeviatiePerRisicoklasse extends Table
{
  /*
  * Object vars
  */
  ...
  * Constructor
  */
  function StandaarddeviatiePerRisicoklasse()
  {
    $this->defineData();
    $this->setDefaults();
  ...
  */
  ...
  {
    $this->data['name']  = "";
    $this->data['table']  = "StandaarddeviatiePerRisicoklasse";
    ...
    $this->data['logChange'] = true;
		...
		$this->addField('norm',
													...
													"list_search"=>false,
													"list_order"=>"true"));
		$this->addField('debetNietToestaan',
													array("description"=>"Debetstanden niet toegestaan",
													"db_size"=>"3",
													"db_type"=>"tinyint",
													"form_size"=>"3",
													"form_type"=>"checkbox",
