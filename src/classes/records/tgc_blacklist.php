...
class Tgc_blacklist extends Table
{
  /*
  * Object vars
  */
  ...
  */
  function defineData()
  {
    ...
    $this->data['identity'] = "id";
		...
		$this->addField('onList',
													array("description"=>"onList",
													"default_value"=>"",
													"db_size"=>"0",
													"db_type"=>"datetime",
													"form_type"=>"calendar",
		...
		$this->addField('offList',
													array("description"=>"offList",
													"default_value"=>"",
													"db_size"=>"0",
													"db_type"=>"datetime",
													"form_type"=>"calendar",
