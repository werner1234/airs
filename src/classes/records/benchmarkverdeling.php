...
/*
    ...
    Revision 1.6  2020/05/08 15:01:04  rm
    8593 Benchmarkverdeling: gebruik AJAX-lookup

    Revision 1.5  2020/05/04 15:04:31  rm
    8593 Benchmarkverdeling: gebruik AJAX-lookup

    Revision 1.4  2017/09/13 09:58:46  rvv
    *** empty log message ***
...
class Benchmarkverdeling extends Table
{
  /*
  * Object vars
  */
  ...
  */
  function Benchmarkverdeling()
  {
	...
	function validate()
	{
		...
		$query  = "SELECT id FROM benchmarkverdeling WHERE ".
  ...
  */
  ...
  {
    $this->data['name']  = "";
    $this->data['table']  = "benchmarkverdeling";
