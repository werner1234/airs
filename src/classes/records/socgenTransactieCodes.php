...
/*
    ...
    Filename            : socgenTransactieCodes.php


*/

class socgenTransactieCodes extends Table
{

  var $data = array();
  var $tableName = "socgenTransactieCodes";

  function socgenTransactieCodes()
  {
    $this->defineData();
    $this->setDefaults();
  ...
  */
  function defineData()
  {
    $this->data['name']     = "socgenTransactieCodes";
