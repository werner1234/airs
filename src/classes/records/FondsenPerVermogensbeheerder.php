...
/* 	
    ...
    $Log: FondsenPerVermogensbeheerder.php,v $
...
class FondsenPerVermogensbeheerder extends Table
{
  /*
  * Object vars
  */
  ...
  * Constructor
  */
  function FondsenPerVermogensbeheerder()
  {
    $this->defineData();
    $this->setDefaults();
  ...
  */
  ...
  {
    $this->data['name']  = "";
    $this->data['table']  = "FondsenPerVermogensbeheerder";
