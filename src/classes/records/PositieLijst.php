...
/* 	
    ...
    $Log: PositieLijst.php,v $
    Revision 1.2  2015/11/29 13:05:52  rvv
    *** empty log message ***

    Revision 1.1  2011/06/22 11:46:13  cvs
    *** empty log message ***
...
class PositieLijst extends Table
{
  /*
  * Object vars
  */
  ...
  */
  function defineData()
  {
    $this->data['name']  = "conversie Positie Overzicht";
    $this->data['table']  = "PositieLijst";
    $this->data['identity'] = "id";
		...
		$this->addField('fondsCodeNumeriek',
													array("description"=>"fondsCodeNumeriek",
													"default_value"=>"",
													"db_size"=>"25",
													"db_type"=>"varchar",
													"form_type"=>"text",
		...
		$this->addField('optieSoort',
													array("description"=>"optieSoort",
													"default_value"=>"",
													"db_size"=>"10",
													"db_type"=>"varchar",
													"form_type"=>"text",
		...
		$this->addField('waardeInEUR',
													array("description"=>"waardeInEUR",
													"default_value"=>"",
													"db_size"=>"0",
													"db_type"=>"double",
													"form_type"=>"text",
		...
		$this->addField('waardeInValuta',
													array("description"=>"waardeInValuta",
													"default_value"=>"",
													"db_size"=>"0",
													"db_type"=>"double",
													"form_type"=>"text",
		...
		$this->addField('kostprijs',
													array("description"=>"kostprijs",
													"default_value"=>"",
													"db_size"=>"0",
													"db_type"=>"double",
													"form_type"=>"text",
