...
/* 	
    ...
    Author              : $Author: cvs $
    Laatste aanpassing  : $Date: 2020/06/17 08:23:40 $
    File Versie         : $Revision: 1.2 $
 		
    $Log: modulezTransactieCodes.php,v $
    Revision 1.2  2020/06/17 08:23:40  cvs
    call 8700

    Revision 1.1  2018/11/19 14:32:53  cvs
...
class modulezTransactieCodes extends Table
{
  /*
  * Object vars
  */
  var $tableName = "modulezTransactieCodes";
  var $data = array();
  
  /*
  * Constructor
  */
  function modulezTransactieCodes()
  {
    $this->defineData();
    $this->setDefaults();
  ...
  */
    ...
    $this->data['identity'] = "id";
		...
		$this->addField('doActie',
                          ...
                          "form_options" => array( 
                                              ...
                                              "KODI" => "KODI - Kosten diverse (code 2)",
  ...
  function initModule()
  {
    ...
    $tst->changeField($this->tableName,"code",array("Type"=>"varchar(10)","Null"=>false));
