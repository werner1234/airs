...
/* 	
    ...
    *** empty log message ***
    ...
    Revision 1.1  2005/11/23 09:30:05  cvs
    *** empty log message ***
...
class Naw_documenten extends Table
{
  /*
  * Object vars
  */
  ...
  */
  function Naw_documenten()
  {
	...
	function validate()
	{
		($this->get("bestandsnaam")=="")?$this->setError("bestandsnaam",vt("Mag niet leeg zijn!")):true;
  ...
  */
  function defineData()
  {
    $this->data['name']  = "Document koppelingen";
    $this->data['table']  = "CRM_naw_documenten";
    $this->data['identity'] = "id";
		...
		$this->addField('bestandsnaam',
													array("description"=>"bestandsnaam",
													"default_value"=>"",
													"db_size"=>"100",
													"db_type"=>"varchar",
													"form_type"=>"text",
