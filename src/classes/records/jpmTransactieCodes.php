...
class jpmTransactieCodes extends Table
{
  /*
  * Object vars
  */
  var $tableName = "jpmTransactieCodes";
  var $data = array();
  
  /*
  * Constructor
  */
  function jpmTransactieCodes()
  {
    $this->defineData();
    $this->initModule();
    $this->setDefaults();
  ...
  function initModule()
  {
    ...
    $tst->changeField($this->tableName,"bankCode",array("Type"=>" varchar(20)","Null"=>false));
  ...
  */
  function defineData()
  {
    $this->data['name']  = "JPM transactiecodes";
