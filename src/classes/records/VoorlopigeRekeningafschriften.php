...
/*
    ...
    Author  						: $Author: rvv $
 		Laatste aanpassing	: $Date: 2014/12/18 07:23:35 $
 		File Versie					: $Revision: 1.8 $

 		$Log: VoorlopigeRekeningafschriften.php,v $
...
class VoorlopigeRekeningafschriften extends Table
{
  /*
  * Object vars
  */
  ...
  * Constructor
  */
  function VoorlopigeRekeningafschriften()
  {
    $this->defineData();
  ...
  function defineData()
  {
    ...
    $this->data['identity'] = "id";
		...
		$this->addField('Datum',
													...
													"db_type"=>"datetime",
													"form_type"=>"calendar",
													"form_extra"=>"onBlur=\"javascript:rekeningChanged(true)\"",
													"form_size"=>"10",
													"form_visible"=>true,
													"list_visible"=>true,
													"list_align"=>"right",
