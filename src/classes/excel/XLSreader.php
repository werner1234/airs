...
* @version    CVS: $Id: XLSreader.php,v 1.1 2008/06/30 06:54:36 rvv Exp $
...
require_once $__appvar["basedir"].'/classes/excel/OLE.php';
require_once $__appvar["basedir"].'/classes/excel/oleread.php';
