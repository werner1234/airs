...
require_once realpath(dirname(__FILE__)) . '/Worksheet.php';
require_once realpath(dirname(__FILE__)) . '/Parser.php';
require_once realpath(dirname(__FILE__)) . '/OLE.php';
require_once realpath(dirname(__FILE__)) . '/File.php';
require_once realpath(dirname(__FILE__)) . '/Root.php';
...
class Spreadsheet_Excel_Writer_Workbook extends Spreadsheet_Excel_Writer_BIFFwriter
{
    ...
    */
    function Spreadsheet_Excel_Writer_Workbook($filename)
    {
        ...
        $this->_tmp_dir         = '';
        $this->_date_format =& $this->addFormat(array('NumFormat'=>'DD-MM-YYYY'));
...
/*        if ($this->isError($res)) {
    ...
    */
    function setVersion($version)
    {
        if ($version == 8) { // only accept version 8
            ...
            $this->_date_format->_BIFF_version = $version;
    ...
    */
    function &addWorksheet($name = '')
    {
        ...
        $worksheet = new Spreadsheet_Excel_Writer_Worksheet($this->_BIFF_version,
                                   ...
                                   $this->_parser, $this->_date_format);
    ...
    */
    ...
    {
        include_once realpath(dirname(__FILE__)) . '/Validator.php';
